 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Zm;function W0(){if(Zm)return ie;Zm=1;var r=Symbol.for("react.transitional.element"),m=Symbol.for("react.portal"),d=Symbol.for("react.fragment"),c=Symbol.for("react.strict_mode"),f=Symbol.for("react.profiler"),p=Symbol.for("react.consumer"),y=Symbol.for("react.context"),C=Symbol.for("react.forward_ref"),w=Symbol.for("react.suspense"),g=Symbol.for("react.memo"),v=Symbol.for("react.lazy"),j=Symbol.iterator;function E(x){return x===null||typeof x!="object"?null:(x=j&&x[j]||x["@@iterator"],typeof x=="function"?x:null)}var O={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},_=Object.assign,Y={};function G(x,H,V){this.props=x,this.context=H,this.refs=Y,this.updater=V||O}G.prototype.isReactComponent={},G.prototype.setState=function(x,H){if(typeof x!="object"&&typeof x!="function"&&x!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,x,H,"setState")},G.prototype.forceUpdate=function(x){this.updater.enqueueForceUpdate(this,x,"forceUpdate")};function B(){}B.prototype=G.prototype;function L(x,H,V){this.props=x,this.context=H,this.refs=Y,this.updater=V||O}var J=L.prototype=new B;J.constructor=L,_(J,G.prototype),J.isPureReactComponent=!0;var me=Array.isArray,Z={H:null,A:null,T:null,S:null,V:null},xe=Object.prototype.hasOwnProperty;function pe(x,H,V,q,W,de){return V=de.ref,{$$typeof:r,type:x,key:H,ref:V!==void 0?V:null,props:de}}function X(x,H){return pe(x.type,H,void 0,void 0,void 0,x.props)}function P(x){return typeof x=="object"&&x!==null&&x.$$typeof===r}function ce(x){var H={"=":"=0",":":"=2"};return"$"+x.replace(/[=:]/g,function(V){return H[V]})}var we=/\/+/g;function Me(x,H){return typeof x=="object"&&x!==null&&x.key!=null?ce(""+x.key):H.toString(36)}function We(){}function $e(x){switch(x.status){case"fulfilled":return x.value;case"rejected":throw x.reason;default:switch(typeof x.status=="string"?x.then(We,We):(x.status="pending",x.then(function(H){x.status==="pending"&&(x.status="fulfilled",x.value=H)},function(H){x.status==="pending"&&(x.status="rejected",x.reason=H)})),x.status){case"fulfilled":return x.value;case"rejected":throw x.reason}}throw x}function Ie(x,H,V,q,W){var de=typeof x;(de==="undefined"||de==="boolean")&&(x=null);var ae=!1;if(x===null)ae=!0;else switch(de){case"bigint":case"string":case"number":ae=!0;break;case"object":switch(x.$$typeof){case r:case m:ae=!0;break;case v:return ae=x._init,Ie(ae(x._payload),H,V,q,W)}}if(ae)return W=W(x),ae=q===""?"."+Me(x,0):q,me(W)?(V="",ae!=null&&(V=ae.replace(we,"$&/")+"/"),Ie(W,H,V,"",function(ta){return ta})):W!=null&&(P(W)&&(W=X(W,V+(W.key==null||x&&x.key===W.key?"":(""+W.key).replace(we,"$&/")+"/")+ae)),H.push(W)),1;ae=0;var nt=q===""?".":q+":";if(me(x))for(var Se=0;Se<x.length;Se++)q=x[Se],de=nt+Me(q,Se),ae+=Ie(q,H,V,de,W);else if(Se=E(x),typeof Se=="function")for(x=Se.call(x),Se=0;!(q=x.next()).done;)q=q.value,de=nt+Me(q,Se++),ae+=Ie(q,H,V,de,W);else if(de==="object"){if(typeof x.then=="function")return Ie($e(x),H,V,q,W);throw H=String(x),Error("Objects are not valid as a React child (found: "+(H==="[object Object]"?"object with keys {"+Object.keys(x).join(", ")+"}":H)+"). If you meant to render a collection of children, use an array instead.")}return ae}function D(x,H,V){if(x==null)return x;var q=[],W=0;return Ie(x,q,"","",function(de){return H.call(V,de,W++)}),q}function Q(x){if(x._status===-1){var H=x._result;H=H(),H.then(function(V){(x._status===0||x._status===-1)&&(x._status=1,x._result=V)},function(V){(x._status===0||x._status===-1)&&(x._status=2,x._result=V)}),x._status===-1&&(x._status=0,x._result=H)}if(x._status===1)return x._result.default;throw x._result}var ee=typeof reportError=="function"?reportError:function(x){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var H=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof x=="object"&&x!==null&&typeof x.message=="string"?String(x.message):String(x),error:x});if(!window.dispatchEvent(H))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",x);return}console.error(x)};function je(){}return ie.Children={map:D,forEach:function(x,H,V){D(x,function(){H.apply(this,arguments)},V)},count:function(x){var H=0;return D(x,function(){H++}),H},toArray:function(x){return D(x,function(H){return H})||[]},only:function(x){if(!P(x))throw Error("React.Children.only expected to receive a single React element child.");return x}},ie.Component=G,ie.Fragment=d,ie.Profiler=f,ie.PureComponent=L,ie.StrictMode=c,ie.Suspense=w,ie.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=Z,ie.__COMPILER_RUNTIME={__proto__:null,c:function(x){return Z.H.useMemoCache(x)}},ie.cache=function(x){return function(){return x.apply(null,arguments)}},ie.cloneElement=function(x,H,V){if(x==null)throw Error("The argument must be a React element, but you passed "+x+".");var q=_({},x.props),W=x.key,de=void 0;if(H!=null)for(ae in H.ref!==void 0&&(de=void 0),H.key!==void 0&&(W=""+H.key),H)!xe.call(H,ae)||ae==="key"||ae==="__self"||ae==="__source"||ae==="ref"&&H.ref===void 0||(q[ae]=H[ae]);var ae=arguments.length-2;if(ae===1)q.children=V;else if(1<ae){for(var nt=Array(ae),Se=0;Se<ae;Se++)nt[Se]=arguments[Se+2];q.children=nt}return pe(x.type,W,void 0,void 0,de,q)},ie.createContext=function(x){return x={$$typeof:y,_currentValue:x,_currentValue2:x,_threadCount:0,Provider:null,Consumer:null},x.Provider=x,x.Consumer={$$typeof:p,_context:x},x},ie.createElement=function(x,H,V){var q,W={},de=null;if(H!=null)for(q in H.key!==void 0&&(de=""+H.key),H)xe.call(H,q)&&q!=="key"&&q!=="__self"&&q!=="__source"&&(W[q]=H[q]);var ae=arguments.length-2;if(ae===1)W.children=V;else if(1<ae){for(var nt=Array(ae),Se=0;Se<ae;Se++)nt[Se]=arguments[Se+2];W.children=nt}if(x&&x.defaultProps)for(q in ae=x.defaultProps,ae)W[q]===void 0&&(W[q]=ae[q]);return pe(x,de,void 0,void 0,null,W)},ie.createRef=function(){return{current:null}},ie.forwardRef=function(x){return{$$typeof:C,render:x}},ie.isValidElement=P,ie.lazy=function(x){return{$$typeof:v,_payload:{_status:-1,_result:x},_init:Q}},ie.memo=function(x,H){return{$$typeof:g,type:x,compare:H===void 0?null:H}},ie.startTransition=function(x){var H=Z.T,V={};Z.T=V;try{var q=x(),W=Z.S;W!==null&&W(V,q),typeof q=="object"&&q!==null&&typeof q.then=="function"&&q.then(je,ee)}catch(de){ee(de)}finally{Z.T=H}},ie.unstable_useCacheRefresh=function(){return Z.H.useCacheRefresh()},ie.use=function(x){return Z.H.use(x)},ie.useActionState=function(x,H,V){return Z.H.useActionState(x,H,V)},ie.useCallback=function(x,H){return Z.H.useCallback(x,H)},ie.useContext=function(x){return Z.H.useContext(x)},ie.useDebugValue=function(){},ie.useDeferredValue=function(x,H){return Z.H.useDeferredValue(x,H)},ie.useEffect=function(x,H,V){var q=Z.H;if(typeof V=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return q.useEffect(x,H)},ie.useId=function(){return Z.H.useId()},ie.useImperativeHandle=function(x,H,V){return Z.H.useImperativeHandle(x,H,V)},ie.useInsertionEffect=function(x,H){return Z.H.useInsertionEffect(x,H)},ie.useLayoutEffect=function(x,H){return Z.H.useLayoutEffect(x,H)},ie.useMemo=function(x,H){return Z.H.useMemo(x,H)},ie.useOptimistic=function(x,H){return Z.H.useOptimistic(x,H)},ie.useReducer=function(x,H,V){return Z.H.useReducer(x,H,V)},ie.useRef=function(x){return Z.H.useRef(x)},ie.useState=function(x){return Z.H.useState(x)},ie.useSyncExternalStore=function(x,H,V){return Z.H.useSyncExternalStore(x,H,V)},ie.useTransition=function(){return Z.H.useTransition()},ie.version="19.1.0",ie}var Jm;function Ko(){return Jm||(Jm=1,Do.exports=W0()),Do.exports}var N=Ko();const F0=K0(N);var Ro={exports:{}},Dn={},Oo={exports:{}},Uo={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Wm;function $0(){return Wm||(Wm=1,function(r){function m(D,Q){var ee=D.length;D.push(Q);e:for(;0<ee;){var je=ee-1>>>1,x=D[je];if(0<f(x,Q))D[je]=Q,D[ee]=x,ee=je;else break e}}function d(D){return D.length===0?null:D[0]}function c(D){if(D.length===0)return null;var Q=D[0],ee=D.pop();if(ee!==Q){D[0]=ee;e:for(var je=0,x=D.length,H=x>>>1;je<H;){var V=2*(je+1)-1,q=D[V],W=V+1,de=D[W];if(0>f(q,ee))W<x&&0>f(de,q)?(D[je]=de,D[W]=ee,je=W):(D[je]=q,D[V]=ee,je=V);else if(W<x&&0>f(de,ee))D[je]=de,D[W]=ee,je=W;else break e}}return Q}function f(D,Q){var ee=D.sortIndex-Q.sortIndex;return ee!==0?ee:D.id-Q.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var p=performance;r.unstable_now=function(){return p.now()}}else{var y=Date,C=y.now();r.unstable_now=function(){return y.now()-C}}var w=[],g=[],v=1,j=null,E=3,O=!1,_=!1,Y=!1,G=!1,B=typeof setTimeout=="function"?setTimeout:null,L=typeof clearTimeout=="function"?clearTimeout:null,J=typeof setImmediate<"u"?setImmediate:null;function me(D){for(var Q=d(g);Q!==null;){if(Q.callback===null)c(g);else if(Q.startTime<=D)c(g),Q.sortIndex=Q.expirationTime,m(w,Q);else break;Q=d(g)}}function Z(D){if(Y=!1,me(D),!_)if(d(w)!==null)_=!0,xe||(xe=!0,Me());else{var Q=d(g);Q!==null&&Ie(Z,Q.startTime-D)}}var xe=!1,pe=-1,X=5,P=-1;function ce(){return G?!0:!(r.unstable_now()-P<X)}function we(){if(G=!1,xe){var D=r.unstable_now();P=D;var Q=!0;try{e:{_=!1,Y&&(Y=!1,L(pe),pe=-1),O=!0;var ee=E;try{t:{for(me(D),j=d(w);j!==null&&!(j.expirationTime>D&&ce());){var je=j.callback;if(typeof je=="function"){j.callback=null,E=j.priorityLevel;var x=je(j.expirationTime<=D);if(D=r.unstable_now(),typeof x=="function"){j.callback=x,me(D),Q=!0;break t}j===d(w)&&c(w),me(D)}else c(w);j=d(w)}if(j!==null)Q=!0;else{var H=d(g);H!==null&&Ie(Z,H.startTime-D),Q=!1}}break e}finally{j=null,E=ee,O=!1}Q=void 0}}finally{Q?Me():xe=!1}}}var Me;if(typeof J=="function")Me=function(){J(we)};else if(typeof MessageChannel<"u"){var We=new MessageChannel,$e=We.port2;We.port1.onmessage=we,Me=function(){$e.postMessage(null)}}else Me=function(){B(we,0)};function Ie(D,Q){pe=B(function(){D(r.unstable_now())},Q)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(D){D.callback=null},r.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):X=0<D?Math.floor(1e3/D):5},r.unstable_getCurrentPriorityLevel=function(){return E},r.unstable_next=function(D){switch(E){case 1:case 2:case 3:var Q=3;break;default:Q=E}var ee=E;E=Q;try{return D()}finally{E=ee}},r.unstable_requestPaint=function(){G=!0},r.unstable_runWithPriority=function(D,Q){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var ee=E;E=D;try{return Q()}finally{E=ee}},r.unstable_scheduleCallback=function(D,Q,ee){var je=r.unstable_now();switch(typeof ee=="object"&&ee!==null?(ee=ee.delay,ee=typeof ee=="number"&&0<ee?je+ee:je):ee=je,D){case 1:var x=-1;break;case 2:x=250;break;case 5:x=1073741823;break;case 4:x=1e4;break;default:x=5e3}return x=ee+x,D={id:v++,callback:Q,priorityLevel:D,startTime:ee,expirationTime:x,sortIndex:-1},ee>je?(D.sortIndex=ee,m(g,D),d(w)===null&&D===d(g)&&(Y?(L(pe),pe=-1):Y=!0,Ie(Z,ee-je))):(D.sortIndex=x,m(w,D),_||O||(_=!0,xe||(xe=!0,Me()))),D},r.unstable_shouldYield=ce,r.unstable_wrapCallback=function(D){var Q=E;return function(){var ee=E;E=Q;try{return D.apply(this,arguments)}finally{E=ee}}}}(Uo)),Uo}var Fm;function P0(){return Fm||(Fm=1,Oo.exports=$0()),Oo.exports}var Bo={exports:{}},Je={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var $m;function eg(){if($m)return Je;$m=1;var r=Ko();function m(w){var g="https://react.dev/errors/"+w;if(1<arguments.length){g+="?args[]="+encodeURIComponent(arguments[1]);for(var v=2;v<arguments.length;v++)g+="&args[]="+encodeURIComponent(arguments[v])}return"Minified React error #"+w+"; visit "+g+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function d(){}var c={d:{f:d,r:function(){throw Error(m(522))},D:d,C:d,L:d,m:d,X:d,S:d,M:d},p:0,findDOMNode:null},f=Symbol.for("react.portal");function p(w,g,v){var j=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:f,key:j==null?null:""+j,children:w,containerInfo:g,implementation:v}}var y=r.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function C(w,g){if(w==="font")return"";if(typeof g=="string")return g==="use-credentials"?g:""}return Je.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=c,Je.createPortal=function(w,g){var v=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!g||g.nodeType!==1&&g.nodeType!==9&&g.nodeType!==11)throw Error(m(299));return p(w,g,null,v)},Je.flushSync=function(w){var g=y.T,v=c.p;try{if(y.T=null,c.p=2,w)return w()}finally{y.T=g,c.p=v,c.d.f()}},Je.preconnect=function(w,g){typeof w=="string"&&(g?(g=g.crossOrigin,g=typeof g=="string"?g==="use-credentials"?g:"":void 0):g=null,c.d.C(w,g))},Je.prefetchDNS=function(w){typeof w=="string"&&c.d.D(w)},Je.preinit=function(w,g){if(typeof w=="string"&&g&&typeof g.as=="string"){var v=g.as,j=C(v,g.crossOrigin),E=typeof g.integrity=="string"?g.integrity:void 0,O=typeof g.fetchPriority=="string"?g.fetchPriority:void 0;v==="style"?c.d.S(w,typeof g.precedence=="string"?g.precedence:void 0,{crossOrigin:j,integrity:E,fetchPriority:O}):v==="script"&&c.d.X(w,{crossOrigin:j,integrity:E,fetchPriority:O,nonce:typeof g.nonce=="string"?g.nonce:void 0})}},Je.preinitModule=function(w,g){if(typeof w=="string")if(typeof g=="object"&&g!==null){if(g.as==null||g.as==="script"){var v=C(g.as,g.crossOrigin);c.d.M(w,{crossOrigin:v,integrity:typeof g.integrity=="string"?g.integrity:void 0,nonce:typeof g.nonce=="string"?g.nonce:void 0})}}else g==null&&c.d.M(w)},Je.preload=function(w,g){if(typeof w=="string"&&typeof g=="object"&&g!==null&&typeof g.as=="string"){var v=g.as,j=C(v,g.crossOrigin);c.d.L(w,v,{crossOrigin:j,integrity:typeof g.integrity=="string"?g.integrity:void 0,nonce:typeof g.nonce=="string"?g.nonce:void 0,type:typeof g.type=="string"?g.type:void 0,fetchPriority:typeof g.fetchPriority=="string"?g.fetchPriority:void 0,referrerPolicy:typeof g.referrerPolicy=="string"?g.referrerPolicy:void 0,imageSrcSet:typeof g.imageSrcSet=="string"?g.imageSrcSet:void 0,imageSizes:typeof g.imageSizes=="string"?g.imageSizes:void 0,media:typeof g.media=="string"?g.media:void 0})}},Je.preloadModule=function(w,g){if(typeof w=="string")if(g){var v=C(g.as,g.crossOrigin);c.d.m(w,{as:typeof g.as=="string"&&g.as!=="script"?g.as:void 0,crossOrigin:v,integrity:typeof g.integrity=="string"?g.integrity:void 0})}else c.d.m(w)},Je.requestFormReset=function(w){c.d.r(w)},Je.unstable_batchedUpdates=function(w,g){return w(g)},Je.useFormState=function(w,g,v){return y.H.useFormState(w,g,v)},Je.useFormStatus=function(){return y.H.useHostTransitionStatus()},Je.version="19.1.0",Je}var Pm;function tg(){if(Pm)return Bo.exports;Pm=1;function r(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(r)}catch(m){console.error(m)}}return r(),Bo.exports=eg(),Bo.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ef;function ag(){if(ef)return Dn;ef=1;var r=P0(),m=Ko(),d=tg();function c(e){var t="https://react.dev/errors/"+e;if(1<arguments.length){t+="?args[]="+encodeURIComponent(arguments[1]);for(var a=2;a<arguments.length;a++)t+="&args[]="+encodeURIComponent(arguments[a])}return"Minified React error #"+e+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function f(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function p(e){var t=e,a=e;if(e.alternate)for(;t.return;)t=t.return;else{e=t;do t=e,(t.flags&4098)!==0&&(a=t.return),e=t.return;while(e)}return t.tag===3?a:null}function y(e){if(e.tag===13){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function C(e){if(p(e)!==e)throw Error(c(188))}function w(e){var t=e.alternate;if(!t){if(t=p(e),t===null)throw Error(c(188));return t!==e?null:e}for(var a=e,i=t;;){var l=a.return;if(l===null)break;var s=l.alternate;if(s===null){if(i=l.return,i!==null){a=i;continue}break}if(l.child===s.child){for(s=l.child;s;){if(s===a)return C(l),e;if(s===i)return C(l),t;s=s.sibling}throw Error(c(188))}if(a.return!==i.return)a=l,i=s;else{for(var o=!1,u=l.child;u;){if(u===a){o=!0,a=l,i=s;break}if(u===i){o=!0,i=l,a=s;break}u=u.sibling}if(!o){for(u=s.child;u;){if(u===a){o=!0,a=s,i=l;break}if(u===i){o=!0,i=s,a=l;break}u=u.sibling}if(!o)throw Error(c(189))}}if(a.alternate!==i)throw Error(c(190))}if(a.tag!==3)throw Error(c(188));return a.stateNode.current===a?e:t}function g(e){var t=e.tag;if(t===5||t===26||t===27||t===6)return e;for(e=e.child;e!==null;){if(t=g(e),t!==null)return t;e=e.sibling}return null}var v=Object.assign,j=Symbol.for("react.element"),E=Symbol.for("react.transitional.element"),O=Symbol.for("react.portal"),_=Symbol.for("react.fragment"),Y=Symbol.for("react.strict_mode"),G=Symbol.for("react.profiler"),B=Symbol.for("react.provider"),L=Symbol.for("react.consumer"),J=Symbol.for("react.context"),me=Symbol.for("react.forward_ref"),Z=Symbol.for("react.suspense"),xe=Symbol.for("react.suspense_list"),pe=Symbol.for("react.memo"),X=Symbol.for("react.lazy"),P=Symbol.for("react.activity"),ce=Symbol.for("react.memo_cache_sentinel"),we=Symbol.iterator;function Me(e){return e===null||typeof e!="object"?null:(e=we&&e[we]||e["@@iterator"],typeof e=="function"?e:null)}var We=Symbol.for("react.client.reference");function $e(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===We?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case _:return"Fragment";case G:return"Profiler";case Y:return"StrictMode";case Z:return"Suspense";case xe:return"SuspenseList";case P:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case O:return"Portal";case J:return(e.displayName||"Context")+".Provider";case L:return(e._context.displayName||"Context")+".Consumer";case me:var t=e.render;return e=e.displayName,e||(e=t.displayName||t.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case pe:return t=e.displayName||null,t!==null?t:$e(e.type)||"Memo";case X:t=e._payload,e=e._init;try{return $e(e(t))}catch{}}return null}var Ie=Array.isArray,D=m.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,Q=d.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,ee={pending:!1,data:null,method:null,action:null},je=[],x=-1;function H(e){return{current:e}}function V(e){0>x||(e.current=je[x],je[x]=null,x--)}function q(e,t){x++,je[x]=e.current,e.current=t}var W=H(null),de=H(null),ae=H(null),nt=H(null);function Se(e,t){switch(q(ae,t),q(de,e),q(W,null),t.nodeType){case 9:case 11:e=(e=t.documentElement)&&(e=e.namespaceURI)?vm(e):0;break;default:if(e=t.tagName,t=t.namespaceURI)t=vm(t),e=wm(t,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}V(W),q(W,e)}function ta(){V(W),V(de),V(ae)}function hs(e){e.memoizedState!==null&&q(nt,e);var t=W.current,a=wm(t,e.type);t!==a&&(q(de,e),q(W,a))}function Yn(e){de.current===e&&(V(W),V(de)),nt.current===e&&(V(nt),kn._currentValue=ee)}var gs=Object.prototype.hasOwnProperty,xs=r.unstable_scheduleCallback,bs=r.unstable_cancelCallback,Sp=r.unstable_shouldYield,kp=r.unstable_requestPaint,Et=r.unstable_now,zp=r.unstable_getCurrentPriorityLevel,ec=r.unstable_ImmediatePriority,tc=r.unstable_UserBlockingPriority,qn=r.unstable_NormalPriority,Ep=r.unstable_LowPriority,ac=r.unstable_IdlePriority,Cp=r.log,Tp=r.unstable_setDisableYieldValue,Ri=null,lt=null;function aa(e){if(typeof Cp=="function"&&Tp(e),lt&&typeof lt.setStrictMode=="function")try{lt.setStrictMode(Ri,e)}catch{}}var st=Math.clz32?Math.clz32:Rp,Mp=Math.log,Dp=Math.LN2;function Rp(e){return e>>>=0,e===0?32:31-(Mp(e)/Dp|0)|0}var Qn=256,Xn=4194304;function ka(e){var t=e&42;if(t!==0)return t;switch(e&-e){case 1:return 1;case 2:return 2;case 4:return 4;case 8:return 8;case 16:return 16;case 32:return 32;case 64:return 64;case 128:return 128;case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:return e&4194048;case 4194304:case 8388608:case 16777216:case 33554432:return e&62914560;case 67108864:return 67108864;case 134217728:return 134217728;case 268435456:return 268435456;case 536870912:return 536870912;case 1073741824:return 0;default:return e}}function Vn(e,t,a){var i=e.pendingLanes;if(i===0)return 0;var l=0,s=e.suspendedLanes,o=e.pingedLanes;e=e.warmLanes;var u=i&134217727;return u!==0?(i=u&~s,i!==0?l=ka(i):(o&=u,o!==0?l=ka(o):a||(a=u&~e,a!==0&&(l=ka(a))))):(u=i&~s,u!==0?l=ka(u):o!==0?l=ka(o):a||(a=i&~e,a!==0&&(l=ka(a)))),l===0?0:t!==0&&t!==l&&(t&s)===0&&(s=l&-l,a=t&-t,s>=a||s===32&&(a&4194048)!==0)?t:l}function Oi(e,t){return(e.pendingLanes&~(e.suspendedLanes&~e.pingedLanes)&t)===0}function Op(e,t){switch(e){case 1:case 2:case 4:case 8:case 64:return t+250;case 16:case 32:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:return t+5e3;case 4194304:case 8388608:case 16777216:case 33554432:return-1;case 67108864:case 134217728:case 268435456:case 536870912:case 1073741824:return-1;default:return-1}}function ic(){var e=Qn;return Qn<<=1,(Qn&4194048)===0&&(Qn=256),e}function nc(){var e=Xn;return Xn<<=1,(Xn&62914560)===0&&(Xn=4194304),e}function ys(e){for(var t=[],a=0;31>a;a++)t.push(e);return t}function Ui(e,t){e.pendingLanes|=t,t!==268435456&&(e.suspendedLanes=0,e.pingedLanes=0,e.warmLanes=0)}function Up(e,t,a,i,l,s){var o=e.pendingLanes;e.pendingLanes=a,e.suspendedLanes=0,e.pingedLanes=0,e.warmLanes=0,e.expiredLanes&=a,e.entangledLanes&=a,e.errorRecoveryDisabledLanes&=a,e.shellSuspendCounter=0;var u=e.entanglements,h=e.expirationTimes,k=e.hiddenUpdates;for(a=o&~a;0<a;){var M=31-st(a),U=1<<M;u[M]=0,h[M]=-1;var z=k[M];if(z!==null)for(k[M]=null,M=0;M<z.length;M++){var T=z[M];T!==null&&(T.lane&=-536870913)}a&=~U}i!==0&&lc(e,i,0),s!==0&&l===0&&e.tag!==0&&(e.suspendedLanes|=s&~(o&~t))}function lc(e,t,a){e.pendingLanes|=t,e.suspendedLanes&=~t;var i=31-st(t);e.entangledLanes|=t,e.entanglements[i]=e.entanglements[i]|1073741824|a&4194090}function sc(e,t){var a=e.entangledLanes|=t;for(e=e.entanglements;a;){var i=31-st(a),l=1<<i;l&t|e[i]&t&&(e[i]|=t),a&=~l}}function vs(e){switch(e){case 2:e=1;break;case 8:e=4;break;case 32:e=16;break;case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:case 4194304:case 8388608:case 16777216:case 33554432:e=128;break;case 268435456:e=134217728;break;default:e=0}return e}function ws(e){return e&=-e,2<e?8<e?(e&134217727)!==0?32:268435456:8:2}function rc(){var e=Q.p;return e!==0?e:(e=window.event,e===void 0?32:Gm(e.type))}function Bp(e,t){var a=Q.p;try{return Q.p=e,t()}finally{Q.p=a}}var ia=Math.random().toString(36).slice(2),Ke="__reactFiber$"+ia,Pe="__reactProps$"+ia,Va="__reactContainer$"+ia,js="__reactEvents$"+ia,Hp="__reactListeners$"+ia,_p="__reactHandles$"+ia,oc="__reactResources$"+ia,Bi="__reactMarker$"+ia;function As(e){delete e[Ke],delete e[Pe],delete e[js],delete e[Hp],delete e[_p]}function Ia(e){var t=e[Ke];if(t)return t;for(var a=e.parentNode;a;){if(t=a[Va]||a[Ke]){if(a=t.alternate,t.child!==null||a!==null&&a.child!==null)for(e=Sm(e);e!==null;){if(a=e[Ke])return a;e=Sm(e)}return t}e=a,a=e.parentNode}return null}function Ka(e){if(e=e[Ke]||e[Va]){var t=e.tag;if(t===5||t===6||t===13||t===26||t===27||t===3)return e}return null}function Hi(e){var t=e.tag;if(t===5||t===26||t===27||t===6)return e.stateNode;throw Error(c(33))}function Za(e){var t=e[oc];return t||(t=e[oc]={hoistableStyles:new Map,hoistableScripts:new Map}),t}function _e(e){e[Bi]=!0}var cc=new Set,dc={};function za(e,t){Ja(e,t),Ja(e+"Capture",t)}function Ja(e,t){for(dc[e]=t,e=0;e<t.length;e++)cc.add(t[e])}var Lp=RegExp("^[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD][:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$"),uc={},mc={};function Gp(e){return gs.call(mc,e)?!0:gs.call(uc,e)?!1:Lp.test(e)?mc[e]=!0:(uc[e]=!0,!1)}function In(e,t,a){if(Gp(t))if(a===null)e.removeAttribute(t);else{switch(typeof a){case"undefined":case"function":case"symbol":e.removeAttribute(t);return;case"boolean":var i=t.toLowerCase().slice(0,5);if(i!=="data-"&&i!=="aria-"){e.removeAttribute(t);return}}e.setAttribute(t,""+a)}}function Kn(e,t,a){if(a===null)e.removeAttribute(t);else{switch(typeof a){case"undefined":case"function":case"symbol":case"boolean":e.removeAttribute(t);return}e.setAttribute(t,""+a)}}function Bt(e,t,a,i){if(i===null)e.removeAttribute(a);else{switch(typeof i){case"undefined":case"function":case"symbol":case"boolean":e.removeAttribute(a);return}e.setAttributeNS(t,a,""+i)}}var Ns,fc;function Wa(e){if(Ns===void 0)try{throw Error()}catch(a){var t=a.stack.trim().match(/\n( *(at )?)/);Ns=t&&t[1]||"",fc=-1<a.stack.indexOf(`
    at`)?" (<anonymous>)":-1<a.stack.indexOf("@")?"@unknown:0:0":""}return`
`+Ns+e+fc}var Ss=!1;function ks(e,t){if(!e||Ss)return"";Ss=!0;var a=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{var i={DetermineComponentFrameRoot:function(){try{if(t){var U=function(){throw Error()};if(Object.defineProperty(U.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(U,[])}catch(T){var z=T}Reflect.construct(e,[],U)}else{try{U.call()}catch(T){z=T}e.call(U.prototype)}}else{try{throw Error()}catch(T){z=T}(U=e())&&typeof U.catch=="function"&&U.catch(function(){})}}catch(T){if(T&&z&&typeof T.stack=="string")return[T.stack,z.stack]}return[null,null]}};i.DetermineComponentFrameRoot.displayName="DetermineComponentFrameRoot";var l=Object.getOwnPropertyDescriptor(i.DetermineComponentFrameRoot,"name");l&&l.configurable&&Object.defineProperty(i.DetermineComponentFrameRoot,"name",{value:"DetermineComponentFrameRoot"});var s=i.DetermineComponentFrameRoot(),o=s[0],u=s[1];if(o&&u){var h=o.split(`
`),k=u.split(`
`);for(l=i=0;i<h.length&&!h[i].includes("DetermineComponentFrameRoot");)i++;for(;l<k.length&&!k[l].includes("DetermineComponentFrameRoot");)l++;if(i===h.length||l===k.length)for(i=h.length-1,l=k.length-1;1<=i&&0<=l&&h[i]!==k[l];)l--;for(;1<=i&&0<=l;i--,l--)if(h[i]!==k[l]){if(i!==1||l!==1)do if(i--,l--,0>l||h[i]!==k[l]){var M=`
`+h[i].replace(" at new "," at ");return e.displayName&&M.includes("<anonymous>")&&(M=M.replace("<anonymous>",e.displayName)),M}while(1<=i&&0<=l);break}}}finally{Ss=!1,Error.prepareStackTrace=a}return(a=e?e.displayName||e.name:"")?Wa(a):""}function Yp(e){switch(e.tag){case 26:case 27:case 5:return Wa(e.type);case 16:return Wa("Lazy");case 13:return Wa("Suspense");case 19:return Wa("SuspenseList");case 0:case 15:return ks(e.type,!1);case 11:return ks(e.type.render,!1);case 1:return ks(e.type,!0);case 31:return Wa("Activity");default:return""}}function pc(e){try{var t="";do t+=Yp(e),e=e.return;while(e);return t}catch(a){return`
Error generating stack: `+a.message+`
`+a.stack}}function pt(e){switch(typeof e){case"bigint":case"boolean":case"number":case"string":case"undefined":return e;case"object":return e;default:return""}}function hc(e){var t=e.type;return(e=e.nodeName)&&e.toLowerCase()==="input"&&(t==="checkbox"||t==="radio")}function qp(e){var t=hc(e)?"checked":"value",a=Object.getOwnPropertyDescriptor(e.constructor.prototype,t),i=""+e[t];if(!e.hasOwnProperty(t)&&typeof a<"u"&&typeof a.get=="function"&&typeof a.set=="function"){var l=a.get,s=a.set;return Object.defineProperty(e,t,{configurable:!0,get:function(){return l.call(this)},set:function(o){i=""+o,s.call(this,o)}}),Object.defineProperty(e,t,{enumerable:a.enumerable}),{getValue:function(){return i},setValue:function(o){i=""+o},stopTracking:function(){e._valueTracker=null,delete e[t]}}}}function Zn(e){e._valueTracker||(e._valueTracker=qp(e))}function gc(e){if(!e)return!1;var t=e._valueTracker;if(!t)return!0;var a=t.getValue(),i="";return e&&(i=hc(e)?e.checked?"true":"false":e.value),e=i,e!==a?(t.setValue(e),!0):!1}function Jn(e){if(e=e||(typeof document<"u"?document:void 0),typeof e>"u")return null;try{return e.activeElement||e.body}catch{return e.body}}var Qp=/[\n"\\]/g;function ht(e){return e.replace(Qp,function(t){return"\\"+t.charCodeAt(0).toString(16)+" "})}function zs(e,t,a,i,l,s,o,u){e.name="",o!=null&&typeof o!="function"&&typeof o!="symbol"&&typeof o!="boolean"?e.type=o:e.removeAttribute("type"),t!=null?o==="number"?(t===0&&e.value===""||e.value!=t)&&(e.value=""+pt(t)):e.value!==""+pt(t)&&(e.value=""+pt(t)):o!=="submit"&&o!=="reset"||e.removeAttribute("value"),t!=null?Es(e,o,pt(t)):a!=null?Es(e,o,pt(a)):i!=null&&e.removeAttribute("value"),l==null&&s!=null&&(e.defaultChecked=!!s),l!=null&&(e.checked=l&&typeof l!="function"&&typeof l!="symbol"),u!=null&&typeof u!="function"&&typeof u!="symbol"&&typeof u!="boolean"?e.name=""+pt(u):e.removeAttribute("name")}function xc(e,t,a,i,l,s,o,u){if(s!=null&&typeof s!="function"&&typeof s!="symbol"&&typeof s!="boolean"&&(e.type=s),t!=null||a!=null){if(!(s!=="submit"&&s!=="reset"||t!=null))return;a=a!=null?""+pt(a):"",t=t!=null?""+pt(t):a,u||t===e.value||(e.value=t),e.defaultValue=t}i=i??l,i=typeof i!="function"&&typeof i!="symbol"&&!!i,e.checked=u?e.checked:!!i,e.defaultChecked=!!i,o!=null&&typeof o!="function"&&typeof o!="symbol"&&typeof o!="boolean"&&(e.name=o)}function Es(e,t,a){t==="number"&&Jn(e.ownerDocument)===e||e.defaultValue===""+a||(e.defaultValue=""+a)}function Fa(e,t,a,i){if(e=e.options,t){t={};for(var l=0;l<a.length;l++)t["$"+a[l]]=!0;for(a=0;a<e.length;a++)l=t.hasOwnProperty("$"+e[a].value),e[a].selected!==l&&(e[a].selected=l),l&&i&&(e[a].defaultSelected=!0)}else{for(a=""+pt(a),t=null,l=0;l<e.length;l++){if(e[l].value===a){e[l].selected=!0,i&&(e[l].defaultSelected=!0);return}t!==null||e[l].disabled||(t=e[l])}t!==null&&(t.selected=!0)}}function bc(e,t,a){if(t!=null&&(t=""+pt(t),t!==e.value&&(e.value=t),a==null)){e.defaultValue!==t&&(e.defaultValue=t);return}e.defaultValue=a!=null?""+pt(a):""}function yc(e,t,a,i){if(t==null){if(i!=null){if(a!=null)throw Error(c(92));if(Ie(i)){if(1<i.length)throw Error(c(93));i=i[0]}a=i}a==null&&(a=""),t=a}a=pt(t),e.defaultValue=a,i=e.textContent,i===a&&i!==""&&i!==null&&(e.value=i)}function $a(e,t){if(t){var a=e.firstChild;if(a&&a===e.lastChild&&a.nodeType===3){a.nodeValue=t;return}}e.textContent=t}var Xp=new Set("animationIterationCount aspectRatio borderImageOutset borderImageSlice borderImageWidth boxFlex boxFlexGroup boxOrdinalGroup columnCount columns flex flexGrow flexPositive flexShrink flexNegative flexOrder gridArea gridRow gridRowEnd gridRowSpan gridRowStart gridColumn gridColumnEnd gridColumnSpan gridColumnStart fontWeight lineClamp lineHeight opacity order orphans scale tabSize widows zIndex zoom fillOpacity floodOpacity stopOpacity strokeDasharray strokeDashoffset strokeMiterlimit strokeOpacity strokeWidth MozAnimationIterationCount MozBoxFlex MozBoxFlexGroup MozLineClamp msAnimationIterationCount msFlex msZoom msFlexGrow msFlexNegative msFlexOrder msFlexPositive msFlexShrink msGridColumn msGridColumnSpan msGridRow msGridRowSpan WebkitAnimationIterationCount WebkitBoxFlex WebKitBoxFlexGroup WebkitBoxOrdinalGroup WebkitColumnCount WebkitColumns WebkitFlex WebkitFlexGrow WebkitFlexPositive WebkitFlexShrink WebkitLineClamp".split(" "));function vc(e,t,a){var i=t.indexOf("--")===0;a==null||typeof a=="boolean"||a===""?i?e.setProperty(t,""):t==="float"?e.cssFloat="":e[t]="":i?e.setProperty(t,a):typeof a!="number"||a===0||Xp.has(t)?t==="float"?e.cssFloat=a:e[t]=(""+a).trim():e[t]=a+"px"}function wc(e,t,a){if(t!=null&&typeof t!="object")throw Error(c(62));if(e=e.style,a!=null){for(var i in a)!a.hasOwnProperty(i)||t!=null&&t.hasOwnProperty(i)||(i.indexOf("--")===0?e.setProperty(i,""):i==="float"?e.cssFloat="":e[i]="");for(var l in t)i=t[l],t.hasOwnProperty(l)&&a[l]!==i&&vc(e,l,i)}else for(var s in t)t.hasOwnProperty(s)&&vc(e,s,t[s])}function Cs(e){if(e.indexOf("-")===-1)return!1;switch(e){case"annotation-xml":case"color-profile":case"font-face":case"font-face-src":case"font-face-uri":case"font-face-format":case"font-face-name":case"missing-glyph":return!1;default:return!0}}var Vp=new Map([["acceptCharset","accept-charset"],["htmlFor","for"],["httpEquiv","http-equiv"],["crossOrigin","crossorigin"],["accentHeight","accent-height"],["alignmentBaseline","alignment-baseline"],["arabicForm","arabic-form"],["baselineShift","baseline-shift"],["capHeight","cap-height"],["clipPath","clip-path"],["clipRule","clip-rule"],["colorInterpolation","color-interpolation"],["colorInterpolationFilters","color-interpolation-filters"],["colorProfile","color-profile"],["colorRendering","color-rendering"],["dominantBaseline","dominant-baseline"],["enableBackground","enable-background"],["fillOpacity","fill-opacity"],["fillRule","fill-rule"],["floodColor","flood-color"],["floodOpacity","flood-opacity"],["fontFamily","font-family"],["fontSize","font-size"],["fontSizeAdjust","font-size-adjust"],["fontStretch","font-stretch"],["fontStyle","font-style"],["fontVariant","font-variant"],["fontWeight","font-weight"],["glyphName","glyph-name"],["glyphOrientationHorizontal","glyph-orientation-horizontal"],["glyphOrientationVertical","glyph-orientation-vertical"],["horizAdvX","horiz-adv-x"],["horizOriginX","horiz-origin-x"],["imageRendering","image-rendering"],["letterSpacing","letter-spacing"],["lightingColor","lighting-color"],["markerEnd","marker-end"],["markerMid","marker-mid"],["markerStart","marker-start"],["overlinePosition","overline-position"],["overlineThickness","overline-thickness"],["paintOrder","paint-order"],["panose-1","panose-1"],["pointerEvents","pointer-events"],["renderingIntent","rendering-intent"],["shapeRendering","shape-rendering"],["stopColor","stop-color"],["stopOpacity","stop-opacity"],["strikethroughPosition","strikethrough-position"],["strikethroughThickness","strikethrough-thickness"],["strokeDasharray","stroke-dasharray"],["strokeDashoffset","stroke-dashoffset"],["strokeLinecap","stroke-linecap"],["strokeLinejoin","stroke-linejoin"],["strokeMiterlimit","stroke-miterlimit"],["strokeOpacity","stroke-opacity"],["strokeWidth","stroke-width"],["textAnchor","text-anchor"],["textDecoration","text-decoration"],["textRendering","text-rendering"],["transformOrigin","transform-origin"],["underlinePosition","underline-position"],["underlineThickness","underline-thickness"],["unicodeBidi","unicode-bidi"],["unicodeRange","unicode-range"],["unitsPerEm","units-per-em"],["vAlphabetic","v-alphabetic"],["vHanging","v-hanging"],["vIdeographic","v-ideographic"],["vMathematical","v-mathematical"],["vectorEffect","vector-effect"],["vertAdvY","vert-adv-y"],["vertOriginX","vert-origin-x"],["vertOriginY","vert-origin-y"],["wordSpacing","word-spacing"],["writingMode","writing-mode"],["xmlnsXlink","xmlns:xlink"],["xHeight","x-height"]]),Ip=/^[\u0000-\u001F ]*j[\r\n\t]*a[\r\n\t]*v[\r\n\t]*a[\r\n\t]*s[\r\n\t]*c[\r\n\t]*r[\r\n\t]*i[\r\n\t]*p[\r\n\t]*t[\r\n\t]*:/i;function Wn(e){return Ip.test(""+e)?"javascript:throw new Error('React has blocked a javascript: URL as a security precaution.')":e}var Ts=null;function Ms(e){return e=e.target||e.srcElement||window,e.correspondingUseElement&&(e=e.correspondingUseElement),e.nodeType===3?e.parentNode:e}var Pa=null,ei=null;function jc(e){var t=Ka(e);if(t&&(e=t.stateNode)){var a=e[Pe]||null;e:switch(e=t.stateNode,t.type){case"input":if(zs(e,a.value,a.defaultValue,a.defaultValue,a.checked,a.defaultChecked,a.type,a.name),t=a.name,a.type==="radio"&&t!=null){for(a=e;a.parentNode;)a=a.parentNode;for(a=a.querySelectorAll('input[name="'+ht(""+t)+'"][type="radio"]'),t=0;t<a.length;t++){var i=a[t];if(i!==e&&i.form===e.form){var l=i[Pe]||null;if(!l)throw Error(c(90));zs(i,l.value,l.defaultValue,l.defaultValue,l.checked,l.defaultChecked,l.type,l.name)}}for(t=0;t<a.length;t++)i=a[t],i.form===e.form&&gc(i)}break e;case"textarea":bc(e,a.value,a.defaultValue);break e;case"select":t=a.value,t!=null&&Fa(e,!!a.multiple,t,!1)}}}var Ds=!1;function Ac(e,t,a){if(Ds)return e(t,a);Ds=!0;try{var i=e(t);return i}finally{if(Ds=!1,(Pa!==null||ei!==null)&&(Ul(),Pa&&(t=Pa,e=ei,ei=Pa=null,jc(t),e)))for(t=0;t<e.length;t++)jc(e[t])}}function _i(e,t){var a=e.stateNode;if(a===null)return null;var i=a[Pe]||null;if(i===null)return null;a=i[t];e:switch(t){case"onClick":case"onClickCapture":case"onDoubleClick":case"onDoubleClickCapture":case"onMouseDown":case"onMouseDownCapture":case"onMouseMove":case"onMouseMoveCapture":case"onMouseUp":case"onMouseUpCapture":case"onMouseEnter":(i=!i.disabled)||(e=e.type,i=!(e==="button"||e==="input"||e==="select"||e==="textarea")),e=!i;break e;default:e=!1}if(e)return null;if(a&&typeof a!="function")throw Error(c(231,t,typeof a));return a}var Ht=!(typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"),Rs=!1;if(Ht)try{var Li={};Object.defineProperty(Li,"passive",{get:function(){Rs=!0}}),window.addEventListener("test",Li,Li),window.removeEventListener("test",Li,Li)}catch{Rs=!1}var na=null,Os=null,Fn=null;function Nc(){if(Fn)return Fn;var e,t=Os,a=t.length,i,l="value"in na?na.value:na.textContent,s=l.length;for(e=0;e<a&&t[e]===l[e];e++);var o=a-e;for(i=1;i<=o&&t[a-i]===l[s-i];i++);return Fn=l.slice(e,1<i?1-i:void 0)}function $n(e){var t=e.keyCode;return"charCode"in e?(e=e.charCode,e===0&&t===13&&(e=13)):e=t,e===10&&(e=13),32<=e||e===13?e:0}function Pn(){return!0}function Sc(){return!1}function et(e){function t(a,i,l,s,o){this._reactName=a,this._targetInst=l,this.type=i,this.nativeEvent=s,this.target=o,this.currentTarget=null;for(var u in e)e.hasOwnProperty(u)&&(a=e[u],this[u]=a?a(s):s[u]);return this.isDefaultPrevented=(s.defaultPrevented!=null?s.defaultPrevented:s.returnValue===!1)?Pn:Sc,this.isPropagationStopped=Sc,this}return v(t.prototype,{preventDefault:function(){this.defaultPrevented=!0;var a=this.nativeEvent;a&&(a.preventDefault?a.preventDefault():typeof a.returnValue!="unknown"&&(a.returnValue=!1),this.isDefaultPrevented=Pn)},stopPropagation:function(){var a=this.nativeEvent;a&&(a.stopPropagation?a.stopPropagation():typeof a.cancelBubble!="unknown"&&(a.cancelBubble=!0),this.isPropagationStopped=Pn)},persist:function(){},isPersistent:Pn}),t}var Ea={eventPhase:0,bubbles:0,cancelable:0,timeStamp:function(e){return e.timeStamp||Date.now()},defaultPrevented:0,isTrusted:0},el=et(Ea),Gi=v({},Ea,{view:0,detail:0}),Kp=et(Gi),Us,Bs,Yi,tl=v({},Gi,{screenX:0,screenY:0,clientX:0,clientY:0,pageX:0,pageY:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,getModifierState:_s,button:0,buttons:0,relatedTarget:function(e){return e.relatedTarget===void 0?e.fromElement===e.srcElement?e.toElement:e.fromElement:e.relatedTarget},movementX:function(e){return"movementX"in e?e.movementX:(e!==Yi&&(Yi&&e.type==="mousemove"?(Us=e.screenX-Yi.screenX,Bs=e.screenY-Yi.screenY):Bs=Us=0,Yi=e),Us)},movementY:function(e){return"movementY"in e?e.movementY:Bs}}),kc=et(tl),Zp=v({},tl,{dataTransfer:0}),Jp=et(Zp),Wp=v({},Gi,{relatedTarget:0}),Hs=et(Wp),Fp=v({},Ea,{animationName:0,elapsedTime:0,pseudoElement:0}),$p=et(Fp),Pp=v({},Ea,{clipboardData:function(e){return"clipboardData"in e?e.clipboardData:window.clipboardData}}),eh=et(Pp),th=v({},Ea,{data:0}),zc=et(th),ah={Esc:"Escape",Spacebar:" ",Left:"ArrowLeft",Up:"ArrowUp",Right:"ArrowRight",Down:"ArrowDown",Del:"Delete",Win:"OS",Menu:"ContextMenu",Apps:"ContextMenu",Scroll:"ScrollLock",MozPrintableKey:"Unidentified"},ih={8:"Backspace",9:"Tab",12:"Clear",13:"Enter",16:"Shift",17:"Control",18:"Alt",19:"Pause",20:"CapsLock",27:"Escape",32:" ",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"ArrowLeft",38:"ArrowUp",39:"ArrowRight",40:"ArrowDown",45:"Insert",46:"Delete",112:"F1",113:"F2",114:"F3",115:"F4",116:"F5",117:"F6",118:"F7",119:"F8",120:"F9",121:"F10",122:"F11",123:"F12",144:"NumLock",145:"ScrollLock",224:"Meta"},nh={Alt:"altKey",Control:"ctrlKey",Meta:"metaKey",Shift:"shiftKey"};function lh(e){var t=this.nativeEvent;return t.getModifierState?t.getModifierState(e):(e=nh[e])?!!t[e]:!1}function _s(){return lh}var sh=v({},Gi,{key:function(e){if(e.key){var t=ah[e.key]||e.key;if(t!=="Unidentified")return t}return e.type==="keypress"?(e=$n(e),e===13?"Enter":String.fromCharCode(e)):e.type==="keydown"||e.type==="keyup"?ih[e.keyCode]||"Unidentified":""},code:0,location:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,repeat:0,locale:0,getModifierState:_s,charCode:function(e){return e.type==="keypress"?$n(e):0},keyCode:function(e){return e.type==="keydown"||e.type==="keyup"?e.keyCode:0},which:function(e){return e.type==="keypress"?$n(e):e.type==="keydown"||e.type==="keyup"?e.keyCode:0}}),rh=et(sh),oh=v({},tl,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0}),Ec=et(oh),ch=v({},Gi,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:_s}),dh=et(ch),uh=v({},Ea,{propertyName:0,elapsedTime:0,pseudoElement:0}),mh=et(uh),fh=v({},tl,{deltaX:function(e){return"deltaX"in e?e.deltaX:"wheelDeltaX"in e?-e.wheelDeltaX:0},deltaY:function(e){return"deltaY"in e?e.deltaY:"wheelDeltaY"in e?-e.wheelDeltaY:"wheelDelta"in e?-e.wheelDelta:0},deltaZ:0,deltaMode:0}),ph=et(fh),hh=v({},Ea,{newState:0,oldState:0}),gh=et(hh),xh=[9,13,27,32],Ls=Ht&&"CompositionEvent"in window,qi=null;Ht&&"documentMode"in document&&(qi=document.documentMode);var bh=Ht&&"TextEvent"in window&&!qi,Cc=Ht&&(!Ls||qi&&8<qi&&11>=qi),Tc=" ",Mc=!1;function Dc(e,t){switch(e){case"keyup":return xh.indexOf(t.keyCode)!==-1;case"keydown":return t.keyCode!==229;case"keypress":case"mousedown":case"focusout":return!0;default:return!1}}function Rc(e){return e=e.detail,typeof e=="object"&&"data"in e?e.data:null}var ti=!1;function yh(e,t){switch(e){case"compositionend":return Rc(t);case"keypress":return t.which!==32?null:(Mc=!0,Tc);case"textInput":return e=t.data,e===Tc&&Mc?null:e;default:return null}}function vh(e,t){if(ti)return e==="compositionend"||!Ls&&Dc(e,t)?(e=Nc(),Fn=Os=na=null,ti=!1,e):null;switch(e){case"paste":return null;case"keypress":if(!(t.ctrlKey||t.altKey||t.metaKey)||t.ctrlKey&&t.altKey){if(t.char&&1<t.char.length)return t.char;if(t.which)return String.fromCharCode(t.which)}return null;case"compositionend":return Cc&&t.locale!=="ko"?null:t.data;default:return null}}var wh={color:!0,date:!0,datetime:!0,"datetime-local":!0,email:!0,month:!0,number:!0,password:!0,range:!0,search:!0,tel:!0,text:!0,time:!0,url:!0,week:!0};function Oc(e){var t=e&&e.nodeName&&e.nodeName.toLowerCase();return t==="input"?!!wh[e.type]:t==="textarea"}function Uc(e,t,a,i){Pa?ei?ei.push(i):ei=[i]:Pa=i,t=Yl(t,"onChange"),0<t.length&&(a=new el("onChange","change",null,a,i),e.push({event:a,listeners:t}))}var Qi=null,Xi=null;function jh(e){hm(e,0)}function al(e){var t=Hi(e);if(gc(t))return e}function Bc(e,t){if(e==="change")return t}var Hc=!1;if(Ht){var Gs;if(Ht){var Ys="oninput"in document;if(!Ys){var _c=document.createElement("div");_c.setAttribute("oninput","return;"),Ys=typeof _c.oninput=="function"}Gs=Ys}else Gs=!1;Hc=Gs&&(!document.documentMode||9<document.documentMode)}function Lc(){Qi&&(Qi.detachEvent("onpropertychange",Gc),Xi=Qi=null)}function Gc(e){if(e.propertyName==="value"&&al(Xi)){var t=[];Uc(t,Xi,e,Ms(e)),Ac(jh,t)}}function Ah(e,t,a){e==="focusin"?(Lc(),Qi=t,Xi=a,Qi.attachEvent("onpropertychange",Gc)):e==="focusout"&&Lc()}function Nh(e){if(e==="selectionchange"||e==="keyup"||e==="keydown")return al(Xi)}function Sh(e,t){if(e==="click")return al(t)}function kh(e,t){if(e==="input"||e==="change")return al(t)}function zh(e,t){return e===t&&(e!==0||1/e===1/t)||e!==e&&t!==t}var rt=typeof Object.is=="function"?Object.is:zh;function Vi(e,t){if(rt(e,t))return!0;if(typeof e!="object"||e===null||typeof t!="object"||t===null)return!1;var a=Object.keys(e),i=Object.keys(t);if(a.length!==i.length)return!1;for(i=0;i<a.length;i++){var l=a[i];if(!gs.call(t,l)||!rt(e[l],t[l]))return!1}return!0}function Yc(e){for(;e&&e.firstChild;)e=e.firstChild;return e}function qc(e,t){var a=Yc(e);e=0;for(var i;a;){if(a.nodeType===3){if(i=e+a.textContent.length,e<=t&&i>=t)return{node:a,offset:t-e};e=i}e:{for(;a;){if(a.nextSibling){a=a.nextSibling;break e}a=a.parentNode}a=void 0}a=Yc(a)}}function Qc(e,t){return e&&t?e===t?!0:e&&e.nodeType===3?!1:t&&t.nodeType===3?Qc(e,t.parentNode):"contains"in e?e.contains(t):e.compareDocumentPosition?!!(e.compareDocumentPosition(t)&16):!1:!1}function Xc(e){e=e!=null&&e.ownerDocument!=null&&e.ownerDocument.defaultView!=null?e.ownerDocument.defaultView:window;for(var t=Jn(e.document);t instanceof e.HTMLIFrameElement;){try{var a=typeof t.contentWindow.location.href=="string"}catch{a=!1}if(a)e=t.contentWindow;else break;t=Jn(e.document)}return t}function qs(e){var t=e&&e.nodeName&&e.nodeName.toLowerCase();return t&&(t==="input"&&(e.type==="text"||e.type==="search"||e.type==="tel"||e.type==="url"||e.type==="password")||t==="textarea"||e.contentEditable==="true")}var Eh=Ht&&"documentMode"in document&&11>=document.documentMode,ai=null,Qs=null,Ii=null,Xs=!1;function Vc(e,t,a){var i=a.window===a?a.document:a.nodeType===9?a:a.ownerDocument;Xs||ai==null||ai!==Jn(i)||(i=ai,"selectionStart"in i&&qs(i)?i={start:i.selectionStart,end:i.selectionEnd}:(i=(i.ownerDocument&&i.ownerDocument.defaultView||window).getSelection(),i={anchorNode:i.anchorNode,anchorOffset:i.anchorOffset,focusNode:i.focusNode,focusOffset:i.focusOffset}),Ii&&Vi(Ii,i)||(Ii=i,i=Yl(Qs,"onSelect"),0<i.length&&(t=new el("onSelect","select",null,t,a),e.push({event:t,listeners:i}),t.target=ai)))}function Ca(e,t){var a={};return a[e.toLowerCase()]=t.toLowerCase(),a["Webkit"+e]="webkit"+t,a["Moz"+e]="moz"+t,a}var ii={animationend:Ca("Animation","AnimationEnd"),animationiteration:Ca("Animation","AnimationIteration"),animationstart:Ca("Animation","AnimationStart"),transitionrun:Ca("Transition","TransitionRun"),transitionstart:Ca("Transition","TransitionStart"),transitioncancel:Ca("Transition","TransitionCancel"),transitionend:Ca("Transition","TransitionEnd")},Vs={},Ic={};Ht&&(Ic=document.createElement("div").style,"AnimationEvent"in window||(delete ii.animationend.animation,delete ii.animationiteration.animation,delete ii.animationstart.animation),"TransitionEvent"in window||delete ii.transitionend.transition);function Ta(e){if(Vs[e])return Vs[e];if(!ii[e])return e;var t=ii[e],a;for(a in t)if(t.hasOwnProperty(a)&&a in Ic)return Vs[e]=t[a];return e}var Kc=Ta("animationend"),Zc=Ta("animationiteration"),Jc=Ta("animationstart"),Ch=Ta("transitionrun"),Th=Ta("transitionstart"),Mh=Ta("transitioncancel"),Wc=Ta("transitionend"),Fc=new Map,Is="abort auxClick beforeToggle cancel canPlay canPlayThrough click close contextMenu copy cut drag dragEnd dragEnter dragExit dragLeave dragOver dragStart drop durationChange emptied encrypted ended error gotPointerCapture input invalid keyDown keyPress keyUp load loadedData loadedMetadata loadStart lostPointerCapture mouseDown mouseMove mouseOut mouseOver mouseUp paste pause play playing pointerCancel pointerDown pointerMove pointerOut pointerOver pointerUp progress rateChange reset resize seeked seeking stalled submit suspend timeUpdate touchCancel touchEnd touchStart volumeChange scroll toggle touchMove waiting wheel".split(" ");Is.push("scrollEnd");function Nt(e,t){Fc.set(e,t),za(t,[e])}var $c=new WeakMap;function gt(e,t){if(typeof e=="object"&&e!==null){var a=$c.get(e);return a!==void 0?a:(t={value:e,source:t,stack:pc(t)},$c.set(e,t),t)}return{value:e,source:t,stack:pc(t)}}var xt=[],ni=0,Ks=0;function il(){for(var e=ni,t=Ks=ni=0;t<e;){var a=xt[t];xt[t++]=null;var i=xt[t];xt[t++]=null;var l=xt[t];xt[t++]=null;var s=xt[t];if(xt[t++]=null,i!==null&&l!==null){var o=i.pending;o===null?l.next=l:(l.next=o.next,o.next=l),i.pending=l}s!==0&&Pc(a,l,s)}}function nl(e,t,a,i){xt[ni++]=e,xt[ni++]=t,xt[ni++]=a,xt[ni++]=i,Ks|=i,e.lanes|=i,e=e.alternate,e!==null&&(e.lanes|=i)}function Zs(e,t,a,i){return nl(e,t,a,i),ll(e)}function li(e,t){return nl(e,null,null,t),ll(e)}function Pc(e,t,a){e.lanes|=a;var i=e.alternate;i!==null&&(i.lanes|=a);for(var l=!1,s=e.return;s!==null;)s.childLanes|=a,i=s.alternate,i!==null&&(i.childLanes|=a),s.tag===22&&(e=s.stateNode,e===null||e._visibility&1||(l=!0)),e=s,s=s.return;return e.tag===3?(s=e.stateNode,l&&t!==null&&(l=31-st(a),e=s.hiddenUpdates,i=e[l],i===null?e[l]=[t]:i.push(t),t.lane=a|536870912),s):null}function ll(e){if(50<bn)throw bn=0,eo=null,Error(c(185));for(var t=e.return;t!==null;)e=t,t=e.return;return e.tag===3?e.stateNode:null}var si={};function Dh(e,t,a,i){this.tag=e,this.key=a,this.sibling=this.child=this.return=this.stateNode=this.type=this.elementType=null,this.index=0,this.refCleanup=this.ref=null,this.pendingProps=t,this.dependencies=this.memoizedState=this.updateQueue=this.memoizedProps=null,this.mode=i,this.subtreeFlags=this.flags=0,this.deletions=null,this.childLanes=this.lanes=0,this.alternate=null}function ot(e,t,a,i){return new Dh(e,t,a,i)}function Js(e){return e=e.prototype,!(!e||!e.isReactComponent)}function _t(e,t){var a=e.alternate;return a===null?(a=ot(e.tag,t,e.key,e.mode),a.elementType=e.elementType,a.type=e.type,a.stateNode=e.stateNode,a.alternate=e,e.alternate=a):(a.pendingProps=t,a.type=e.type,a.flags=0,a.subtreeFlags=0,a.deletions=null),a.flags=e.flags&65011712,a.childLanes=e.childLanes,a.lanes=e.lanes,a.child=e.child,a.memoizedProps=e.memoizedProps,a.memoizedState=e.memoizedState,a.updateQueue=e.updateQueue,t=e.dependencies,a.dependencies=t===null?null:{lanes:t.lanes,firstContext:t.firstContext},a.sibling=e.sibling,a.index=e.index,a.ref=e.ref,a.refCleanup=e.refCleanup,a}function ed(e,t){e.flags&=65011714;var a=e.alternate;return a===null?(e.childLanes=0,e.lanes=t,e.child=null,e.subtreeFlags=0,e.memoizedProps=null,e.memoizedState=null,e.updateQueue=null,e.dependencies=null,e.stateNode=null):(e.childLanes=a.childLanes,e.lanes=a.lanes,e.child=a.child,e.subtreeFlags=0,e.deletions=null,e.memoizedProps=a.memoizedProps,e.memoizedState=a.memoizedState,e.updateQueue=a.updateQueue,e.type=a.type,t=a.dependencies,e.dependencies=t===null?null:{lanes:t.lanes,firstContext:t.firstContext}),e}function sl(e,t,a,i,l,s){var o=0;if(i=e,typeof e=="function")Js(e)&&(o=1);else if(typeof e=="string")o=O0(e,a,W.current)?26:e==="html"||e==="head"||e==="body"?27:5;else e:switch(e){case P:return e=ot(31,a,t,l),e.elementType=P,e.lanes=s,e;case _:return Ma(a.children,l,s,t);case Y:o=8,l|=24;break;case G:return e=ot(12,a,t,l|2),e.elementType=G,e.lanes=s,e;case Z:return e=ot(13,a,t,l),e.elementType=Z,e.lanes=s,e;case xe:return e=ot(19,a,t,l),e.elementType=xe,e.lanes=s,e;default:if(typeof e=="object"&&e!==null)switch(e.$$typeof){case B:case J:o=10;break e;case L:o=9;break e;case me:o=11;break e;case pe:o=14;break e;case X:o=16,i=null;break e}o=29,a=Error(c(130,e===null?"null":typeof e,"")),i=null}return t=ot(o,a,t,l),t.elementType=e,t.type=i,t.lanes=s,t}function Ma(e,t,a,i){return e=ot(7,e,i,t),e.lanes=a,e}function Ws(e,t,a){return e=ot(6,e,null,t),e.lanes=a,e}function Fs(e,t,a){return t=ot(4,e.children!==null?e.children:[],e.key,t),t.lanes=a,t.stateNode={containerInfo:e.containerInfo,pendingChildren:null,implementation:e.implementation},t}var ri=[],oi=0,rl=null,ol=0,bt=[],yt=0,Da=null,Lt=1,Gt="";function Ra(e,t){ri[oi++]=ol,ri[oi++]=rl,rl=e,ol=t}function td(e,t,a){bt[yt++]=Lt,bt[yt++]=Gt,bt[yt++]=Da,Da=e;var i=Lt;e=Gt;var l=32-st(i)-1;i&=~(1<<l),a+=1;var s=32-st(t)+l;if(30<s){var o=l-l%5;s=(i&(1<<o)-1).toString(32),i>>=o,l-=o,Lt=1<<32-st(t)+l|a<<l|i,Gt=s+e}else Lt=1<<s|a<<l|i,Gt=e}function $s(e){e.return!==null&&(Ra(e,1),td(e,1,0))}function Ps(e){for(;e===rl;)rl=ri[--oi],ri[oi]=null,ol=ri[--oi],ri[oi]=null;for(;e===Da;)Da=bt[--yt],bt[yt]=null,Gt=bt[--yt],bt[yt]=null,Lt=bt[--yt],bt[yt]=null}var Fe=null,Ce=null,fe=!1,Oa=null,Ct=!1,er=Error(c(519));function Ua(e){var t=Error(c(418,""));throw Ji(gt(t,e)),er}function ad(e){var t=e.stateNode,a=e.type,i=e.memoizedProps;switch(t[Ke]=e,t[Pe]=i,a){case"dialog":re("cancel",t),re("close",t);break;case"iframe":case"object":case"embed":re("load",t);break;case"video":case"audio":for(a=0;a<vn.length;a++)re(vn[a],t);break;case"source":re("error",t);break;case"img":case"image":case"link":re("error",t),re("load",t);break;case"details":re("toggle",t);break;case"input":re("invalid",t),xc(t,i.value,i.defaultValue,i.checked,i.defaultChecked,i.type,i.name,!0),Zn(t);break;case"select":re("invalid",t);break;case"textarea":re("invalid",t),yc(t,i.value,i.defaultValue,i.children),Zn(t)}a=i.children,typeof a!="string"&&typeof a!="number"&&typeof a!="bigint"||t.textContent===""+a||i.suppressHydrationWarning===!0||ym(t.textContent,a)?(i.popover!=null&&(re("beforetoggle",t),re("toggle",t)),i.onScroll!=null&&re("scroll",t),i.onScrollEnd!=null&&re("scrollend",t),i.onClick!=null&&(t.onclick=ql),t=!0):t=!1,t||Ua(e)}function id(e){for(Fe=e.return;Fe;)switch(Fe.tag){case 5:case 13:Ct=!1;return;case 27:case 3:Ct=!0;return;default:Fe=Fe.return}}function Ki(e){if(e!==Fe)return!1;if(!fe)return id(e),fe=!0,!1;var t=e.tag,a;if((a=t!==3&&t!==27)&&((a=t===5)&&(a=e.type,a=!(a!=="form"&&a!=="button")||xo(e.type,e.memoizedProps)),a=!a),a&&Ce&&Ua(e),id(e),t===13){if(e=e.memoizedState,e=e!==null?e.dehydrated:null,!e)throw Error(c(317));e:{for(e=e.nextSibling,t=0;e;){if(e.nodeType===8)if(a=e.data,a==="/$"){if(t===0){Ce=kt(e.nextSibling);break e}t--}else a!=="$"&&a!=="$!"&&a!=="$?"||t++;e=e.nextSibling}Ce=null}}else t===27?(t=Ce,va(e.type)?(e=wo,wo=null,Ce=e):Ce=t):Ce=Fe?kt(e.stateNode.nextSibling):null;return!0}function Zi(){Ce=Fe=null,fe=!1}function nd(){var e=Oa;return e!==null&&(it===null?it=e:it.push.apply(it,e),Oa=null),e}function Ji(e){Oa===null?Oa=[e]:Oa.push(e)}var tr=H(null),Ba=null,Yt=null;function la(e,t,a){q(tr,t._currentValue),t._currentValue=a}function qt(e){e._currentValue=tr.current,V(tr)}function ar(e,t,a){for(;e!==null;){var i=e.alternate;if((e.childLanes&t)!==t?(e.childLanes|=t,i!==null&&(i.childLanes|=t)):i!==null&&(i.childLanes&t)!==t&&(i.childLanes|=t),e===a)break;e=e.return}}function ir(e,t,a,i){var l=e.child;for(l!==null&&(l.return=e);l!==null;){var s=l.dependencies;if(s!==null){var o=l.child;s=s.firstContext;e:for(;s!==null;){var u=s;s=l;for(var h=0;h<t.length;h++)if(u.context===t[h]){s.lanes|=a,u=s.alternate,u!==null&&(u.lanes|=a),ar(s.return,a,e),i||(o=null);break e}s=u.next}}else if(l.tag===18){if(o=l.return,o===null)throw Error(c(341));o.lanes|=a,s=o.alternate,s!==null&&(s.lanes|=a),ar(o,a,e),o=null}else o=l.child;if(o!==null)o.return=l;else for(o=l;o!==null;){if(o===e){o=null;break}if(l=o.sibling,l!==null){l.return=o.return,o=l;break}o=o.return}l=o}}function Wi(e,t,a,i){e=null;for(var l=t,s=!1;l!==null;){if(!s){if((l.flags&524288)!==0)s=!0;else if((l.flags&262144)!==0)break}if(l.tag===10){var o=l.alternate;if(o===null)throw Error(c(387));if(o=o.memoizedProps,o!==null){var u=l.type;rt(l.pendingProps.value,o.value)||(e!==null?e.push(u):e=[u])}}else if(l===nt.current){if(o=l.alternate,o===null)throw Error(c(387));o.memoizedState.memoizedState!==l.memoizedState.memoizedState&&(e!==null?e.push(kn):e=[kn])}l=l.return}e!==null&&ir(t,e,a,i),t.flags|=262144}function cl(e){for(e=e.firstContext;e!==null;){if(!rt(e.context._currentValue,e.memoizedValue))return!0;e=e.next}return!1}function Ha(e){Ba=e,Yt=null,e=e.dependencies,e!==null&&(e.firstContext=null)}function Ze(e){return ld(Ba,e)}function dl(e,t){return Ba===null&&Ha(e),ld(e,t)}function ld(e,t){var a=t._currentValue;if(t={context:t,memoizedValue:a,next:null},Yt===null){if(e===null)throw Error(c(308));Yt=t,e.dependencies={lanes:0,firstContext:t},e.flags|=524288}else Yt=Yt.next=t;return a}var Rh=typeof AbortController<"u"?AbortController:function(){var e=[],t=this.signal={aborted:!1,addEventListener:function(a,i){e.push(i)}};this.abort=function(){t.aborted=!0,e.forEach(function(a){return a()})}},Oh=r.unstable_scheduleCallback,Uh=r.unstable_NormalPriority,Be={$$typeof:J,Consumer:null,Provider:null,_currentValue:null,_currentValue2:null,_threadCount:0};function nr(){return{controller:new Rh,data:new Map,refCount:0}}function Fi(e){e.refCount--,e.refCount===0&&Oh(Uh,function(){e.controller.abort()})}var $i=null,lr=0,ci=0,di=null;function Bh(e,t){if($i===null){var a=$i=[];lr=0,ci=ro(),di={status:"pending",value:void 0,then:function(i){a.push(i)}}}return lr++,t.then(sd,sd),t}function sd(){if(--lr===0&&$i!==null){di!==null&&(di.status="fulfilled");var e=$i;$i=null,ci=0,di=null;for(var t=0;t<e.length;t++)(0,e[t])()}}function Hh(e,t){var a=[],i={status:"pending",value:null,reason:null,then:function(l){a.push(l)}};return e.then(function(){i.status="fulfilled",i.value=t;for(var l=0;l<a.length;l++)(0,a[l])(t)},function(l){for(i.status="rejected",i.reason=l,l=0;l<a.length;l++)(0,a[l])(void 0)}),i}var rd=D.S;D.S=function(e,t){typeof t=="object"&&t!==null&&typeof t.then=="function"&&Bh(e,t),rd!==null&&rd(e,t)};var _a=H(null);function sr(){var e=_a.current;return e!==null?e:Ne.pooledCache}function ul(e,t){t===null?q(_a,_a.current):q(_a,t.pool)}function od(){var e=sr();return e===null?null:{parent:Be._currentValue,pool:e}}var Pi=Error(c(460)),cd=Error(c(474)),ml=Error(c(542)),rr={then:function(){}};function dd(e){return e=e.status,e==="fulfilled"||e==="rejected"}function fl(){}function ud(e,t,a){switch(a=e[a],a===void 0?e.push(t):a!==t&&(t.then(fl,fl),t=a),t.status){case"fulfilled":return t.value;case"rejected":throw e=t.reason,fd(e),e;default:if(typeof t.status=="string")t.then(fl,fl);else{if(e=Ne,e!==null&&100<e.shellSuspendCounter)throw Error(c(482));e=t,e.status="pending",e.then(function(i){if(t.status==="pending"){var l=t;l.status="fulfilled",l.value=i}},function(i){if(t.status==="pending"){var l=t;l.status="rejected",l.reason=i}})}switch(t.status){case"fulfilled":return t.value;case"rejected":throw e=t.reason,fd(e),e}throw en=t,Pi}}var en=null;function md(){if(en===null)throw Error(c(459));var e=en;return en=null,e}function fd(e){if(e===Pi||e===ml)throw Error(c(483))}var sa=!1;function or(e){e.updateQueue={baseState:e.memoizedState,firstBaseUpdate:null,lastBaseUpdate:null,shared:{pending:null,lanes:0,hiddenCallbacks:null},callbacks:null}}function cr(e,t){e=e.updateQueue,t.updateQueue===e&&(t.updateQueue={baseState:e.baseState,firstBaseUpdate:e.firstBaseUpdate,lastBaseUpdate:e.lastBaseUpdate,shared:e.shared,callbacks:null})}function ra(e){return{lane:e,tag:0,payload:null,callback:null,next:null}}function oa(e,t,a){var i=e.updateQueue;if(i===null)return null;if(i=i.shared,(he&2)!==0){var l=i.pending;return l===null?t.next=t:(t.next=l.next,l.next=t),i.pending=t,t=ll(e),Pc(e,null,a),t}return nl(e,i,t,a),ll(e)}function tn(e,t,a){if(t=t.updateQueue,t!==null&&(t=t.shared,(a&4194048)!==0)){var i=t.lanes;i&=e.pendingLanes,a|=i,t.lanes=a,sc(e,a)}}function dr(e,t){var a=e.updateQueue,i=e.alternate;if(i!==null&&(i=i.updateQueue,a===i)){var l=null,s=null;if(a=a.firstBaseUpdate,a!==null){do{var o={lane:a.lane,tag:a.tag,payload:a.payload,callback:null,next:null};s===null?l=s=o:s=s.next=o,a=a.next}while(a!==null);s===null?l=s=t:s=s.next=t}else l=s=t;a={baseState:i.baseState,firstBaseUpdate:l,lastBaseUpdate:s,shared:i.shared,callbacks:i.callbacks},e.updateQueue=a;return}e=a.lastBaseUpdate,e===null?a.firstBaseUpdate=t:e.next=t,a.lastBaseUpdate=t}var ur=!1;function an(){if(ur){var e=di;if(e!==null)throw e}}function nn(e,t,a,i){ur=!1;var l=e.updateQueue;sa=!1;var s=l.firstBaseUpdate,o=l.lastBaseUpdate,u=l.shared.pending;if(u!==null){l.shared.pending=null;var h=u,k=h.next;h.next=null,o===null?s=k:o.next=k,o=h;var M=e.alternate;M!==null&&(M=M.updateQueue,u=M.lastBaseUpdate,u!==o&&(u===null?M.firstBaseUpdate=k:u.next=k,M.lastBaseUpdate=h))}if(s!==null){var U=l.baseState;o=0,M=k=h=null,u=s;do{var z=u.lane&-536870913,T=z!==u.lane;if(T?(oe&z)===z:(i&z)===z){z!==0&&z===ci&&(ur=!0),M!==null&&(M=M.next={lane:0,tag:u.tag,payload:u.payload,callback:null,next:null});e:{var te=e,F=u;z=t;var ve=a;switch(F.tag){case 1:if(te=F.payload,typeof te=="function"){U=te.call(ve,U,z);break e}U=te;break e;case 3:te.flags=te.flags&-65537|128;case 0:if(te=F.payload,z=typeof te=="function"?te.call(ve,U,z):te,z==null)break e;U=v({},U,z);break e;case 2:sa=!0}}z=u.callback,z!==null&&(e.flags|=64,T&&(e.flags|=8192),T=l.callbacks,T===null?l.callbacks=[z]:T.push(z))}else T={lane:z,tag:u.tag,payload:u.payload,callback:u.callback,next:null},M===null?(k=M=T,h=U):M=M.next=T,o|=z;if(u=u.next,u===null){if(u=l.shared.pending,u===null)break;T=u,u=T.next,T.next=null,l.lastBaseUpdate=T,l.shared.pending=null}}while(!0);M===null&&(h=U),l.baseState=h,l.firstBaseUpdate=k,l.lastBaseUpdate=M,s===null&&(l.shared.lanes=0),ga|=o,e.lanes=o,e.memoizedState=U}}function pd(e,t){if(typeof e!="function")throw Error(c(191,e));e.call(t)}function hd(e,t){var a=e.callbacks;if(a!==null)for(e.callbacks=null,e=0;e<a.length;e++)pd(a[e],t)}var ui=H(null),pl=H(0);function gd(e,t){e=Jt,q(pl,e),q(ui,t),Jt=e|t.baseLanes}function mr(){q(pl,Jt),q(ui,ui.current)}function fr(){Jt=pl.current,V(ui),V(pl)}var ca=0,ne=null,be=null,Oe=null,hl=!1,mi=!1,La=!1,gl=0,ln=0,fi=null,_h=0;function De(){throw Error(c(321))}function pr(e,t){if(t===null)return!1;for(var a=0;a<t.length&&a<e.length;a++)if(!rt(e[a],t[a]))return!1;return!0}function hr(e,t,a,i,l,s){return ca=s,ne=t,t.memoizedState=null,t.updateQueue=null,t.lanes=0,D.H=e===null||e.memoizedState===null?Pd:eu,La=!1,s=a(i,l),La=!1,mi&&(s=bd(t,a,i,l)),xd(e),s}function xd(e){D.H=jl;var t=be!==null&&be.next!==null;if(ca=0,Oe=be=ne=null,hl=!1,ln=0,fi=null,t)throw Error(c(300));e===null||Le||(e=e.dependencies,e!==null&&cl(e)&&(Le=!0))}function bd(e,t,a,i){ne=e;var l=0;do{if(mi&&(fi=null),ln=0,mi=!1,25<=l)throw Error(c(301));if(l+=1,Oe=be=null,e.updateQueue!=null){var s=e.updateQueue;s.lastEffect=null,s.events=null,s.stores=null,s.memoCache!=null&&(s.memoCache.index=0)}D.H=Vh,s=t(a,i)}while(mi);return s}function Lh(){var e=D.H,t=e.useState()[0];return t=typeof t.then=="function"?sn(t):t,e=e.useState()[0],(be!==null?be.memoizedState:null)!==e&&(ne.flags|=1024),t}function gr(){var e=gl!==0;return gl=0,e}function xr(e,t,a){t.updateQueue=e.updateQueue,t.flags&=-2053,e.lanes&=~a}function br(e){if(hl){for(e=e.memoizedState;e!==null;){var t=e.queue;t!==null&&(t.pending=null),e=e.next}hl=!1}ca=0,Oe=be=ne=null,mi=!1,ln=gl=0,fi=null}function tt(){var e={memoizedState:null,baseState:null,baseQueue:null,queue:null,next:null};return Oe===null?ne.memoizedState=Oe=e:Oe=Oe.next=e,Oe}function Ue(){if(be===null){var e=ne.alternate;e=e!==null?e.memoizedState:null}else e=be.next;var t=Oe===null?ne.memoizedState:Oe.next;if(t!==null)Oe=t,be=e;else{if(e===null)throw ne.alternate===null?Error(c(467)):Error(c(310));be=e,e={memoizedState:be.memoizedState,baseState:be.baseState,baseQueue:be.baseQueue,queue:be.queue,next:null},Oe===null?ne.memoizedState=Oe=e:Oe=Oe.next=e}return Oe}function yr(){return{lastEffect:null,events:null,stores:null,memoCache:null}}function sn(e){var t=ln;return ln+=1,fi===null&&(fi=[]),e=ud(fi,e,t),t=ne,(Oe===null?t.memoizedState:Oe.next)===null&&(t=t.alternate,D.H=t===null||t.memoizedState===null?Pd:eu),e}function xl(e){if(e!==null&&typeof e=="object"){if(typeof e.then=="function")return sn(e);if(e.$$typeof===J)return Ze(e)}throw Error(c(438,String(e)))}function vr(e){var t=null,a=ne.updateQueue;if(a!==null&&(t=a.memoCache),t==null){var i=ne.alternate;i!==null&&(i=i.updateQueue,i!==null&&(i=i.memoCache,i!=null&&(t={data:i.data.map(function(l){return l.slice()}),index:0})))}if(t==null&&(t={data:[],index:0}),a===null&&(a=yr(),ne.updateQueue=a),a.memoCache=t,a=t.data[t.index],a===void 0)for(a=t.data[t.index]=Array(e),i=0;i<e;i++)a[i]=ce;return t.index++,a}function Qt(e,t){return typeof t=="function"?t(e):t}function bl(e){var t=Ue();return wr(t,be,e)}function wr(e,t,a){var i=e.queue;if(i===null)throw Error(c(311));i.lastRenderedReducer=a;var l=e.baseQueue,s=i.pending;if(s!==null){if(l!==null){var o=l.next;l.next=s.next,s.next=o}t.baseQueue=l=s,i.pending=null}if(s=e.baseState,l===null)e.memoizedState=s;else{t=l.next;var u=o=null,h=null,k=t,M=!1;do{var U=k.lane&-536870913;if(U!==k.lane?(oe&U)===U:(ca&U)===U){var z=k.revertLane;if(z===0)h!==null&&(h=h.next={lane:0,revertLane:0,action:k.action,hasEagerState:k.hasEagerState,eagerState:k.eagerState,next:null}),U===ci&&(M=!0);else if((ca&z)===z){k=k.next,z===ci&&(M=!0);continue}else U={lane:0,revertLane:k.revertLane,action:k.action,hasEagerState:k.hasEagerState,eagerState:k.eagerState,next:null},h===null?(u=h=U,o=s):h=h.next=U,ne.lanes|=z,ga|=z;U=k.action,La&&a(s,U),s=k.hasEagerState?k.eagerState:a(s,U)}else z={lane:U,revertLane:k.revertLane,action:k.action,hasEagerState:k.hasEagerState,eagerState:k.eagerState,next:null},h===null?(u=h=z,o=s):h=h.next=z,ne.lanes|=U,ga|=U;k=k.next}while(k!==null&&k!==t);if(h===null?o=s:h.next=u,!rt(s,e.memoizedState)&&(Le=!0,M&&(a=di,a!==null)))throw a;e.memoizedState=s,e.baseState=o,e.baseQueue=h,i.lastRenderedState=s}return l===null&&(i.lanes=0),[e.memoizedState,i.dispatch]}function jr(e){var t=Ue(),a=t.queue;if(a===null)throw Error(c(311));a.lastRenderedReducer=e;var i=a.dispatch,l=a.pending,s=t.memoizedState;if(l!==null){a.pending=null;var o=l=l.next;do s=e(s,o.action),o=o.next;while(o!==l);rt(s,t.memoizedState)||(Le=!0),t.memoizedState=s,t.baseQueue===null&&(t.baseState=s),a.lastRenderedState=s}return[s,i]}function yd(e,t,a){var i=ne,l=Ue(),s=fe;if(s){if(a===void 0)throw Error(c(407));a=a()}else a=t();var o=!rt((be||l).memoizedState,a);o&&(l.memoizedState=a,Le=!0),l=l.queue;var u=jd.bind(null,i,l,e);if(rn(2048,8,u,[e]),l.getSnapshot!==t||o||Oe!==null&&Oe.memoizedState.tag&1){if(i.flags|=2048,pi(9,yl(),wd.bind(null,i,l,a,t),null),Ne===null)throw Error(c(349));s||(ca&124)!==0||vd(i,t,a)}return a}function vd(e,t,a){e.flags|=16384,e={getSnapshot:t,value:a},t=ne.updateQueue,t===null?(t=yr(),ne.updateQueue=t,t.stores=[e]):(a=t.stores,a===null?t.stores=[e]:a.push(e))}function wd(e,t,a,i){t.value=a,t.getSnapshot=i,Ad(t)&&Nd(e)}function jd(e,t,a){return a(function(){Ad(t)&&Nd(e)})}function Ad(e){var t=e.getSnapshot;e=e.value;try{var a=t();return!rt(e,a)}catch{return!0}}function Nd(e){var t=li(e,2);t!==null&&ft(t,e,2)}function Ar(e){var t=tt();if(typeof e=="function"){var a=e;if(e=a(),La){aa(!0);try{a()}finally{aa(!1)}}}return t.memoizedState=t.baseState=e,t.queue={pending:null,lanes:0,dispatch:null,lastRenderedReducer:Qt,lastRenderedState:e},t}function Sd(e,t,a,i){return e.baseState=a,wr(e,be,typeof i=="function"?i:Qt)}function Gh(e,t,a,i,l){if(wl(e))throw Error(c(485));if(e=t.action,e!==null){var s={payload:l,action:e,next:null,isTransition:!0,status:"pending",value:null,reason:null,listeners:[],then:function(o){s.listeners.push(o)}};D.T!==null?a(!0):s.isTransition=!1,i(s),a=t.pending,a===null?(s.next=t.pending=s,kd(t,s)):(s.next=a.next,t.pending=a.next=s)}}function kd(e,t){var a=t.action,i=t.payload,l=e.state;if(t.isTransition){var s=D.T,o={};D.T=o;try{var u=a(l,i),h=D.S;h!==null&&h(o,u),zd(e,t,u)}catch(k){Nr(e,t,k)}finally{D.T=s}}else try{s=a(l,i),zd(e,t,s)}catch(k){Nr(e,t,k)}}function zd(e,t,a){a!==null&&typeof a=="object"&&typeof a.then=="function"?a.then(function(i){Ed(e,t,i)},function(i){return Nr(e,t,i)}):Ed(e,t,a)}function Ed(e,t,a){t.status="fulfilled",t.value=a,Cd(t),e.state=a,t=e.pending,t!==null&&(a=t.next,a===t?e.pending=null:(a=a.next,t.next=a,kd(e,a)))}function Nr(e,t,a){var i=e.pending;if(e.pending=null,i!==null){i=i.next;do t.status="rejected",t.reason=a,Cd(t),t=t.next;while(t!==i)}e.action=null}function Cd(e){e=e.listeners;for(var t=0;t<e.length;t++)(0,e[t])()}function Td(e,t){return t}function Md(e,t){if(fe){var a=Ne.formState;if(a!==null){e:{var i=ne;if(fe){if(Ce){t:{for(var l=Ce,s=Ct;l.nodeType!==8;){if(!s){l=null;break t}if(l=kt(l.nextSibling),l===null){l=null;break t}}s=l.data,l=s==="F!"||s==="F"?l:null}if(l){Ce=kt(l.nextSibling),i=l.data==="F!";break e}}Ua(i)}i=!1}i&&(t=a[0])}}return a=tt(),a.memoizedState=a.baseState=t,i={pending:null,lanes:0,dispatch:null,lastRenderedReducer:Td,lastRenderedState:t},a.queue=i,a=Wd.bind(null,ne,i),i.dispatch=a,i=Ar(!1),s=Cr.bind(null,ne,!1,i.queue),i=tt(),l={state:t,dispatch:null,action:e,pending:null},i.queue=l,a=Gh.bind(null,ne,l,s,a),l.dispatch=a,i.memoizedState=e,[t,a,!1]}function Dd(e){var t=Ue();return Rd(t,be,e)}function Rd(e,t,a){if(t=wr(e,t,Td)[0],e=bl(Qt)[0],typeof t=="object"&&t!==null&&typeof t.then=="function")try{var i=sn(t)}catch(o){throw o===Pi?ml:o}else i=t;t=Ue();var l=t.queue,s=l.dispatch;return a!==t.memoizedState&&(ne.flags|=2048,pi(9,yl(),Yh.bind(null,l,a),null)),[i,s,e]}function Yh(e,t){e.action=t}function Od(e){var t=Ue(),a=be;if(a!==null)return Rd(t,a,e);Ue(),t=t.memoizedState,a=Ue();var i=a.queue.dispatch;return a.memoizedState=e,[t,i,!1]}function pi(e,t,a,i){return e={tag:e,create:a,deps:i,inst:t,next:null},t=ne.updateQueue,t===null&&(t=yr(),ne.updateQueue=t),a=t.lastEffect,a===null?t.lastEffect=e.next=e:(i=a.next,a.next=e,e.next=i,t.lastEffect=e),e}function yl(){return{destroy:void 0,resource:void 0}}function Ud(){return Ue().memoizedState}function vl(e,t,a,i){var l=tt();i=i===void 0?null:i,ne.flags|=e,l.memoizedState=pi(1|t,yl(),a,i)}function rn(e,t,a,i){var l=Ue();i=i===void 0?null:i;var s=l.memoizedState.inst;be!==null&&i!==null&&pr(i,be.memoizedState.deps)?l.memoizedState=pi(t,s,a,i):(ne.flags|=e,l.memoizedState=pi(1|t,s,a,i))}function Bd(e,t){vl(8390656,8,e,t)}function Hd(e,t){rn(2048,8,e,t)}function _d(e,t){return rn(4,2,e,t)}function Ld(e,t){return rn(4,4,e,t)}function Gd(e,t){if(typeof t=="function"){e=e();var a=t(e);return function(){typeof a=="function"?a():t(null)}}if(t!=null)return e=e(),t.current=e,function(){t.current=null}}function Yd(e,t,a){a=a!=null?a.concat([e]):null,rn(4,4,Gd.bind(null,t,e),a)}function Sr(){}function qd(e,t){var a=Ue();t=t===void 0?null:t;var i=a.memoizedState;return t!==null&&pr(t,i[1])?i[0]:(a.memoizedState=[e,t],e)}function Qd(e,t){var a=Ue();t=t===void 0?null:t;var i=a.memoizedState;if(t!==null&&pr(t,i[1]))return i[0];if(i=e(),La){aa(!0);try{e()}finally{aa(!1)}}return a.memoizedState=[i,t],i}function kr(e,t,a){return a===void 0||(ca&1073741824)!==0?e.memoizedState=t:(e.memoizedState=a,e=Iu(),ne.lanes|=e,ga|=e,a)}function Xd(e,t,a,i){return rt(a,t)?a:ui.current!==null?(e=kr(e,a,i),rt(e,t)||(Le=!0),e):(ca&42)===0?(Le=!0,e.memoizedState=a):(e=Iu(),ne.lanes|=e,ga|=e,t)}function Vd(e,t,a,i,l){var s=Q.p;Q.p=s!==0&&8>s?s:8;var o=D.T,u={};D.T=u,Cr(e,!1,t,a);try{var h=l(),k=D.S;if(k!==null&&k(u,h),h!==null&&typeof h=="object"&&typeof h.then=="function"){var M=Hh(h,i);on(e,t,M,mt(e))}else on(e,t,i,mt(e))}catch(U){on(e,t,{then:function(){},status:"rejected",reason:U},mt())}finally{Q.p=s,D.T=o}}function qh(){}function zr(e,t,a,i){if(e.tag!==5)throw Error(c(476));var l=Id(e).queue;Vd(e,l,t,ee,a===null?qh:function(){return Kd(e),a(i)})}function Id(e){var t=e.memoizedState;if(t!==null)return t;t={memoizedState:ee,baseState:ee,baseQueue:null,queue:{pending:null,lanes:0,dispatch:null,lastRenderedReducer:Qt,lastRenderedState:ee},next:null};var a={};return t.next={memoizedState:a,baseState:a,baseQueue:null,queue:{pending:null,lanes:0,dispatch:null,lastRenderedReducer:Qt,lastRenderedState:a},next:null},e.memoizedState=t,e=e.alternate,e!==null&&(e.memoizedState=t),t}function Kd(e){var t=Id(e).next.queue;on(e,t,{},mt())}function Er(){return Ze(kn)}function Zd(){return Ue().memoizedState}function Jd(){return Ue().memoizedState}function Qh(e){for(var t=e.return;t!==null;){switch(t.tag){case 24:case 3:var a=mt();e=ra(a);var i=oa(t,e,a);i!==null&&(ft(i,t,a),tn(i,t,a)),t={cache:nr()},e.payload=t;return}t=t.return}}function Xh(e,t,a){var i=mt();a={lane:i,revertLane:0,action:a,hasEagerState:!1,eagerState:null,next:null},wl(e)?Fd(t,a):(a=Zs(e,t,a,i),a!==null&&(ft(a,e,i),$d(a,t,i)))}function Wd(e,t,a){var i=mt();on(e,t,a,i)}function on(e,t,a,i){var l={lane:i,revertLane:0,action:a,hasEagerState:!1,eagerState:null,next:null};if(wl(e))Fd(t,l);else{var s=e.alternate;if(e.lanes===0&&(s===null||s.lanes===0)&&(s=t.lastRenderedReducer,s!==null))try{var o=t.lastRenderedState,u=s(o,a);if(l.hasEagerState=!0,l.eagerState=u,rt(u,o))return nl(e,t,l,0),Ne===null&&il(),!1}catch{}finally{}if(a=Zs(e,t,l,i),a!==null)return ft(a,e,i),$d(a,t,i),!0}return!1}function Cr(e,t,a,i){if(i={lane:2,revertLane:ro(),action:i,hasEagerState:!1,eagerState:null,next:null},wl(e)){if(t)throw Error(c(479))}else t=Zs(e,a,i,2),t!==null&&ft(t,e,2)}function wl(e){var t=e.alternate;return e===ne||t!==null&&t===ne}function Fd(e,t){mi=hl=!0;var a=e.pending;a===null?t.next=t:(t.next=a.next,a.next=t),e.pending=t}function $d(e,t,a){if((a&4194048)!==0){var i=t.lanes;i&=e.pendingLanes,a|=i,t.lanes=a,sc(e,a)}}var jl={readContext:Ze,use:xl,useCallback:De,useContext:De,useEffect:De,useImperativeHandle:De,useLayoutEffect:De,useInsertionEffect:De,useMemo:De,useReducer:De,useRef:De,useState:De,useDebugValue:De,useDeferredValue:De,useTransition:De,useSyncExternalStore:De,useId:De,useHostTransitionStatus:De,useFormState:De,useActionState:De,useOptimistic:De,useMemoCache:De,useCacheRefresh:De},Pd={readContext:Ze,use:xl,useCallback:function(e,t){return tt().memoizedState=[e,t===void 0?null:t],e},useContext:Ze,useEffect:Bd,useImperativeHandle:function(e,t,a){a=a!=null?a.concat([e]):null,vl(4194308,4,Gd.bind(null,t,e),a)},useLayoutEffect:function(e,t){return vl(4194308,4,e,t)},useInsertionEffect:function(e,t){vl(4,2,e,t)},useMemo:function(e,t){var a=tt();t=t===void 0?null:t;var i=e();if(La){aa(!0);try{e()}finally{aa(!1)}}return a.memoizedState=[i,t],i},useReducer:function(e,t,a){var i=tt();if(a!==void 0){var l=a(t);if(La){aa(!0);try{a(t)}finally{aa(!1)}}}else l=t;return i.memoizedState=i.baseState=l,e={pending:null,lanes:0,dispatch:null,lastRenderedReducer:e,lastRenderedState:l},i.queue=e,e=e.dispatch=Xh.bind(null,ne,e),[i.memoizedState,e]},useRef:function(e){var t=tt();return e={current:e},t.memoizedState=e},useState:function(e){e=Ar(e);var t=e.queue,a=Wd.bind(null,ne,t);return t.dispatch=a,[e.memoizedState,a]},useDebugValue:Sr,useDeferredValue:function(e,t){var a=tt();return kr(a,e,t)},useTransition:function(){var e=Ar(!1);return e=Vd.bind(null,ne,e.queue,!0,!1),tt().memoizedState=e,[!1,e]},useSyncExternalStore:function(e,t,a){var i=ne,l=tt();if(fe){if(a===void 0)throw Error(c(407));a=a()}else{if(a=t(),Ne===null)throw Error(c(349));(oe&124)!==0||vd(i,t,a)}l.memoizedState=a;var s={value:a,getSnapshot:t};return l.queue=s,Bd(jd.bind(null,i,s,e),[e]),i.flags|=2048,pi(9,yl(),wd.bind(null,i,s,a,t),null),a},useId:function(){var e=tt(),t=Ne.identifierPrefix;if(fe){var a=Gt,i=Lt;a=(i&~(1<<32-st(i)-1)).toString(32)+a,t="«"+t+"R"+a,a=gl++,0<a&&(t+="H"+a.toString(32)),t+="»"}else a=_h++,t="«"+t+"r"+a.toString(32)+"»";return e.memoizedState=t},useHostTransitionStatus:Er,useFormState:Md,useActionState:Md,useOptimistic:function(e){var t=tt();t.memoizedState=t.baseState=e;var a={pending:null,lanes:0,dispatch:null,lastRenderedReducer:null,lastRenderedState:null};return t.queue=a,t=Cr.bind(null,ne,!0,a),a.dispatch=t,[e,t]},useMemoCache:vr,useCacheRefresh:function(){return tt().memoizedState=Qh.bind(null,ne)}},eu={readContext:Ze,use:xl,useCallback:qd,useContext:Ze,useEffect:Hd,useImperativeHandle:Yd,useInsertionEffect:_d,useLayoutEffect:Ld,useMemo:Qd,useReducer:bl,useRef:Ud,useState:function(){return bl(Qt)},useDebugValue:Sr,useDeferredValue:function(e,t){var a=Ue();return Xd(a,be.memoizedState,e,t)},useTransition:function(){var e=bl(Qt)[0],t=Ue().memoizedState;return[typeof e=="boolean"?e:sn(e),t]},useSyncExternalStore:yd,useId:Zd,useHostTransitionStatus:Er,useFormState:Dd,useActionState:Dd,useOptimistic:function(e,t){var a=Ue();return Sd(a,be,e,t)},useMemoCache:vr,useCacheRefresh:Jd},Vh={readContext:Ze,use:xl,useCallback:qd,useContext:Ze,useEffect:Hd,useImperativeHandle:Yd,useInsertionEffect:_d,useLayoutEffect:Ld,useMemo:Qd,useReducer:jr,useRef:Ud,useState:function(){return jr(Qt)},useDebugValue:Sr,useDeferredValue:function(e,t){var a=Ue();return be===null?kr(a,e,t):Xd(a,be.memoizedState,e,t)},useTransition:function(){var e=jr(Qt)[0],t=Ue().memoizedState;return[typeof e=="boolean"?e:sn(e),t]},useSyncExternalStore:yd,useId:Zd,useHostTransitionStatus:Er,useFormState:Od,useActionState:Od,useOptimistic:function(e,t){var a=Ue();return be!==null?Sd(a,be,e,t):(a.baseState=e,[e,a.queue.dispatch])},useMemoCache:vr,useCacheRefresh:Jd},hi=null,cn=0;function Al(e){var t=cn;return cn+=1,hi===null&&(hi=[]),ud(hi,e,t)}function dn(e,t){t=t.props.ref,e.ref=t!==void 0?t:null}function Nl(e,t){throw t.$$typeof===j?Error(c(525)):(e=Object.prototype.toString.call(t),Error(c(31,e==="[object Object]"?"object with keys {"+Object.keys(t).join(", ")+"}":e)))}function tu(e){var t=e._init;return t(e._payload)}function au(e){function t(A,b){if(e){var S=A.deletions;S===null?(A.deletions=[b],A.flags|=16):S.push(b)}}function a(A,b){if(!e)return null;for(;b!==null;)t(A,b),b=b.sibling;return null}function i(A){for(var b=new Map;A!==null;)A.key!==null?b.set(A.key,A):b.set(A.index,A),A=A.sibling;return b}function l(A,b){return A=_t(A,b),A.index=0,A.sibling=null,A}function s(A,b,S){return A.index=S,e?(S=A.alternate,S!==null?(S=S.index,S<b?(A.flags|=67108866,b):S):(A.flags|=67108866,b)):(A.flags|=1048576,b)}function o(A){return e&&A.alternate===null&&(A.flags|=67108866),A}function u(A,b,S,R){return b===null||b.tag!==6?(b=Ws(S,A.mode,R),b.return=A,b):(b=l(b,S),b.return=A,b)}function h(A,b,S,R){var I=S.type;return I===_?M(A,b,S.props.children,R,S.key):b!==null&&(b.elementType===I||typeof I=="object"&&I!==null&&I.$$typeof===X&&tu(I)===b.type)?(b=l(b,S.props),dn(b,S),b.return=A,b):(b=sl(S.type,S.key,S.props,null,A.mode,R),dn(b,S),b.return=A,b)}function k(A,b,S,R){return b===null||b.tag!==4||b.stateNode.containerInfo!==S.containerInfo||b.stateNode.implementation!==S.implementation?(b=Fs(S,A.mode,R),b.return=A,b):(b=l(b,S.children||[]),b.return=A,b)}function M(A,b,S,R,I){return b===null||b.tag!==7?(b=Ma(S,A.mode,R,I),b.return=A,b):(b=l(b,S),b.return=A,b)}function U(A,b,S){if(typeof b=="string"&&b!==""||typeof b=="number"||typeof b=="bigint")return b=Ws(""+b,A.mode,S),b.return=A,b;if(typeof b=="object"&&b!==null){switch(b.$$typeof){case E:return S=sl(b.type,b.key,b.props,null,A.mode,S),dn(S,b),S.return=A,S;case O:return b=Fs(b,A.mode,S),b.return=A,b;case X:var R=b._init;return b=R(b._payload),U(A,b,S)}if(Ie(b)||Me(b))return b=Ma(b,A.mode,S,null),b.return=A,b;if(typeof b.then=="function")return U(A,Al(b),S);if(b.$$typeof===J)return U(A,dl(A,b),S);Nl(A,b)}return null}function z(A,b,S,R){var I=b!==null?b.key:null;if(typeof S=="string"&&S!==""||typeof S=="number"||typeof S=="bigint")return I!==null?null:u(A,b,""+S,R);if(typeof S=="object"&&S!==null){switch(S.$$typeof){case E:return S.key===I?h(A,b,S,R):null;case O:return S.key===I?k(A,b,S,R):null;case X:return I=S._init,S=I(S._payload),z(A,b,S,R)}if(Ie(S)||Me(S))return I!==null?null:M(A,b,S,R,null);if(typeof S.then=="function")return z(A,b,Al(S),R);if(S.$$typeof===J)return z(A,b,dl(A,S),R);Nl(A,S)}return null}function T(A,b,S,R,I){if(typeof R=="string"&&R!==""||typeof R=="number"||typeof R=="bigint")return A=A.get(S)||null,u(b,A,""+R,I);if(typeof R=="object"&&R!==null){switch(R.$$typeof){case E:return A=A.get(R.key===null?S:R.key)||null,h(b,A,R,I);case O:return A=A.get(R.key===null?S:R.key)||null,k(b,A,R,I);case X:var le=R._init;return R=le(R._payload),T(A,b,S,R,I)}if(Ie(R)||Me(R))return A=A.get(S)||null,M(b,A,R,I,null);if(typeof R.then=="function")return T(A,b,S,Al(R),I);if(R.$$typeof===J)return T(A,b,S,dl(b,R),I);Nl(b,R)}return null}function te(A,b,S,R){for(var I=null,le=null,K=b,$=b=0,Ye=null;K!==null&&$<S.length;$++){K.index>$?(Ye=K,K=null):Ye=K.sibling;var ue=z(A,K,S[$],R);if(ue===null){K===null&&(K=Ye);break}e&&K&&ue.alternate===null&&t(A,K),b=s(ue,b,$),le===null?I=ue:le.sibling=ue,le=ue,K=Ye}if($===S.length)return a(A,K),fe&&Ra(A,$),I;if(K===null){for(;$<S.length;$++)K=U(A,S[$],R),K!==null&&(b=s(K,b,$),le===null?I=K:le.sibling=K,le=K);return fe&&Ra(A,$),I}for(K=i(K);$<S.length;$++)Ye=T(K,A,$,S[$],R),Ye!==null&&(e&&Ye.alternate!==null&&K.delete(Ye.key===null?$:Ye.key),b=s(Ye,b,$),le===null?I=Ye:le.sibling=Ye,le=Ye);return e&&K.forEach(function(Sa){return t(A,Sa)}),fe&&Ra(A,$),I}function F(A,b,S,R){if(S==null)throw Error(c(151));for(var I=null,le=null,K=b,$=b=0,Ye=null,ue=S.next();K!==null&&!ue.done;$++,ue=S.next()){K.index>$?(Ye=K,K=null):Ye=K.sibling;var Sa=z(A,K,ue.value,R);if(Sa===null){K===null&&(K=Ye);break}e&&K&&Sa.alternate===null&&t(A,K),b=s(Sa,b,$),le===null?I=Sa:le.sibling=Sa,le=Sa,K=Ye}if(ue.done)return a(A,K),fe&&Ra(A,$),I;if(K===null){for(;!ue.done;$++,ue=S.next())ue=U(A,ue.value,R),ue!==null&&(b=s(ue,b,$),le===null?I=ue:le.sibling=ue,le=ue);return fe&&Ra(A,$),I}for(K=i(K);!ue.done;$++,ue=S.next())ue=T(K,A,$,ue.value,R),ue!==null&&(e&&ue.alternate!==null&&K.delete(ue.key===null?$:ue.key),b=s(ue,b,$),le===null?I=ue:le.sibling=ue,le=ue);return e&&K.forEach(function(I0){return t(A,I0)}),fe&&Ra(A,$),I}function ve(A,b,S,R){if(typeof S=="object"&&S!==null&&S.type===_&&S.key===null&&(S=S.props.children),typeof S=="object"&&S!==null){switch(S.$$typeof){case E:e:{for(var I=S.key;b!==null;){if(b.key===I){if(I=S.type,I===_){if(b.tag===7){a(A,b.sibling),R=l(b,S.props.children),R.return=A,A=R;break e}}else if(b.elementType===I||typeof I=="object"&&I!==null&&I.$$typeof===X&&tu(I)===b.type){a(A,b.sibling),R=l(b,S.props),dn(R,S),R.return=A,A=R;break e}a(A,b);break}else t(A,b);b=b.sibling}S.type===_?(R=Ma(S.props.children,A.mode,R,S.key),R.return=A,A=R):(R=sl(S.type,S.key,S.props,null,A.mode,R),dn(R,S),R.return=A,A=R)}return o(A);case O:e:{for(I=S.key;b!==null;){if(b.key===I)if(b.tag===4&&b.stateNode.containerInfo===S.containerInfo&&b.stateNode.implementation===S.implementation){a(A,b.sibling),R=l(b,S.children||[]),R.return=A,A=R;break e}else{a(A,b);break}else t(A,b);b=b.sibling}R=Fs(S,A.mode,R),R.return=A,A=R}return o(A);case X:return I=S._init,S=I(S._payload),ve(A,b,S,R)}if(Ie(S))return te(A,b,S,R);if(Me(S)){if(I=Me(S),typeof I!="function")throw Error(c(150));return S=I.call(S),F(A,b,S,R)}if(typeof S.then=="function")return ve(A,b,Al(S),R);if(S.$$typeof===J)return ve(A,b,dl(A,S),R);Nl(A,S)}return typeof S=="string"&&S!==""||typeof S=="number"||typeof S=="bigint"?(S=""+S,b!==null&&b.tag===6?(a(A,b.sibling),R=l(b,S),R.return=A,A=R):(a(A,b),R=Ws(S,A.mode,R),R.return=A,A=R),o(A)):a(A,b)}return function(A,b,S,R){try{cn=0;var I=ve(A,b,S,R);return hi=null,I}catch(K){if(K===Pi||K===ml)throw K;var le=ot(29,K,null,A.mode);return le.lanes=R,le.return=A,le}finally{}}}var gi=au(!0),iu=au(!1),vt=H(null),Tt=null;function da(e){var t=e.alternate;q(He,He.current&1),q(vt,e),Tt===null&&(t===null||ui.current!==null||t.memoizedState!==null)&&(Tt=e)}function nu(e){if(e.tag===22){if(q(He,He.current),q(vt,e),Tt===null){var t=e.alternate;t!==null&&t.memoizedState!==null&&(Tt=e)}}else ua()}function ua(){q(He,He.current),q(vt,vt.current)}function Xt(e){V(vt),Tt===e&&(Tt=null),V(He)}var He=H(0);function Sl(e){for(var t=e;t!==null;){if(t.tag===13){var a=t.memoizedState;if(a!==null&&(a=a.dehydrated,a===null||a.data==="$?"||vo(a)))return t}else if(t.tag===19&&t.memoizedProps.revealOrder!==void 0){if((t.flags&128)!==0)return t}else if(t.child!==null){t.child.return=t,t=t.child;continue}if(t===e)break;for(;t.sibling===null;){if(t.return===null||t.return===e)return null;t=t.return}t.sibling.return=t.return,t=t.sibling}return null}function Tr(e,t,a,i){t=e.memoizedState,a=a(i,t),a=a==null?t:v({},t,a),e.memoizedState=a,e.lanes===0&&(e.updateQueue.baseState=a)}var Mr={enqueueSetState:function(e,t,a){e=e._reactInternals;var i=mt(),l=ra(i);l.payload=t,a!=null&&(l.callback=a),t=oa(e,l,i),t!==null&&(ft(t,e,i),tn(t,e,i))},enqueueReplaceState:function(e,t,a){e=e._reactInternals;var i=mt(),l=ra(i);l.tag=1,l.payload=t,a!=null&&(l.callback=a),t=oa(e,l,i),t!==null&&(ft(t,e,i),tn(t,e,i))},enqueueForceUpdate:function(e,t){e=e._reactInternals;var a=mt(),i=ra(a);i.tag=2,t!=null&&(i.callback=t),t=oa(e,i,a),t!==null&&(ft(t,e,a),tn(t,e,a))}};function lu(e,t,a,i,l,s,o){return e=e.stateNode,typeof e.shouldComponentUpdate=="function"?e.shouldComponentUpdate(i,s,o):t.prototype&&t.prototype.isPureReactComponent?!Vi(a,i)||!Vi(l,s):!0}function su(e,t,a,i){e=t.state,typeof t.componentWillReceiveProps=="function"&&t.componentWillReceiveProps(a,i),typeof t.UNSAFE_componentWillReceiveProps=="function"&&t.UNSAFE_componentWillReceiveProps(a,i),t.state!==e&&Mr.enqueueReplaceState(t,t.state,null)}function Ga(e,t){var a=t;if("ref"in t){a={};for(var i in t)i!=="ref"&&(a[i]=t[i])}if(e=e.defaultProps){a===t&&(a=v({},a));for(var l in e)a[l]===void 0&&(a[l]=e[l])}return a}var kl=typeof reportError=="function"?reportError:function(e){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var t=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof e=="object"&&e!==null&&typeof e.message=="string"?String(e.message):String(e),error:e});if(!window.dispatchEvent(t))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",e);return}console.error(e)};function ru(e){kl(e)}function ou(e){console.error(e)}function cu(e){kl(e)}function zl(e,t){try{var a=e.onUncaughtError;a(t.value,{componentStack:t.stack})}catch(i){setTimeout(function(){throw i})}}function du(e,t,a){try{var i=e.onCaughtError;i(a.value,{componentStack:a.stack,errorBoundary:t.tag===1?t.stateNode:null})}catch(l){setTimeout(function(){throw l})}}function Dr(e,t,a){return a=ra(a),a.tag=3,a.payload={element:null},a.callback=function(){zl(e,t)},a}function uu(e){return e=ra(e),e.tag=3,e}function mu(e,t,a,i){var l=a.type.getDerivedStateFromError;if(typeof l=="function"){var s=i.value;e.payload=function(){return l(s)},e.callback=function(){du(t,a,i)}}var o=a.stateNode;o!==null&&typeof o.componentDidCatch=="function"&&(e.callback=function(){du(t,a,i),typeof l!="function"&&(xa===null?xa=new Set([this]):xa.add(this));var u=i.stack;this.componentDidCatch(i.value,{componentStack:u!==null?u:""})})}function Ih(e,t,a,i,l){if(a.flags|=32768,i!==null&&typeof i=="object"&&typeof i.then=="function"){if(t=a.alternate,t!==null&&Wi(t,a,l,!0),a=vt.current,a!==null){switch(a.tag){case 13:return Tt===null?ao():a.alternate===null&&Te===0&&(Te=3),a.flags&=-257,a.flags|=65536,a.lanes=l,i===rr?a.flags|=16384:(t=a.updateQueue,t===null?a.updateQueue=new Set([i]):t.add(i),no(e,i,l)),!1;case 22:return a.flags|=65536,i===rr?a.flags|=16384:(t=a.updateQueue,t===null?(t={transitions:null,markerInstances:null,retryQueue:new Set([i])},a.updateQueue=t):(a=t.retryQueue,a===null?t.retryQueue=new Set([i]):a.add(i)),no(e,i,l)),!1}throw Error(c(435,a.tag))}return no(e,i,l),ao(),!1}if(fe)return t=vt.current,t!==null?((t.flags&65536)===0&&(t.flags|=256),t.flags|=65536,t.lanes=l,i!==er&&(e=Error(c(422),{cause:i}),Ji(gt(e,a)))):(i!==er&&(t=Error(c(423),{cause:i}),Ji(gt(t,a))),e=e.current.alternate,e.flags|=65536,l&=-l,e.lanes|=l,i=gt(i,a),l=Dr(e.stateNode,i,l),dr(e,l),Te!==4&&(Te=2)),!1;var s=Error(c(520),{cause:i});if(s=gt(s,a),xn===null?xn=[s]:xn.push(s),Te!==4&&(Te=2),t===null)return!0;i=gt(i,a),a=t;do{switch(a.tag){case 3:return a.flags|=65536,e=l&-l,a.lanes|=e,e=Dr(a.stateNode,i,e),dr(a,e),!1;case 1:if(t=a.type,s=a.stateNode,(a.flags&128)===0&&(typeof t.getDerivedStateFromError=="function"||s!==null&&typeof s.componentDidCatch=="function"&&(xa===null||!xa.has(s))))return a.flags|=65536,l&=-l,a.lanes|=l,l=uu(l),mu(l,e,a,i),dr(a,l),!1}a=a.return}while(a!==null);return!1}var fu=Error(c(461)),Le=!1;function qe(e,t,a,i){t.child=e===null?iu(t,null,a,i):gi(t,e.child,a,i)}function pu(e,t,a,i,l){a=a.render;var s=t.ref;if("ref"in i){var o={};for(var u in i)u!=="ref"&&(o[u]=i[u])}else o=i;return Ha(t),i=hr(e,t,a,o,s,l),u=gr(),e!==null&&!Le?(xr(e,t,l),Vt(e,t,l)):(fe&&u&&$s(t),t.flags|=1,qe(e,t,i,l),t.child)}function hu(e,t,a,i,l){if(e===null){var s=a.type;return typeof s=="function"&&!Js(s)&&s.defaultProps===void 0&&a.compare===null?(t.tag=15,t.type=s,gu(e,t,s,i,l)):(e=sl(a.type,null,i,t,t.mode,l),e.ref=t.ref,e.return=t,t.child=e)}if(s=e.child,!Gr(e,l)){var o=s.memoizedProps;if(a=a.compare,a=a!==null?a:Vi,a(o,i)&&e.ref===t.ref)return Vt(e,t,l)}return t.flags|=1,e=_t(s,i),e.ref=t.ref,e.return=t,t.child=e}function gu(e,t,a,i,l){if(e!==null){var s=e.memoizedProps;if(Vi(s,i)&&e.ref===t.ref)if(Le=!1,t.pendingProps=i=s,Gr(e,l))(e.flags&131072)!==0&&(Le=!0);else return t.lanes=e.lanes,Vt(e,t,l)}return Rr(e,t,a,i,l)}function xu(e,t,a){var i=t.pendingProps,l=i.children,s=e!==null?e.memoizedState:null;if(i.mode==="hidden"){if((t.flags&128)!==0){if(i=s!==null?s.baseLanes|a:a,e!==null){for(l=t.child=e.child,s=0;l!==null;)s=s|l.lanes|l.childLanes,l=l.sibling;t.childLanes=s&~i}else t.childLanes=0,t.child=null;return bu(e,t,i,a)}if((a&536870912)!==0)t.memoizedState={baseLanes:0,cachePool:null},e!==null&&ul(t,s!==null?s.cachePool:null),s!==null?gd(t,s):mr(),nu(t);else return t.lanes=t.childLanes=536870912,bu(e,t,s!==null?s.baseLanes|a:a,a)}else s!==null?(ul(t,s.cachePool),gd(t,s),ua(),t.memoizedState=null):(e!==null&&ul(t,null),mr(),ua());return qe(e,t,l,a),t.child}function bu(e,t,a,i){var l=sr();return l=l===null?null:{parent:Be._currentValue,pool:l},t.memoizedState={baseLanes:a,cachePool:l},e!==null&&ul(t,null),mr(),nu(t),e!==null&&Wi(e,t,i,!0),null}function El(e,t){var a=t.ref;if(a===null)e!==null&&e.ref!==null&&(t.flags|=4194816);else{if(typeof a!="function"&&typeof a!="object")throw Error(c(284));(e===null||e.ref!==a)&&(t.flags|=4194816)}}function Rr(e,t,a,i,l){return Ha(t),a=hr(e,t,a,i,void 0,l),i=gr(),e!==null&&!Le?(xr(e,t,l),Vt(e,t,l)):(fe&&i&&$s(t),t.flags|=1,qe(e,t,a,l),t.child)}function yu(e,t,a,i,l,s){return Ha(t),t.updateQueue=null,a=bd(t,i,a,l),xd(e),i=gr(),e!==null&&!Le?(xr(e,t,s),Vt(e,t,s)):(fe&&i&&$s(t),t.flags|=1,qe(e,t,a,s),t.child)}function vu(e,t,a,i,l){if(Ha(t),t.stateNode===null){var s=si,o=a.contextType;typeof o=="object"&&o!==null&&(s=Ze(o)),s=new a(i,s),t.memoizedState=s.state!==null&&s.state!==void 0?s.state:null,s.updater=Mr,t.stateNode=s,s._reactInternals=t,s=t.stateNode,s.props=i,s.state=t.memoizedState,s.refs={},or(t),o=a.contextType,s.context=typeof o=="object"&&o!==null?Ze(o):si,s.state=t.memoizedState,o=a.getDerivedStateFromProps,typeof o=="function"&&(Tr(t,a,o,i),s.state=t.memoizedState),typeof a.getDerivedStateFromProps=="function"||typeof s.getSnapshotBeforeUpdate=="function"||typeof s.UNSAFE_componentWillMount!="function"&&typeof s.componentWillMount!="function"||(o=s.state,typeof s.componentWillMount=="function"&&s.componentWillMount(),typeof s.UNSAFE_componentWillMount=="function"&&s.UNSAFE_componentWillMount(),o!==s.state&&Mr.enqueueReplaceState(s,s.state,null),nn(t,i,s,l),an(),s.state=t.memoizedState),typeof s.componentDidMount=="function"&&(t.flags|=4194308),i=!0}else if(e===null){s=t.stateNode;var u=t.memoizedProps,h=Ga(a,u);s.props=h;var k=s.context,M=a.contextType;o=si,typeof M=="object"&&M!==null&&(o=Ze(M));var U=a.getDerivedStateFromProps;M=typeof U=="function"||typeof s.getSnapshotBeforeUpdate=="function",u=t.pendingProps!==u,M||typeof s.UNSAFE_componentWillReceiveProps!="function"&&typeof s.componentWillReceiveProps!="function"||(u||k!==o)&&su(t,s,i,o),sa=!1;var z=t.memoizedState;s.state=z,nn(t,i,s,l),an(),k=t.memoizedState,u||z!==k||sa?(typeof U=="function"&&(Tr(t,a,U,i),k=t.memoizedState),(h=sa||lu(t,a,h,i,z,k,o))?(M||typeof s.UNSAFE_componentWillMount!="function"&&typeof s.componentWillMount!="function"||(typeof s.componentWillMount=="function"&&s.componentWillMount(),typeof s.UNSAFE_componentWillMount=="function"&&s.UNSAFE_componentWillMount()),typeof s.componentDidMount=="function"&&(t.flags|=4194308)):(typeof s.componentDidMount=="function"&&(t.flags|=4194308),t.memoizedProps=i,t.memoizedState=k),s.props=i,s.state=k,s.context=o,i=h):(typeof s.componentDidMount=="function"&&(t.flags|=4194308),i=!1)}else{s=t.stateNode,cr(e,t),o=t.memoizedProps,M=Ga(a,o),s.props=M,U=t.pendingProps,z=s.context,k=a.contextType,h=si,typeof k=="object"&&k!==null&&(h=Ze(k)),u=a.getDerivedStateFromProps,(k=typeof u=="function"||typeof s.getSnapshotBeforeUpdate=="function")||typeof s.UNSAFE_componentWillReceiveProps!="function"&&typeof s.componentWillReceiveProps!="function"||(o!==U||z!==h)&&su(t,s,i,h),sa=!1,z=t.memoizedState,s.state=z,nn(t,i,s,l),an();var T=t.memoizedState;o!==U||z!==T||sa||e!==null&&e.dependencies!==null&&cl(e.dependencies)?(typeof u=="function"&&(Tr(t,a,u,i),T=t.memoizedState),(M=sa||lu(t,a,M,i,z,T,h)||e!==null&&e.dependencies!==null&&cl(e.dependencies))?(k||typeof s.UNSAFE_componentWillUpdate!="function"&&typeof s.componentWillUpdate!="function"||(typeof s.componentWillUpdate=="function"&&s.componentWillUpdate(i,T,h),typeof s.UNSAFE_componentWillUpdate=="function"&&s.UNSAFE_componentWillUpdate(i,T,h)),typeof s.componentDidUpdate=="function"&&(t.flags|=4),typeof s.getSnapshotBeforeUpdate=="function"&&(t.flags|=1024)):(typeof s.componentDidUpdate!="function"||o===e.memoizedProps&&z===e.memoizedState||(t.flags|=4),typeof s.getSnapshotBeforeUpdate!="function"||o===e.memoizedProps&&z===e.memoizedState||(t.flags|=1024),t.memoizedProps=i,t.memoizedState=T),s.props=i,s.state=T,s.context=h,i=M):(typeof s.componentDidUpdate!="function"||o===e.memoizedProps&&z===e.memoizedState||(t.flags|=4),typeof s.getSnapshotBeforeUpdate!="function"||o===e.memoizedProps&&z===e.memoizedState||(t.flags|=1024),i=!1)}return s=i,El(e,t),i=(t.flags&128)!==0,s||i?(s=t.stateNode,a=i&&typeof a.getDerivedStateFromError!="function"?null:s.render(),t.flags|=1,e!==null&&i?(t.child=gi(t,e.child,null,l),t.child=gi(t,null,a,l)):qe(e,t,a,l),t.memoizedState=s.state,e=t.child):e=Vt(e,t,l),e}function wu(e,t,a,i){return Zi(),t.flags|=256,qe(e,t,a,i),t.child}var Or={dehydrated:null,treeContext:null,retryLane:0,hydrationErrors:null};function Ur(e){return{baseLanes:e,cachePool:od()}}function Br(e,t,a){return e=e!==null?e.childLanes&~a:0,t&&(e|=wt),e}function ju(e,t,a){var i=t.pendingProps,l=!1,s=(t.flags&128)!==0,o;if((o=s)||(o=e!==null&&e.memoizedState===null?!1:(He.current&2)!==0),o&&(l=!0,t.flags&=-129),o=(t.flags&32)!==0,t.flags&=-33,e===null){if(fe){if(l?da(t):ua(),fe){var u=Ce,h;if(h=u){e:{for(h=u,u=Ct;h.nodeType!==8;){if(!u){u=null;break e}if(h=kt(h.nextSibling),h===null){u=null;break e}}u=h}u!==null?(t.memoizedState={dehydrated:u,treeContext:Da!==null?{id:Lt,overflow:Gt}:null,retryLane:536870912,hydrationErrors:null},h=ot(18,null,null,0),h.stateNode=u,h.return=t,t.child=h,Fe=t,Ce=null,h=!0):h=!1}h||Ua(t)}if(u=t.memoizedState,u!==null&&(u=u.dehydrated,u!==null))return vo(u)?t.lanes=32:t.lanes=536870912,null;Xt(t)}return u=i.children,i=i.fallback,l?(ua(),l=t.mode,u=Cl({mode:"hidden",children:u},l),i=Ma(i,l,a,null),u.return=t,i.return=t,u.sibling=i,t.child=u,l=t.child,l.memoizedState=Ur(a),l.childLanes=Br(e,o,a),t.memoizedState=Or,i):(da(t),Hr(t,u))}if(h=e.memoizedState,h!==null&&(u=h.dehydrated,u!==null)){if(s)t.flags&256?(da(t),t.flags&=-257,t=_r(e,t,a)):t.memoizedState!==null?(ua(),t.child=e.child,t.flags|=128,t=null):(ua(),l=i.fallback,u=t.mode,i=Cl({mode:"visible",children:i.children},u),l=Ma(l,u,a,null),l.flags|=2,i.return=t,l.return=t,i.sibling=l,t.child=i,gi(t,e.child,null,a),i=t.child,i.memoizedState=Ur(a),i.childLanes=Br(e,o,a),t.memoizedState=Or,t=l);else if(da(t),vo(u)){if(o=u.nextSibling&&u.nextSibling.dataset,o)var k=o.dgst;o=k,i=Error(c(419)),i.stack="",i.digest=o,Ji({value:i,source:null,stack:null}),t=_r(e,t,a)}else if(Le||Wi(e,t,a,!1),o=(a&e.childLanes)!==0,Le||o){if(o=Ne,o!==null&&(i=a&-a,i=(i&42)!==0?1:vs(i),i=(i&(o.suspendedLanes|a))!==0?0:i,i!==0&&i!==h.retryLane))throw h.retryLane=i,li(e,i),ft(o,e,i),fu;u.data==="$?"||ao(),t=_r(e,t,a)}else u.data==="$?"?(t.flags|=192,t.child=e.child,t=null):(e=h.treeContext,Ce=kt(u.nextSibling),Fe=t,fe=!0,Oa=null,Ct=!1,e!==null&&(bt[yt++]=Lt,bt[yt++]=Gt,bt[yt++]=Da,Lt=e.id,Gt=e.overflow,Da=t),t=Hr(t,i.children),t.flags|=4096);return t}return l?(ua(),l=i.fallback,u=t.mode,h=e.child,k=h.sibling,i=_t(h,{mode:"hidden",children:i.children}),i.subtreeFlags=h.subtreeFlags&65011712,k!==null?l=_t(k,l):(l=Ma(l,u,a,null),l.flags|=2),l.return=t,i.return=t,i.sibling=l,t.child=i,i=l,l=t.child,u=e.child.memoizedState,u===null?u=Ur(a):(h=u.cachePool,h!==null?(k=Be._currentValue,h=h.parent!==k?{parent:k,pool:k}:h):h=od(),u={baseLanes:u.baseLanes|a,cachePool:h}),l.memoizedState=u,l.childLanes=Br(e,o,a),t.memoizedState=Or,i):(da(t),a=e.child,e=a.sibling,a=_t(a,{mode:"visible",children:i.children}),a.return=t,a.sibling=null,e!==null&&(o=t.deletions,o===null?(t.deletions=[e],t.flags|=16):o.push(e)),t.child=a,t.memoizedState=null,a)}function Hr(e,t){return t=Cl({mode:"visible",children:t},e.mode),t.return=e,e.child=t}function Cl(e,t){return e=ot(22,e,null,t),e.lanes=0,e.stateNode={_visibility:1,_pendingMarkers:null,_retryCache:null,_transitions:null},e}function _r(e,t,a){return gi(t,e.child,null,a),e=Hr(t,t.pendingProps.children),e.flags|=2,t.memoizedState=null,e}function Au(e,t,a){e.lanes|=t;var i=e.alternate;i!==null&&(i.lanes|=t),ar(e.return,t,a)}function Lr(e,t,a,i,l){var s=e.memoizedState;s===null?e.memoizedState={isBackwards:t,rendering:null,renderingStartTime:0,last:i,tail:a,tailMode:l}:(s.isBackwards=t,s.rendering=null,s.renderingStartTime=0,s.last=i,s.tail=a,s.tailMode=l)}function Nu(e,t,a){var i=t.pendingProps,l=i.revealOrder,s=i.tail;if(qe(e,t,i.children,a),i=He.current,(i&2)!==0)i=i&1|2,t.flags|=128;else{if(e!==null&&(e.flags&128)!==0)e:for(e=t.child;e!==null;){if(e.tag===13)e.memoizedState!==null&&Au(e,a,t);else if(e.tag===19)Au(e,a,t);else if(e.child!==null){e.child.return=e,e=e.child;continue}if(e===t)break e;for(;e.sibling===null;){if(e.return===null||e.return===t)break e;e=e.return}e.sibling.return=e.return,e=e.sibling}i&=1}switch(q(He,i),l){case"forwards":for(a=t.child,l=null;a!==null;)e=a.alternate,e!==null&&Sl(e)===null&&(l=a),a=a.sibling;a=l,a===null?(l=t.child,t.child=null):(l=a.sibling,a.sibling=null),Lr(t,!1,l,a,s);break;case"backwards":for(a=null,l=t.child,t.child=null;l!==null;){if(e=l.alternate,e!==null&&Sl(e)===null){t.child=l;break}e=l.sibling,l.sibling=a,a=l,l=e}Lr(t,!0,a,null,s);break;case"together":Lr(t,!1,null,null,void 0);break;default:t.memoizedState=null}return t.child}function Vt(e,t,a){if(e!==null&&(t.dependencies=e.dependencies),ga|=t.lanes,(a&t.childLanes)===0)if(e!==null){if(Wi(e,t,a,!1),(a&t.childLanes)===0)return null}else return null;if(e!==null&&t.child!==e.child)throw Error(c(153));if(t.child!==null){for(e=t.child,a=_t(e,e.pendingProps),t.child=a,a.return=t;e.sibling!==null;)e=e.sibling,a=a.sibling=_t(e,e.pendingProps),a.return=t;a.sibling=null}return t.child}function Gr(e,t){return(e.lanes&t)!==0?!0:(e=e.dependencies,!!(e!==null&&cl(e)))}function Kh(e,t,a){switch(t.tag){case 3:Se(t,t.stateNode.containerInfo),la(t,Be,e.memoizedState.cache),Zi();break;case 27:case 5:hs(t);break;case 4:Se(t,t.stateNode.containerInfo);break;case 10:la(t,t.type,t.memoizedProps.value);break;case 13:var i=t.memoizedState;if(i!==null)return i.dehydrated!==null?(da(t),t.flags|=128,null):(a&t.child.childLanes)!==0?ju(e,t,a):(da(t),e=Vt(e,t,a),e!==null?e.sibling:null);da(t);break;case 19:var l=(e.flags&128)!==0;if(i=(a&t.childLanes)!==0,i||(Wi(e,t,a,!1),i=(a&t.childLanes)!==0),l){if(i)return Nu(e,t,a);t.flags|=128}if(l=t.memoizedState,l!==null&&(l.rendering=null,l.tail=null,l.lastEffect=null),q(He,He.current),i)break;return null;case 22:case 23:return t.lanes=0,xu(e,t,a);case 24:la(t,Be,e.memoizedState.cache)}return Vt(e,t,a)}function Su(e,t,a){if(e!==null)if(e.memoizedProps!==t.pendingProps)Le=!0;else{if(!Gr(e,a)&&(t.flags&128)===0)return Le=!1,Kh(e,t,a);Le=(e.flags&131072)!==0}else Le=!1,fe&&(t.flags&1048576)!==0&&td(t,ol,t.index);switch(t.lanes=0,t.tag){case 16:e:{e=t.pendingProps;var i=t.elementType,l=i._init;if(i=l(i._payload),t.type=i,typeof i=="function")Js(i)?(e=Ga(i,e),t.tag=1,t=vu(null,t,i,e,a)):(t.tag=0,t=Rr(null,t,i,e,a));else{if(i!=null){if(l=i.$$typeof,l===me){t.tag=11,t=pu(null,t,i,e,a);break e}else if(l===pe){t.tag=14,t=hu(null,t,i,e,a);break e}}throw t=$e(i)||i,Error(c(306,t,""))}}return t;case 0:return Rr(e,t,t.type,t.pendingProps,a);case 1:return i=t.type,l=Ga(i,t.pendingProps),vu(e,t,i,l,a);case 3:e:{if(Se(t,t.stateNode.containerInfo),e===null)throw Error(c(387));i=t.pendingProps;var s=t.memoizedState;l=s.element,cr(e,t),nn(t,i,null,a);var o=t.memoizedState;if(i=o.cache,la(t,Be,i),i!==s.cache&&ir(t,[Be],a,!0),an(),i=o.element,s.isDehydrated)if(s={element:i,isDehydrated:!1,cache:o.cache},t.updateQueue.baseState=s,t.memoizedState=s,t.flags&256){t=wu(e,t,i,a);break e}else if(i!==l){l=gt(Error(c(424)),t),Ji(l),t=wu(e,t,i,a);break e}else{switch(e=t.stateNode.containerInfo,e.nodeType){case 9:e=e.body;break;default:e=e.nodeName==="HTML"?e.ownerDocument.body:e}for(Ce=kt(e.firstChild),Fe=t,fe=!0,Oa=null,Ct=!0,a=iu(t,null,i,a),t.child=a;a;)a.flags=a.flags&-3|4096,a=a.sibling}else{if(Zi(),i===l){t=Vt(e,t,a);break e}qe(e,t,i,a)}t=t.child}return t;case 26:return El(e,t),e===null?(a=Cm(t.type,null,t.pendingProps,null))?t.memoizedState=a:fe||(a=t.type,e=t.pendingProps,i=Ql(ae.current).createElement(a),i[Ke]=t,i[Pe]=e,Xe(i,a,e),_e(i),t.stateNode=i):t.memoizedState=Cm(t.type,e.memoizedProps,t.pendingProps,e.memoizedState),null;case 27:return hs(t),e===null&&fe&&(i=t.stateNode=km(t.type,t.pendingProps,ae.current),Fe=t,Ct=!0,l=Ce,va(t.type)?(wo=l,Ce=kt(i.firstChild)):Ce=l),qe(e,t,t.pendingProps.children,a),El(e,t),e===null&&(t.flags|=4194304),t.child;case 5:return e===null&&fe&&((l=i=Ce)&&(i=w0(i,t.type,t.pendingProps,Ct),i!==null?(t.stateNode=i,Fe=t,Ce=kt(i.firstChild),Ct=!1,l=!0):l=!1),l||Ua(t)),hs(t),l=t.type,s=t.pendingProps,o=e!==null?e.memoizedProps:null,i=s.children,xo(l,s)?i=null:o!==null&&xo(l,o)&&(t.flags|=32),t.memoizedState!==null&&(l=hr(e,t,Lh,null,null,a),kn._currentValue=l),El(e,t),qe(e,t,i,a),t.child;case 6:return e===null&&fe&&((e=a=Ce)&&(a=j0(a,t.pendingProps,Ct),a!==null?(t.stateNode=a,Fe=t,Ce=null,e=!0):e=!1),e||Ua(t)),null;case 13:return ju(e,t,a);case 4:return Se(t,t.stateNode.containerInfo),i=t.pendingProps,e===null?t.child=gi(t,null,i,a):qe(e,t,i,a),t.child;case 11:return pu(e,t,t.type,t.pendingProps,a);case 7:return qe(e,t,t.pendingProps,a),t.child;case 8:return qe(e,t,t.pendingProps.children,a),t.child;case 12:return qe(e,t,t.pendingProps.children,a),t.child;case 10:return i=t.pendingProps,la(t,t.type,i.value),qe(e,t,i.children,a),t.child;case 9:return l=t.type._context,i=t.pendingProps.children,Ha(t),l=Ze(l),i=i(l),t.flags|=1,qe(e,t,i,a),t.child;case 14:return hu(e,t,t.type,t.pendingProps,a);case 15:return gu(e,t,t.type,t.pendingProps,a);case 19:return Nu(e,t,a);case 31:return i=t.pendingProps,a=t.mode,i={mode:i.mode,children:i.children},e===null?(a=Cl(i,a),a.ref=t.ref,t.child=a,a.return=t,t=a):(a=_t(e.child,i),a.ref=t.ref,t.child=a,a.return=t,t=a),t;case 22:return xu(e,t,a);case 24:return Ha(t),i=Ze(Be),e===null?(l=sr(),l===null&&(l=Ne,s=nr(),l.pooledCache=s,s.refCount++,s!==null&&(l.pooledCacheLanes|=a),l=s),t.memoizedState={parent:i,cache:l},or(t),la(t,Be,l)):((e.lanes&a)!==0&&(cr(e,t),nn(t,null,null,a),an()),l=e.memoizedState,s=t.memoizedState,l.parent!==i?(l={parent:i,cache:i},t.memoizedState=l,t.lanes===0&&(t.memoizedState=t.updateQueue.baseState=l),la(t,Be,i)):(i=s.cache,la(t,Be,i),i!==l.cache&&ir(t,[Be],a,!0))),qe(e,t,t.pendingProps.children,a),t.child;case 29:throw t.pendingProps}throw Error(c(156,t.tag))}function It(e){e.flags|=4}function ku(e,t){if(t.type!=="stylesheet"||(t.state.loading&4)!==0)e.flags&=-16777217;else if(e.flags|=16777216,!Om(t)){if(t=vt.current,t!==null&&((oe&4194048)===oe?Tt!==null:(oe&62914560)!==oe&&(oe&536870912)===0||t!==Tt))throw en=rr,cd;e.flags|=8192}}function Tl(e,t){t!==null&&(e.flags|=4),e.flags&16384&&(t=e.tag!==22?nc():536870912,e.lanes|=t,vi|=t)}function un(e,t){if(!fe)switch(e.tailMode){case"hidden":t=e.tail;for(var a=null;t!==null;)t.alternate!==null&&(a=t),t=t.sibling;a===null?e.tail=null:a.sibling=null;break;case"collapsed":a=e.tail;for(var i=null;a!==null;)a.alternate!==null&&(i=a),a=a.sibling;i===null?t||e.tail===null?e.tail=null:e.tail.sibling=null:i.sibling=null}}function ze(e){var t=e.alternate!==null&&e.alternate.child===e.child,a=0,i=0;if(t)for(var l=e.child;l!==null;)a|=l.lanes|l.childLanes,i|=l.subtreeFlags&65011712,i|=l.flags&65011712,l.return=e,l=l.sibling;else for(l=e.child;l!==null;)a|=l.lanes|l.childLanes,i|=l.subtreeFlags,i|=l.flags,l.return=e,l=l.sibling;return e.subtreeFlags|=i,e.childLanes=a,t}function Zh(e,t,a){var i=t.pendingProps;switch(Ps(t),t.tag){case 31:case 16:case 15:case 0:case 11:case 7:case 8:case 12:case 9:case 14:return ze(t),null;case 1:return ze(t),null;case 3:return a=t.stateNode,i=null,e!==null&&(i=e.memoizedState.cache),t.memoizedState.cache!==i&&(t.flags|=2048),qt(Be),ta(),a.pendingContext&&(a.context=a.pendingContext,a.pendingContext=null),(e===null||e.child===null)&&(Ki(t)?It(t):e===null||e.memoizedState.isDehydrated&&(t.flags&256)===0||(t.flags|=1024,nd())),ze(t),null;case 26:return a=t.memoizedState,e===null?(It(t),a!==null?(ze(t),ku(t,a)):(ze(t),t.flags&=-16777217)):a?a!==e.memoizedState?(It(t),ze(t),ku(t,a)):(ze(t),t.flags&=-16777217):(e.memoizedProps!==i&&It(t),ze(t),t.flags&=-16777217),null;case 27:Yn(t),a=ae.current;var l=t.type;if(e!==null&&t.stateNode!=null)e.memoizedProps!==i&&It(t);else{if(!i){if(t.stateNode===null)throw Error(c(166));return ze(t),null}e=W.current,Ki(t)?ad(t):(e=km(l,i,a),t.stateNode=e,It(t))}return ze(t),null;case 5:if(Yn(t),a=t.type,e!==null&&t.stateNode!=null)e.memoizedProps!==i&&It(t);else{if(!i){if(t.stateNode===null)throw Error(c(166));return ze(t),null}if(e=W.current,Ki(t))ad(t);else{switch(l=Ql(ae.current),e){case 1:e=l.createElementNS("http://www.w3.org/2000/svg",a);break;case 2:e=l.createElementNS("http://www.w3.org/1998/Math/MathML",a);break;default:switch(a){case"svg":e=l.createElementNS("http://www.w3.org/2000/svg",a);break;case"math":e=l.createElementNS("http://www.w3.org/1998/Math/MathML",a);break;case"script":e=l.createElement("div"),e.innerHTML="<script><\/script>",e=e.removeChild(e.firstChild);break;case"select":e=typeof i.is=="string"?l.createElement("select",{is:i.is}):l.createElement("select"),i.multiple?e.multiple=!0:i.size&&(e.size=i.size);break;default:e=typeof i.is=="string"?l.createElement(a,{is:i.is}):l.createElement(a)}}e[Ke]=t,e[Pe]=i;e:for(l=t.child;l!==null;){if(l.tag===5||l.tag===6)e.appendChild(l.stateNode);else if(l.tag!==4&&l.tag!==27&&l.child!==null){l.child.return=l,l=l.child;continue}if(l===t)break e;for(;l.sibling===null;){if(l.return===null||l.return===t)break e;l=l.return}l.sibling.return=l.return,l=l.sibling}t.stateNode=e;e:switch(Xe(e,a,i),a){case"button":case"input":case"select":case"textarea":e=!!i.autoFocus;break e;case"img":e=!0;break e;default:e=!1}e&&It(t)}}return ze(t),t.flags&=-16777217,null;case 6:if(e&&t.stateNode!=null)e.memoizedProps!==i&&It(t);else{if(typeof i!="string"&&t.stateNode===null)throw Error(c(166));if(e=ae.current,Ki(t)){if(e=t.stateNode,a=t.memoizedProps,i=null,l=Fe,l!==null)switch(l.tag){case 27:case 5:i=l.memoizedProps}e[Ke]=t,e=!!(e.nodeValue===a||i!==null&&i.suppressHydrationWarning===!0||ym(e.nodeValue,a)),e||Ua(t)}else e=Ql(e).createTextNode(i),e[Ke]=t,t.stateNode=e}return ze(t),null;case 13:if(i=t.memoizedState,e===null||e.memoizedState!==null&&e.memoizedState.dehydrated!==null){if(l=Ki(t),i!==null&&i.dehydrated!==null){if(e===null){if(!l)throw Error(c(318));if(l=t.memoizedState,l=l!==null?l.dehydrated:null,!l)throw Error(c(317));l[Ke]=t}else Zi(),(t.flags&128)===0&&(t.memoizedState=null),t.flags|=4;ze(t),l=!1}else l=nd(),e!==null&&e.memoizedState!==null&&(e.memoizedState.hydrationErrors=l),l=!0;if(!l)return t.flags&256?(Xt(t),t):(Xt(t),null)}if(Xt(t),(t.flags&128)!==0)return t.lanes=a,t;if(a=i!==null,e=e!==null&&e.memoizedState!==null,a){i=t.child,l=null,i.alternate!==null&&i.alternate.memoizedState!==null&&i.alternate.memoizedState.cachePool!==null&&(l=i.alternate.memoizedState.cachePool.pool);var s=null;i.memoizedState!==null&&i.memoizedState.cachePool!==null&&(s=i.memoizedState.cachePool.pool),s!==l&&(i.flags|=2048)}return a!==e&&a&&(t.child.flags|=8192),Tl(t,t.updateQueue),ze(t),null;case 4:return ta(),e===null&&mo(t.stateNode.containerInfo),ze(t),null;case 10:return qt(t.type),ze(t),null;case 19:if(V(He),l=t.memoizedState,l===null)return ze(t),null;if(i=(t.flags&128)!==0,s=l.rendering,s===null)if(i)un(l,!1);else{if(Te!==0||e!==null&&(e.flags&128)!==0)for(e=t.child;e!==null;){if(s=Sl(e),s!==null){for(t.flags|=128,un(l,!1),e=s.updateQueue,t.updateQueue=e,Tl(t,e),t.subtreeFlags=0,e=a,a=t.child;a!==null;)ed(a,e),a=a.sibling;return q(He,He.current&1|2),t.child}e=e.sibling}l.tail!==null&&Et()>Rl&&(t.flags|=128,i=!0,un(l,!1),t.lanes=4194304)}else{if(!i)if(e=Sl(s),e!==null){if(t.flags|=128,i=!0,e=e.updateQueue,t.updateQueue=e,Tl(t,e),un(l,!0),l.tail===null&&l.tailMode==="hidden"&&!s.alternate&&!fe)return ze(t),null}else 2*Et()-l.renderingStartTime>Rl&&a!==536870912&&(t.flags|=128,i=!0,un(l,!1),t.lanes=4194304);l.isBackwards?(s.sibling=t.child,t.child=s):(e=l.last,e!==null?e.sibling=s:t.child=s,l.last=s)}return l.tail!==null?(t=l.tail,l.rendering=t,l.tail=t.sibling,l.renderingStartTime=Et(),t.sibling=null,e=He.current,q(He,i?e&1|2:e&1),t):(ze(t),null);case 22:case 23:return Xt(t),fr(),i=t.memoizedState!==null,e!==null?e.memoizedState!==null!==i&&(t.flags|=8192):i&&(t.flags|=8192),i?(a&536870912)!==0&&(t.flags&128)===0&&(ze(t),t.subtreeFlags&6&&(t.flags|=8192)):ze(t),a=t.updateQueue,a!==null&&Tl(t,a.retryQueue),a=null,e!==null&&e.memoizedState!==null&&e.memoizedState.cachePool!==null&&(a=e.memoizedState.cachePool.pool),i=null,t.memoizedState!==null&&t.memoizedState.cachePool!==null&&(i=t.memoizedState.cachePool.pool),i!==a&&(t.flags|=2048),e!==null&&V(_a),null;case 24:return a=null,e!==null&&(a=e.memoizedState.cache),t.memoizedState.cache!==a&&(t.flags|=2048),qt(Be),ze(t),null;case 25:return null;case 30:return null}throw Error(c(156,t.tag))}function Jh(e,t){switch(Ps(t),t.tag){case 1:return e=t.flags,e&65536?(t.flags=e&-65537|128,t):null;case 3:return qt(Be),ta(),e=t.flags,(e&65536)!==0&&(e&128)===0?(t.flags=e&-65537|128,t):null;case 26:case 27:case 5:return Yn(t),null;case 13:if(Xt(t),e=t.memoizedState,e!==null&&e.dehydrated!==null){if(t.alternate===null)throw Error(c(340));Zi()}return e=t.flags,e&65536?(t.flags=e&-65537|128,t):null;case 19:return V(He),null;case 4:return ta(),null;case 10:return qt(t.type),null;case 22:case 23:return Xt(t),fr(),e!==null&&V(_a),e=t.flags,e&65536?(t.flags=e&-65537|128,t):null;case 24:return qt(Be),null;case 25:return null;default:return null}}function zu(e,t){switch(Ps(t),t.tag){case 3:qt(Be),ta();break;case 26:case 27:case 5:Yn(t);break;case 4:ta();break;case 13:Xt(t);break;case 19:V(He);break;case 10:qt(t.type);break;case 22:case 23:Xt(t),fr(),e!==null&&V(_a);break;case 24:qt(Be)}}function mn(e,t){try{var a=t.updateQueue,i=a!==null?a.lastEffect:null;if(i!==null){var l=i.next;a=l;do{if((a.tag&e)===e){i=void 0;var s=a.create,o=a.inst;i=s(),o.destroy=i}a=a.next}while(a!==l)}}catch(u){Ae(t,t.return,u)}}function ma(e,t,a){try{var i=t.updateQueue,l=i!==null?i.lastEffect:null;if(l!==null){var s=l.next;i=s;do{if((i.tag&e)===e){var o=i.inst,u=o.destroy;if(u!==void 0){o.destroy=void 0,l=t;var h=a,k=u;try{k()}catch(M){Ae(l,h,M)}}}i=i.next}while(i!==s)}}catch(M){Ae(t,t.return,M)}}function Eu(e){var t=e.updateQueue;if(t!==null){var a=e.stateNode;try{hd(t,a)}catch(i){Ae(e,e.return,i)}}}function Cu(e,t,a){a.props=Ga(e.type,e.memoizedProps),a.state=e.memoizedState;try{a.componentWillUnmount()}catch(i){Ae(e,t,i)}}function fn(e,t){try{var a=e.ref;if(a!==null){switch(e.tag){case 26:case 27:case 5:var i=e.stateNode;break;case 30:i=e.stateNode;break;default:i=e.stateNode}typeof a=="function"?e.refCleanup=a(i):a.current=i}}catch(l){Ae(e,t,l)}}function Mt(e,t){var a=e.ref,i=e.refCleanup;if(a!==null)if(typeof i=="function")try{i()}catch(l){Ae(e,t,l)}finally{e.refCleanup=null,e=e.alternate,e!=null&&(e.refCleanup=null)}else if(typeof a=="function")try{a(null)}catch(l){Ae(e,t,l)}else a.current=null}function Tu(e){var t=e.type,a=e.memoizedProps,i=e.stateNode;try{e:switch(t){case"button":case"input":case"select":case"textarea":a.autoFocus&&i.focus();break e;case"img":a.src?i.src=a.src:a.srcSet&&(i.srcset=a.srcSet)}}catch(l){Ae(e,e.return,l)}}function Yr(e,t,a){try{var i=e.stateNode;g0(i,e.type,a,t),i[Pe]=t}catch(l){Ae(e,e.return,l)}}function Mu(e){return e.tag===5||e.tag===3||e.tag===26||e.tag===27&&va(e.type)||e.tag===4}function qr(e){e:for(;;){for(;e.sibling===null;){if(e.return===null||Mu(e.return))return null;e=e.return}for(e.sibling.return=e.return,e=e.sibling;e.tag!==5&&e.tag!==6&&e.tag!==18;){if(e.tag===27&&va(e.type)||e.flags&2||e.child===null||e.tag===4)continue e;e.child.return=e,e=e.child}if(!(e.flags&2))return e.stateNode}}function Qr(e,t,a){var i=e.tag;if(i===5||i===6)e=e.stateNode,t?(a.nodeType===9?a.body:a.nodeName==="HTML"?a.ownerDocument.body:a).insertBefore(e,t):(t=a.nodeType===9?a.body:a.nodeName==="HTML"?a.ownerDocument.body:a,t.appendChild(e),a=a._reactRootContainer,a!=null||t.onclick!==null||(t.onclick=ql));else if(i!==4&&(i===27&&va(e.type)&&(a=e.stateNode,t=null),e=e.child,e!==null))for(Qr(e,t,a),e=e.sibling;e!==null;)Qr(e,t,a),e=e.sibling}function Ml(e,t,a){var i=e.tag;if(i===5||i===6)e=e.stateNode,t?a.insertBefore(e,t):a.appendChild(e);else if(i!==4&&(i===27&&va(e.type)&&(a=e.stateNode),e=e.child,e!==null))for(Ml(e,t,a),e=e.sibling;e!==null;)Ml(e,t,a),e=e.sibling}function Du(e){var t=e.stateNode,a=e.memoizedProps;try{for(var i=e.type,l=t.attributes;l.length;)t.removeAttributeNode(l[0]);Xe(t,i,a),t[Ke]=e,t[Pe]=a}catch(s){Ae(e,e.return,s)}}var Kt=!1,Re=!1,Xr=!1,Ru=typeof WeakSet=="function"?WeakSet:Set,Ge=null;function Wh(e,t){if(e=e.containerInfo,ho=Jl,e=Xc(e),qs(e)){if("selectionStart"in e)var a={start:e.selectionStart,end:e.selectionEnd};else e:{a=(a=e.ownerDocument)&&a.defaultView||window;var i=a.getSelection&&a.getSelection();if(i&&i.rangeCount!==0){a=i.anchorNode;var l=i.anchorOffset,s=i.focusNode;i=i.focusOffset;try{a.nodeType,s.nodeType}catch{a=null;break e}var o=0,u=-1,h=-1,k=0,M=0,U=e,z=null;t:for(;;){for(var T;U!==a||l!==0&&U.nodeType!==3||(u=o+l),U!==s||i!==0&&U.nodeType!==3||(h=o+i),U.nodeType===3&&(o+=U.nodeValue.length),(T=U.firstChild)!==null;)z=U,U=T;for(;;){if(U===e)break t;if(z===a&&++k===l&&(u=o),z===s&&++M===i&&(h=o),(T=U.nextSibling)!==null)break;U=z,z=U.parentNode}U=T}a=u===-1||h===-1?null:{start:u,end:h}}else a=null}a=a||{start:0,end:0}}else a=null;for(go={focusedElem:e,selectionRange:a},Jl=!1,Ge=t;Ge!==null;)if(t=Ge,e=t.child,(t.subtreeFlags&1024)!==0&&e!==null)e.return=t,Ge=e;else for(;Ge!==null;){switch(t=Ge,s=t.alternate,e=t.flags,t.tag){case 0:break;case 11:case 15:break;case 1:if((e&1024)!==0&&s!==null){e=void 0,a=t,l=s.memoizedProps,s=s.memoizedState,i=a.stateNode;try{var te=Ga(a.type,l,a.elementType===a.type);e=i.getSnapshotBeforeUpdate(te,s),i.__reactInternalSnapshotBeforeUpdate=e}catch(F){Ae(a,a.return,F)}}break;case 3:if((e&1024)!==0){if(e=t.stateNode.containerInfo,a=e.nodeType,a===9)yo(e);else if(a===1)switch(e.nodeName){case"HEAD":case"HTML":case"BODY":yo(e);break;default:e.textContent=""}}break;case 5:case 26:case 27:case 6:case 4:case 17:break;default:if((e&1024)!==0)throw Error(c(163))}if(e=t.sibling,e!==null){e.return=t.return,Ge=e;break}Ge=t.return}}function Ou(e,t,a){var i=a.flags;switch(a.tag){case 0:case 11:case 15:fa(e,a),i&4&&mn(5,a);break;case 1:if(fa(e,a),i&4)if(e=a.stateNode,t===null)try{e.componentDidMount()}catch(o){Ae(a,a.return,o)}else{var l=Ga(a.type,t.memoizedProps);t=t.memoizedState;try{e.componentDidUpdate(l,t,e.__reactInternalSnapshotBeforeUpdate)}catch(o){Ae(a,a.return,o)}}i&64&&Eu(a),i&512&&fn(a,a.return);break;case 3:if(fa(e,a),i&64&&(e=a.updateQueue,e!==null)){if(t=null,a.child!==null)switch(a.child.tag){case 27:case 5:t=a.child.stateNode;break;case 1:t=a.child.stateNode}try{hd(e,t)}catch(o){Ae(a,a.return,o)}}break;case 27:t===null&&i&4&&Du(a);case 26:case 5:fa(e,a),t===null&&i&4&&Tu(a),i&512&&fn(a,a.return);break;case 12:fa(e,a);break;case 13:fa(e,a),i&4&&Hu(e,a),i&64&&(e=a.memoizedState,e!==null&&(e=e.dehydrated,e!==null&&(a=l0.bind(null,a),A0(e,a))));break;case 22:if(i=a.memoizedState!==null||Kt,!i){t=t!==null&&t.memoizedState!==null||Re,l=Kt;var s=Re;Kt=i,(Re=t)&&!s?pa(e,a,(a.subtreeFlags&8772)!==0):fa(e,a),Kt=l,Re=s}break;case 30:break;default:fa(e,a)}}function Uu(e){var t=e.alternate;t!==null&&(e.alternate=null,Uu(t)),e.child=null,e.deletions=null,e.sibling=null,e.tag===5&&(t=e.stateNode,t!==null&&As(t)),e.stateNode=null,e.return=null,e.dependencies=null,e.memoizedProps=null,e.memoizedState=null,e.pendingProps=null,e.stateNode=null,e.updateQueue=null}var ke=null,at=!1;function Zt(e,t,a){for(a=a.child;a!==null;)Bu(e,t,a),a=a.sibling}function Bu(e,t,a){if(lt&&typeof lt.onCommitFiberUnmount=="function")try{lt.onCommitFiberUnmount(Ri,a)}catch{}switch(a.tag){case 26:Re||Mt(a,t),Zt(e,t,a),a.memoizedState?a.memoizedState.count--:a.stateNode&&(a=a.stateNode,a.parentNode.removeChild(a));break;case 27:Re||Mt(a,t);var i=ke,l=at;va(a.type)&&(ke=a.stateNode,at=!1),Zt(e,t,a),jn(a.stateNode),ke=i,at=l;break;case 5:Re||Mt(a,t);case 6:if(i=ke,l=at,ke=null,Zt(e,t,a),ke=i,at=l,ke!==null)if(at)try{(ke.nodeType===9?ke.body:ke.nodeName==="HTML"?ke.ownerDocument.body:ke).removeChild(a.stateNode)}catch(s){Ae(a,t,s)}else try{ke.removeChild(a.stateNode)}catch(s){Ae(a,t,s)}break;case 18:ke!==null&&(at?(e=ke,Nm(e.nodeType===9?e.body:e.nodeName==="HTML"?e.ownerDocument.body:e,a.stateNode),Tn(e)):Nm(ke,a.stateNode));break;case 4:i=ke,l=at,ke=a.stateNode.containerInfo,at=!0,Zt(e,t,a),ke=i,at=l;break;case 0:case 11:case 14:case 15:Re||ma(2,a,t),Re||ma(4,a,t),Zt(e,t,a);break;case 1:Re||(Mt(a,t),i=a.stateNode,typeof i.componentWillUnmount=="function"&&Cu(a,t,i)),Zt(e,t,a);break;case 21:Zt(e,t,a);break;case 22:Re=(i=Re)||a.memoizedState!==null,Zt(e,t,a),Re=i;break;default:Zt(e,t,a)}}function Hu(e,t){if(t.memoizedState===null&&(e=t.alternate,e!==null&&(e=e.memoizedState,e!==null&&(e=e.dehydrated,e!==null))))try{Tn(e)}catch(a){Ae(t,t.return,a)}}function Fh(e){switch(e.tag){case 13:case 19:var t=e.stateNode;return t===null&&(t=e.stateNode=new Ru),t;case 22:return e=e.stateNode,t=e._retryCache,t===null&&(t=e._retryCache=new Ru),t;default:throw Error(c(435,e.tag))}}function Vr(e,t){var a=Fh(e);t.forEach(function(i){var l=s0.bind(null,e,i);a.has(i)||(a.add(i),i.then(l,l))})}function ct(e,t){var a=t.deletions;if(a!==null)for(var i=0;i<a.length;i++){var l=a[i],s=e,o=t,u=o;e:for(;u!==null;){switch(u.tag){case 27:if(va(u.type)){ke=u.stateNode,at=!1;break e}break;case 5:ke=u.stateNode,at=!1;break e;case 3:case 4:ke=u.stateNode.containerInfo,at=!0;break e}u=u.return}if(ke===null)throw Error(c(160));Bu(s,o,l),ke=null,at=!1,s=l.alternate,s!==null&&(s.return=null),l.return=null}if(t.subtreeFlags&13878)for(t=t.child;t!==null;)_u(t,e),t=t.sibling}var St=null;function _u(e,t){var a=e.alternate,i=e.flags;switch(e.tag){case 0:case 11:case 14:case 15:ct(t,e),dt(e),i&4&&(ma(3,e,e.return),mn(3,e),ma(5,e,e.return));break;case 1:ct(t,e),dt(e),i&512&&(Re||a===null||Mt(a,a.return)),i&64&&Kt&&(e=e.updateQueue,e!==null&&(i=e.callbacks,i!==null&&(a=e.shared.hiddenCallbacks,e.shared.hiddenCallbacks=a===null?i:a.concat(i))));break;case 26:var l=St;if(ct(t,e),dt(e),i&512&&(Re||a===null||Mt(a,a.return)),i&4){var s=a!==null?a.memoizedState:null;if(i=e.memoizedState,a===null)if(i===null)if(e.stateNode===null){e:{i=e.type,a=e.memoizedProps,l=l.ownerDocument||l;t:switch(i){case"title":s=l.getElementsByTagName("title")[0],(!s||s[Bi]||s[Ke]||s.namespaceURI==="http://www.w3.org/2000/svg"||s.hasAttribute("itemprop"))&&(s=l.createElement(i),l.head.insertBefore(s,l.querySelector("head > title"))),Xe(s,i,a),s[Ke]=e,_e(s),i=s;break e;case"link":var o=Dm("link","href",l).get(i+(a.href||""));if(o){for(var u=0;u<o.length;u++)if(s=o[u],s.getAttribute("href")===(a.href==null||a.href===""?null:a.href)&&s.getAttribute("rel")===(a.rel==null?null:a.rel)&&s.getAttribute("title")===(a.title==null?null:a.title)&&s.getAttribute("crossorigin")===(a.crossOrigin==null?null:a.crossOrigin)){o.splice(u,1);break t}}s=l.createElement(i),Xe(s,i,a),l.head.appendChild(s);break;case"meta":if(o=Dm("meta","content",l).get(i+(a.content||""))){for(u=0;u<o.length;u++)if(s=o[u],s.getAttribute("content")===(a.content==null?null:""+a.content)&&s.getAttribute("name")===(a.name==null?null:a.name)&&s.getAttribute("property")===(a.property==null?null:a.property)&&s.getAttribute("http-equiv")===(a.httpEquiv==null?null:a.httpEquiv)&&s.getAttribute("charset")===(a.charSet==null?null:a.charSet)){o.splice(u,1);break t}}s=l.createElement(i),Xe(s,i,a),l.head.appendChild(s);break;default:throw Error(c(468,i))}s[Ke]=e,_e(s),i=s}e.stateNode=i}else Rm(l,e.type,e.stateNode);else e.stateNode=Mm(l,i,e.memoizedProps);else s!==i?(s===null?a.stateNode!==null&&(a=a.stateNode,a.parentNode.removeChild(a)):s.count--,i===null?Rm(l,e.type,e.stateNode):Mm(l,i,e.memoizedProps)):i===null&&e.stateNode!==null&&Yr(e,e.memoizedProps,a.memoizedProps)}break;case 27:ct(t,e),dt(e),i&512&&(Re||a===null||Mt(a,a.return)),a!==null&&i&4&&Yr(e,e.memoizedProps,a.memoizedProps);break;case 5:if(ct(t,e),dt(e),i&512&&(Re||a===null||Mt(a,a.return)),e.flags&32){l=e.stateNode;try{$a(l,"")}catch(T){Ae(e,e.return,T)}}i&4&&e.stateNode!=null&&(l=e.memoizedProps,Yr(e,l,a!==null?a.memoizedProps:l)),i&1024&&(Xr=!0);break;case 6:if(ct(t,e),dt(e),i&4){if(e.stateNode===null)throw Error(c(162));i=e.memoizedProps,a=e.stateNode;try{a.nodeValue=i}catch(T){Ae(e,e.return,T)}}break;case 3:if(Il=null,l=St,St=Xl(t.containerInfo),ct(t,e),St=l,dt(e),i&4&&a!==null&&a.memoizedState.isDehydrated)try{Tn(t.containerInfo)}catch(T){Ae(e,e.return,T)}Xr&&(Xr=!1,Lu(e));break;case 4:i=St,St=Xl(e.stateNode.containerInfo),ct(t,e),dt(e),St=i;break;case 12:ct(t,e),dt(e);break;case 13:ct(t,e),dt(e),e.child.flags&8192&&e.memoizedState!==null!=(a!==null&&a.memoizedState!==null)&&(Fr=Et()),i&4&&(i=e.updateQueue,i!==null&&(e.updateQueue=null,Vr(e,i)));break;case 22:l=e.memoizedState!==null;var h=a!==null&&a.memoizedState!==null,k=Kt,M=Re;if(Kt=k||l,Re=M||h,ct(t,e),Re=M,Kt=k,dt(e),i&8192)e:for(t=e.stateNode,t._visibility=l?t._visibility&-2:t._visibility|1,l&&(a===null||h||Kt||Re||Ya(e)),a=null,t=e;;){if(t.tag===5||t.tag===26){if(a===null){h=a=t;try{if(s=h.stateNode,l)o=s.style,typeof o.setProperty=="function"?o.setProperty("display","none","important"):o.display="none";else{u=h.stateNode;var U=h.memoizedProps.style,z=U!=null&&U.hasOwnProperty("display")?U.display:null;u.style.display=z==null||typeof z=="boolean"?"":(""+z).trim()}}catch(T){Ae(h,h.return,T)}}}else if(t.tag===6){if(a===null){h=t;try{h.stateNode.nodeValue=l?"":h.memoizedProps}catch(T){Ae(h,h.return,T)}}}else if((t.tag!==22&&t.tag!==23||t.memoizedState===null||t===e)&&t.child!==null){t.child.return=t,t=t.child;continue}if(t===e)break e;for(;t.sibling===null;){if(t.return===null||t.return===e)break e;a===t&&(a=null),t=t.return}a===t&&(a=null),t.sibling.return=t.return,t=t.sibling}i&4&&(i=e.updateQueue,i!==null&&(a=i.retryQueue,a!==null&&(i.retryQueue=null,Vr(e,a))));break;case 19:ct(t,e),dt(e),i&4&&(i=e.updateQueue,i!==null&&(e.updateQueue=null,Vr(e,i)));break;case 30:break;case 21:break;default:ct(t,e),dt(e)}}function dt(e){var t=e.flags;if(t&2){try{for(var a,i=e.return;i!==null;){if(Mu(i)){a=i;break}i=i.return}if(a==null)throw Error(c(160));switch(a.tag){case 27:var l=a.stateNode,s=qr(e);Ml(e,s,l);break;case 5:var o=a.stateNode;a.flags&32&&($a(o,""),a.flags&=-33);var u=qr(e);Ml(e,u,o);break;case 3:case 4:var h=a.stateNode.containerInfo,k=qr(e);Qr(e,k,h);break;default:throw Error(c(161))}}catch(M){Ae(e,e.return,M)}e.flags&=-3}t&4096&&(e.flags&=-4097)}function Lu(e){if(e.subtreeFlags&1024)for(e=e.child;e!==null;){var t=e;Lu(t),t.tag===5&&t.flags&1024&&t.stateNode.reset(),e=e.sibling}}function fa(e,t){if(t.subtreeFlags&8772)for(t=t.child;t!==null;)Ou(e,t.alternate,t),t=t.sibling}function Ya(e){for(e=e.child;e!==null;){var t=e;switch(t.tag){case 0:case 11:case 14:case 15:ma(4,t,t.return),Ya(t);break;case 1:Mt(t,t.return);var a=t.stateNode;typeof a.componentWillUnmount=="function"&&Cu(t,t.return,a),Ya(t);break;case 27:jn(t.stateNode);case 26:case 5:Mt(t,t.return),Ya(t);break;case 22:t.memoizedState===null&&Ya(t);break;case 30:Ya(t);break;default:Ya(t)}e=e.sibling}}function pa(e,t,a){for(a=a&&(t.subtreeFlags&8772)!==0,t=t.child;t!==null;){var i=t.alternate,l=e,s=t,o=s.flags;switch(s.tag){case 0:case 11:case 15:pa(l,s,a),mn(4,s);break;case 1:if(pa(l,s,a),i=s,l=i.stateNode,typeof l.componentDidMount=="function")try{l.componentDidMount()}catch(k){Ae(i,i.return,k)}if(i=s,l=i.updateQueue,l!==null){var u=i.stateNode;try{var h=l.shared.hiddenCallbacks;if(h!==null)for(l.shared.hiddenCallbacks=null,l=0;l<h.length;l++)pd(h[l],u)}catch(k){Ae(i,i.return,k)}}a&&o&64&&Eu(s),fn(s,s.return);break;case 27:Du(s);case 26:case 5:pa(l,s,a),a&&i===null&&o&4&&Tu(s),fn(s,s.return);break;case 12:pa(l,s,a);break;case 13:pa(l,s,a),a&&o&4&&Hu(l,s);break;case 22:s.memoizedState===null&&pa(l,s,a),fn(s,s.return);break;case 30:break;default:pa(l,s,a)}t=t.sibling}}function Ir(e,t){var a=null;e!==null&&e.memoizedState!==null&&e.memoizedState.cachePool!==null&&(a=e.memoizedState.cachePool.pool),e=null,t.memoizedState!==null&&t.memoizedState.cachePool!==null&&(e=t.memoizedState.cachePool.pool),e!==a&&(e!=null&&e.refCount++,a!=null&&Fi(a))}function Kr(e,t){e=null,t.alternate!==null&&(e=t.alternate.memoizedState.cache),t=t.memoizedState.cache,t!==e&&(t.refCount++,e!=null&&Fi(e))}function Dt(e,t,a,i){if(t.subtreeFlags&10256)for(t=t.child;t!==null;)Gu(e,t,a,i),t=t.sibling}function Gu(e,t,a,i){var l=t.flags;switch(t.tag){case 0:case 11:case 15:Dt(e,t,a,i),l&2048&&mn(9,t);break;case 1:Dt(e,t,a,i);break;case 3:Dt(e,t,a,i),l&2048&&(e=null,t.alternate!==null&&(e=t.alternate.memoizedState.cache),t=t.memoizedState.cache,t!==e&&(t.refCount++,e!=null&&Fi(e)));break;case 12:if(l&2048){Dt(e,t,a,i),e=t.stateNode;try{var s=t.memoizedProps,o=s.id,u=s.onPostCommit;typeof u=="function"&&u(o,t.alternate===null?"mount":"update",e.passiveEffectDuration,-0)}catch(h){Ae(t,t.return,h)}}else Dt(e,t,a,i);break;case 13:Dt(e,t,a,i);break;case 23:break;case 22:s=t.stateNode,o=t.alternate,t.memoizedState!==null?s._visibility&2?Dt(e,t,a,i):pn(e,t):s._visibility&2?Dt(e,t,a,i):(s._visibility|=2,xi(e,t,a,i,(t.subtreeFlags&10256)!==0)),l&2048&&Ir(o,t);break;case 24:Dt(e,t,a,i),l&2048&&Kr(t.alternate,t);break;default:Dt(e,t,a,i)}}function xi(e,t,a,i,l){for(l=l&&(t.subtreeFlags&10256)!==0,t=t.child;t!==null;){var s=e,o=t,u=a,h=i,k=o.flags;switch(o.tag){case 0:case 11:case 15:xi(s,o,u,h,l),mn(8,o);break;case 23:break;case 22:var M=o.stateNode;o.memoizedState!==null?M._visibility&2?xi(s,o,u,h,l):pn(s,o):(M._visibility|=2,xi(s,o,u,h,l)),l&&k&2048&&Ir(o.alternate,o);break;case 24:xi(s,o,u,h,l),l&&k&2048&&Kr(o.alternate,o);break;default:xi(s,o,u,h,l)}t=t.sibling}}function pn(e,t){if(t.subtreeFlags&10256)for(t=t.child;t!==null;){var a=e,i=t,l=i.flags;switch(i.tag){case 22:pn(a,i),l&2048&&Ir(i.alternate,i);break;case 24:pn(a,i),l&2048&&Kr(i.alternate,i);break;default:pn(a,i)}t=t.sibling}}var hn=8192;function bi(e){if(e.subtreeFlags&hn)for(e=e.child;e!==null;)Yu(e),e=e.sibling}function Yu(e){switch(e.tag){case 26:bi(e),e.flags&hn&&e.memoizedState!==null&&B0(St,e.memoizedState,e.memoizedProps);break;case 5:bi(e);break;case 3:case 4:var t=St;St=Xl(e.stateNode.containerInfo),bi(e),St=t;break;case 22:e.memoizedState===null&&(t=e.alternate,t!==null&&t.memoizedState!==null?(t=hn,hn=16777216,bi(e),hn=t):bi(e));break;default:bi(e)}}function qu(e){var t=e.alternate;if(t!==null&&(e=t.child,e!==null)){t.child=null;do t=e.sibling,e.sibling=null,e=t;while(e!==null)}}function gn(e){var t=e.deletions;if((e.flags&16)!==0){if(t!==null)for(var a=0;a<t.length;a++){var i=t[a];Ge=i,Xu(i,e)}qu(e)}if(e.subtreeFlags&10256)for(e=e.child;e!==null;)Qu(e),e=e.sibling}function Qu(e){switch(e.tag){case 0:case 11:case 15:gn(e),e.flags&2048&&ma(9,e,e.return);break;case 3:gn(e);break;case 12:gn(e);break;case 22:var t=e.stateNode;e.memoizedState!==null&&t._visibility&2&&(e.return===null||e.return.tag!==13)?(t._visibility&=-3,Dl(e)):gn(e);break;default:gn(e)}}function Dl(e){var t=e.deletions;if((e.flags&16)!==0){if(t!==null)for(var a=0;a<t.length;a++){var i=t[a];Ge=i,Xu(i,e)}qu(e)}for(e=e.child;e!==null;){switch(t=e,t.tag){case 0:case 11:case 15:ma(8,t,t.return),Dl(t);break;case 22:a=t.stateNode,a._visibility&2&&(a._visibility&=-3,Dl(t));break;default:Dl(t)}e=e.sibling}}function Xu(e,t){for(;Ge!==null;){var a=Ge;switch(a.tag){case 0:case 11:case 15:ma(8,a,t);break;case 23:case 22:if(a.memoizedState!==null&&a.memoizedState.cachePool!==null){var i=a.memoizedState.cachePool.pool;i!=null&&i.refCount++}break;case 24:Fi(a.memoizedState.cache)}if(i=a.child,i!==null)i.return=a,Ge=i;else e:for(a=e;Ge!==null;){i=Ge;var l=i.sibling,s=i.return;if(Uu(i),i===a){Ge=null;break e}if(l!==null){l.return=s,Ge=l;break e}Ge=s}}}var $h={getCacheForType:function(e){var t=Ze(Be),a=t.data.get(e);return a===void 0&&(a=e(),t.data.set(e,a)),a}},Ph=typeof WeakMap=="function"?WeakMap:Map,he=0,Ne=null,se=null,oe=0,ge=0,ut=null,ha=!1,yi=!1,Zr=!1,Jt=0,Te=0,ga=0,qa=0,Jr=0,wt=0,vi=0,xn=null,it=null,Wr=!1,Fr=0,Rl=1/0,Ol=null,xa=null,Qe=0,ba=null,wi=null,ji=0,$r=0,Pr=null,Vu=null,bn=0,eo=null;function mt(){if((he&2)!==0&&oe!==0)return oe&-oe;if(D.T!==null){var e=ci;return e!==0?e:ro()}return rc()}function Iu(){wt===0&&(wt=(oe&536870912)===0||fe?ic():536870912);var e=vt.current;return e!==null&&(e.flags|=32),wt}function ft(e,t,a){(e===Ne&&(ge===2||ge===9)||e.cancelPendingCommit!==null)&&(Ai(e,0),ya(e,oe,wt,!1)),Ui(e,a),((he&2)===0||e!==Ne)&&(e===Ne&&((he&2)===0&&(qa|=a),Te===4&&ya(e,oe,wt,!1)),Rt(e))}function Ku(e,t,a){if((he&6)!==0)throw Error(c(327));var i=!a&&(t&124)===0&&(t&e.expiredLanes)===0||Oi(e,t),l=i?a0(e,t):io(e,t,!0),s=i;do{if(l===0){yi&&!i&&ya(e,t,0,!1);break}else{if(a=e.current.alternate,s&&!e0(a)){l=io(e,t,!1),s=!1;continue}if(l===2){if(s=t,e.errorRecoveryDisabledLanes&s)var o=0;else o=e.pendingLanes&-536870913,o=o!==0?o:o&536870912?536870912:0;if(o!==0){t=o;e:{var u=e;l=xn;var h=u.current.memoizedState.isDehydrated;if(h&&(Ai(u,o).flags|=256),o=io(u,o,!1),o!==2){if(Zr&&!h){u.errorRecoveryDisabledLanes|=s,qa|=s,l=4;break e}s=it,it=l,s!==null&&(it===null?it=s:it.push.apply(it,s))}l=o}if(s=!1,l!==2)continue}}if(l===1){Ai(e,0),ya(e,t,0,!0);break}e:{switch(i=e,s=l,s){case 0:case 1:throw Error(c(345));case 4:if((t&4194048)!==t)break;case 6:ya(i,t,wt,!ha);break e;case 2:it=null;break;case 3:case 5:break;default:throw Error(c(329))}if((t&62914560)===t&&(l=Fr+300-Et(),10<l)){if(ya(i,t,wt,!ha),Vn(i,0,!0)!==0)break e;i.timeoutHandle=jm(Zu.bind(null,i,a,it,Ol,Wr,t,wt,qa,vi,ha,s,2,-0,0),l);break e}Zu(i,a,it,Ol,Wr,t,wt,qa,vi,ha,s,0,-0,0)}}break}while(!0);Rt(e)}function Zu(e,t,a,i,l,s,o,u,h,k,M,U,z,T){if(e.timeoutHandle=-1,U=t.subtreeFlags,(U&8192||(U&16785408)===16785408)&&(Sn={stylesheets:null,count:0,unsuspend:U0},Yu(t),U=H0(),U!==null)){e.cancelPendingCommit=U(tm.bind(null,e,t,s,a,i,l,o,u,h,M,1,z,T)),ya(e,s,o,!k);return}tm(e,t,s,a,i,l,o,u,h)}function e0(e){for(var t=e;;){var a=t.tag;if((a===0||a===11||a===15)&&t.flags&16384&&(a=t.updateQueue,a!==null&&(a=a.stores,a!==null)))for(var i=0;i<a.length;i++){var l=a[i],s=l.getSnapshot;l=l.value;try{if(!rt(s(),l))return!1}catch{return!1}}if(a=t.child,t.subtreeFlags&16384&&a!==null)a.return=t,t=a;else{if(t===e)break;for(;t.sibling===null;){if(t.return===null||t.return===e)return!0;t=t.return}t.sibling.return=t.return,t=t.sibling}}return!0}function ya(e,t,a,i){t&=~Jr,t&=~qa,e.suspendedLanes|=t,e.pingedLanes&=~t,i&&(e.warmLanes|=t),i=e.expirationTimes;for(var l=t;0<l;){var s=31-st(l),o=1<<s;i[s]=-1,l&=~o}a!==0&&lc(e,a,t)}function Ul(){return(he&6)===0?(yn(0),!1):!0}function to(){if(se!==null){if(ge===0)var e=se.return;else e=se,Yt=Ba=null,br(e),hi=null,cn=0,e=se;for(;e!==null;)zu(e.alternate,e),e=e.return;se=null}}function Ai(e,t){var a=e.timeoutHandle;a!==-1&&(e.timeoutHandle=-1,b0(a)),a=e.cancelPendingCommit,a!==null&&(e.cancelPendingCommit=null,a()),to(),Ne=e,se=a=_t(e.current,null),oe=t,ge=0,ut=null,ha=!1,yi=Oi(e,t),Zr=!1,vi=wt=Jr=qa=ga=Te=0,it=xn=null,Wr=!1,(t&8)!==0&&(t|=t&32);var i=e.entangledLanes;if(i!==0)for(e=e.entanglements,i&=t;0<i;){var l=31-st(i),s=1<<l;t|=e[l],i&=~s}return Jt=t,il(),a}function Ju(e,t){ne=null,D.H=jl,t===Pi||t===ml?(t=md(),ge=3):t===cd?(t=md(),ge=4):ge=t===fu?8:t!==null&&typeof t=="object"&&typeof t.then=="function"?6:1,ut=t,se===null&&(Te=1,zl(e,gt(t,e.current)))}function Wu(){var e=D.H;return D.H=jl,e===null?jl:e}function Fu(){var e=D.A;return D.A=$h,e}function ao(){Te=4,ha||(oe&4194048)!==oe&&vt.current!==null||(yi=!0),(ga&134217727)===0&&(qa&134217727)===0||Ne===null||ya(Ne,oe,wt,!1)}function io(e,t,a){var i=he;he|=2;var l=Wu(),s=Fu();(Ne!==e||oe!==t)&&(Ol=null,Ai(e,t)),t=!1;var o=Te;e:do try{if(ge!==0&&se!==null){var u=se,h=ut;switch(ge){case 8:to(),o=6;break e;case 3:case 2:case 9:case 6:vt.current===null&&(t=!0);var k=ge;if(ge=0,ut=null,Ni(e,u,h,k),a&&yi){o=0;break e}break;default:k=ge,ge=0,ut=null,Ni(e,u,h,k)}}t0(),o=Te;break}catch(M){Ju(e,M)}while(!0);return t&&e.shellSuspendCounter++,Yt=Ba=null,he=i,D.H=l,D.A=s,se===null&&(Ne=null,oe=0,il()),o}function t0(){for(;se!==null;)$u(se)}function a0(e,t){var a=he;he|=2;var i=Wu(),l=Fu();Ne!==e||oe!==t?(Ol=null,Rl=Et()+500,Ai(e,t)):yi=Oi(e,t);e:do try{if(ge!==0&&se!==null){t=se;var s=ut;t:switch(ge){case 1:ge=0,ut=null,Ni(e,t,s,1);break;case 2:case 9:if(dd(s)){ge=0,ut=null,Pu(t);break}t=function(){ge!==2&&ge!==9||Ne!==e||(ge=7),Rt(e)},s.then(t,t);break e;case 3:ge=7;break e;case 4:ge=5;break e;case 7:dd(s)?(ge=0,ut=null,Pu(t)):(ge=0,ut=null,Ni(e,t,s,7));break;case 5:var o=null;switch(se.tag){case 26:o=se.memoizedState;case 5:case 27:var u=se;if(!o||Om(o)){ge=0,ut=null;var h=u.sibling;if(h!==null)se=h;else{var k=u.return;k!==null?(se=k,Bl(k)):se=null}break t}}ge=0,ut=null,Ni(e,t,s,5);break;case 6:ge=0,ut=null,Ni(e,t,s,6);break;case 8:to(),Te=6;break e;default:throw Error(c(462))}}i0();break}catch(M){Ju(e,M)}while(!0);return Yt=Ba=null,D.H=i,D.A=l,he=a,se!==null?0:(Ne=null,oe=0,il(),Te)}function i0(){for(;se!==null&&!Sp();)$u(se)}function $u(e){var t=Su(e.alternate,e,Jt);e.memoizedProps=e.pendingProps,t===null?Bl(e):se=t}function Pu(e){var t=e,a=t.alternate;switch(t.tag){case 15:case 0:t=yu(a,t,t.pendingProps,t.type,void 0,oe);break;case 11:t=yu(a,t,t.pendingProps,t.type.render,t.ref,oe);break;case 5:br(t);default:zu(a,t),t=se=ed(t,Jt),t=Su(a,t,Jt)}e.memoizedProps=e.pendingProps,t===null?Bl(e):se=t}function Ni(e,t,a,i){Yt=Ba=null,br(t),hi=null,cn=0;var l=t.return;try{if(Ih(e,l,t,a,oe)){Te=1,zl(e,gt(a,e.current)),se=null;return}}catch(s){if(l!==null)throw se=l,s;Te=1,zl(e,gt(a,e.current)),se=null;return}t.flags&32768?(fe||i===1?e=!0:yi||(oe&536870912)!==0?e=!1:(ha=e=!0,(i===2||i===9||i===3||i===6)&&(i=vt.current,i!==null&&i.tag===13&&(i.flags|=16384))),em(t,e)):Bl(t)}function Bl(e){var t=e;do{if((t.flags&32768)!==0){em(t,ha);return}e=t.return;var a=Zh(t.alternate,t,Jt);if(a!==null){se=a;return}if(t=t.sibling,t!==null){se=t;return}se=t=e}while(t!==null);Te===0&&(Te=5)}function em(e,t){do{var a=Jh(e.alternate,e);if(a!==null){a.flags&=32767,se=a;return}if(a=e.return,a!==null&&(a.flags|=32768,a.subtreeFlags=0,a.deletions=null),!t&&(e=e.sibling,e!==null)){se=e;return}se=e=a}while(e!==null);Te=6,se=null}function tm(e,t,a,i,l,s,o,u,h){e.cancelPendingCommit=null;do Hl();while(Qe!==0);if((he&6)!==0)throw Error(c(327));if(t!==null){if(t===e.current)throw Error(c(177));if(s=t.lanes|t.childLanes,s|=Ks,Up(e,a,s,o,u,h),e===Ne&&(se=Ne=null,oe=0),wi=t,ba=e,ji=a,$r=s,Pr=l,Vu=i,(t.subtreeFlags&10256)!==0||(t.flags&10256)!==0?(e.callbackNode=null,e.callbackPriority=0,r0(qn,function(){return sm(),null})):(e.callbackNode=null,e.callbackPriority=0),i=(t.flags&13878)!==0,(t.subtreeFlags&13878)!==0||i){i=D.T,D.T=null,l=Q.p,Q.p=2,o=he,he|=4;try{Wh(e,t,a)}finally{he=o,Q.p=l,D.T=i}}Qe=1,am(),im(),nm()}}function am(){if(Qe===1){Qe=0;var e=ba,t=wi,a=(t.flags&13878)!==0;if((t.subtreeFlags&13878)!==0||a){a=D.T,D.T=null;var i=Q.p;Q.p=2;var l=he;he|=4;try{_u(t,e);var s=go,o=Xc(e.containerInfo),u=s.focusedElem,h=s.selectionRange;if(o!==u&&u&&u.ownerDocument&&Qc(u.ownerDocument.documentElement,u)){if(h!==null&&qs(u)){var k=h.start,M=h.end;if(M===void 0&&(M=k),"selectionStart"in u)u.selectionStart=k,u.selectionEnd=Math.min(M,u.value.length);else{var U=u.ownerDocument||document,z=U&&U.defaultView||window;if(z.getSelection){var T=z.getSelection(),te=u.textContent.length,F=Math.min(h.start,te),ve=h.end===void 0?F:Math.min(h.end,te);!T.extend&&F>ve&&(o=ve,ve=F,F=o);var A=qc(u,F),b=qc(u,ve);if(A&&b&&(T.rangeCount!==1||T.anchorNode!==A.node||T.anchorOffset!==A.offset||T.focusNode!==b.node||T.focusOffset!==b.offset)){var S=U.createRange();S.setStart(A.node,A.offset),T.removeAllRanges(),F>ve?(T.addRange(S),T.extend(b.node,b.offset)):(S.setEnd(b.node,b.offset),T.addRange(S))}}}}for(U=[],T=u;T=T.parentNode;)T.nodeType===1&&U.push({element:T,left:T.scrollLeft,top:T.scrollTop});for(typeof u.focus=="function"&&u.focus(),u=0;u<U.length;u++){var R=U[u];R.element.scrollLeft=R.left,R.element.scrollTop=R.top}}Jl=!!ho,go=ho=null}finally{he=l,Q.p=i,D.T=a}}e.current=t,Qe=2}}function im(){if(Qe===2){Qe=0;var e=ba,t=wi,a=(t.flags&8772)!==0;if((t.subtreeFlags&8772)!==0||a){a=D.T,D.T=null;var i=Q.p;Q.p=2;var l=he;he|=4;try{Ou(e,t.alternate,t)}finally{he=l,Q.p=i,D.T=a}}Qe=3}}function nm(){if(Qe===4||Qe===3){Qe=0,kp();var e=ba,t=wi,a=ji,i=Vu;(t.subtreeFlags&10256)!==0||(t.flags&10256)!==0?Qe=5:(Qe=0,wi=ba=null,lm(e,e.pendingLanes));var l=e.pendingLanes;if(l===0&&(xa=null),ws(a),t=t.stateNode,lt&&typeof lt.onCommitFiberRoot=="function")try{lt.onCommitFiberRoot(Ri,t,void 0,(t.current.flags&128)===128)}catch{}if(i!==null){t=D.T,l=Q.p,Q.p=2,D.T=null;try{for(var s=e.onRecoverableError,o=0;o<i.length;o++){var u=i[o];s(u.value,{componentStack:u.stack})}}finally{D.T=t,Q.p=l}}(ji&3)!==0&&Hl(),Rt(e),l=e.pendingLanes,(a&4194090)!==0&&(l&42)!==0?e===eo?bn++:(bn=0,eo=e):bn=0,yn(0)}}function lm(e,t){(e.pooledCacheLanes&=t)===0&&(t=e.pooledCache,t!=null&&(e.pooledCache=null,Fi(t)))}function Hl(e){return am(),im(),nm(),sm()}function sm(){if(Qe!==5)return!1;var e=ba,t=$r;$r=0;var a=ws(ji),i=D.T,l=Q.p;try{Q.p=32>a?32:a,D.T=null,a=Pr,Pr=null;var s=ba,o=ji;if(Qe=0,wi=ba=null,ji=0,(he&6)!==0)throw Error(c(331));var u=he;if(he|=4,Qu(s.current),Gu(s,s.current,o,a),he=u,yn(0,!1),lt&&typeof lt.onPostCommitFiberRoot=="function")try{lt.onPostCommitFiberRoot(Ri,s)}catch{}return!0}finally{Q.p=l,D.T=i,lm(e,t)}}function rm(e,t,a){t=gt(a,t),t=Dr(e.stateNode,t,2),e=oa(e,t,2),e!==null&&(Ui(e,2),Rt(e))}function Ae(e,t,a){if(e.tag===3)rm(e,e,a);else for(;t!==null;){if(t.tag===3){rm(t,e,a);break}else if(t.tag===1){var i=t.stateNode;if(typeof t.type.getDerivedStateFromError=="function"||typeof i.componentDidCatch=="function"&&(xa===null||!xa.has(i))){e=gt(a,e),a=uu(2),i=oa(t,a,2),i!==null&&(mu(a,i,t,e),Ui(i,2),Rt(i));break}}t=t.return}}function no(e,t,a){var i=e.pingCache;if(i===null){i=e.pingCache=new Ph;var l=new Set;i.set(t,l)}else l=i.get(t),l===void 0&&(l=new Set,i.set(t,l));l.has(a)||(Zr=!0,l.add(a),e=n0.bind(null,e,t,a),t.then(e,e))}function n0(e,t,a){var i=e.pingCache;i!==null&&i.delete(t),e.pingedLanes|=e.suspendedLanes&a,e.warmLanes&=~a,Ne===e&&(oe&a)===a&&(Te===4||Te===3&&(oe&62914560)===oe&&300>Et()-Fr?(he&2)===0&&Ai(e,0):Jr|=a,vi===oe&&(vi=0)),Rt(e)}function om(e,t){t===0&&(t=nc()),e=li(e,t),e!==null&&(Ui(e,t),Rt(e))}function l0(e){var t=e.memoizedState,a=0;t!==null&&(a=t.retryLane),om(e,a)}function s0(e,t){var a=0;switch(e.tag){case 13:var i=e.stateNode,l=e.memoizedState;l!==null&&(a=l.retryLane);break;case 19:i=e.stateNode;break;case 22:i=e.stateNode._retryCache;break;default:throw Error(c(314))}i!==null&&i.delete(t),om(e,a)}function r0(e,t){return xs(e,t)}var _l=null,Si=null,lo=!1,Ll=!1,so=!1,Qa=0;function Rt(e){e!==Si&&e.next===null&&(Si===null?_l=Si=e:Si=Si.next=e),Ll=!0,lo||(lo=!0,c0())}function yn(e,t){if(!so&&Ll){so=!0;do for(var a=!1,i=_l;i!==null;){if(e!==0){var l=i.pendingLanes;if(l===0)var s=0;else{var o=i.suspendedLanes,u=i.pingedLanes;s=(1<<31-st(42|e)+1)-1,s&=l&~(o&~u),s=s&201326741?s&201326741|1:s?s|2:0}s!==0&&(a=!0,mm(i,s))}else s=oe,s=Vn(i,i===Ne?s:0,i.cancelPendingCommit!==null||i.timeoutHandle!==-1),(s&3)===0||Oi(i,s)||(a=!0,mm(i,s));i=i.next}while(a);so=!1}}function o0(){cm()}function cm(){Ll=lo=!1;var e=0;Qa!==0&&(x0()&&(e=Qa),Qa=0);for(var t=Et(),a=null,i=_l;i!==null;){var l=i.next,s=dm(i,t);s===0?(i.next=null,a===null?_l=l:a.next=l,l===null&&(Si=a)):(a=i,(e!==0||(s&3)!==0)&&(Ll=!0)),i=l}yn(e)}function dm(e,t){for(var a=e.suspendedLanes,i=e.pingedLanes,l=e.expirationTimes,s=e.pendingLanes&-62914561;0<s;){var o=31-st(s),u=1<<o,h=l[o];h===-1?((u&a)===0||(u&i)!==0)&&(l[o]=Op(u,t)):h<=t&&(e.expiredLanes|=u),s&=~u}if(t=Ne,a=oe,a=Vn(e,e===t?a:0,e.cancelPendingCommit!==null||e.timeoutHandle!==-1),i=e.callbackNode,a===0||e===t&&(ge===2||ge===9)||e.cancelPendingCommit!==null)return i!==null&&i!==null&&bs(i),e.callbackNode=null,e.callbackPriority=0;if((a&3)===0||Oi(e,a)){if(t=a&-a,t===e.callbackPriority)return t;switch(i!==null&&bs(i),ws(a)){case 2:case 8:a=tc;break;case 32:a=qn;break;case 268435456:a=ac;break;default:a=qn}return i=um.bind(null,e),a=xs(a,i),e.callbackPriority=t,e.callbackNode=a,t}return i!==null&&i!==null&&bs(i),e.callbackPriority=2,e.callbackNode=null,2}function um(e,t){if(Qe!==0&&Qe!==5)return e.callbackNode=null,e.callbackPriority=0,null;var a=e.callbackNode;if(Hl()&&e.callbackNode!==a)return null;var i=oe;return i=Vn(e,e===Ne?i:0,e.cancelPendingCommit!==null||e.timeoutHandle!==-1),i===0?null:(Ku(e,i,t),dm(e,Et()),e.callbackNode!=null&&e.callbackNode===a?um.bind(null,e):null)}function mm(e,t){if(Hl())return null;Ku(e,t,!0)}function c0(){y0(function(){(he&6)!==0?xs(ec,o0):cm()})}function ro(){return Qa===0&&(Qa=ic()),Qa}function fm(e){return e==null||typeof e=="symbol"||typeof e=="boolean"?null:typeof e=="function"?e:Wn(""+e)}function pm(e,t){var a=t.ownerDocument.createElement("input");return a.name=t.name,a.value=t.value,e.id&&a.setAttribute("form",e.id),t.parentNode.insertBefore(a,t),e=new FormData(e),a.parentNode.removeChild(a),e}function d0(e,t,a,i,l){if(t==="submit"&&a&&a.stateNode===l){var s=fm((l[Pe]||null).action),o=i.submitter;o&&(t=(t=o[Pe]||null)?fm(t.formAction):o.getAttribute("formAction"),t!==null&&(s=t,o=null));var u=new el("action","action",null,i,l);e.push({event:u,listeners:[{instance:null,listener:function(){if(i.defaultPrevented){if(Qa!==0){var h=o?pm(l,o):new FormData(l);zr(a,{pending:!0,data:h,method:l.method,action:s},null,h)}}else typeof s=="function"&&(u.preventDefault(),h=o?pm(l,o):new FormData(l),zr(a,{pending:!0,data:h,method:l.method,action:s},s,h))},currentTarget:l}]})}}for(var oo=0;oo<Is.length;oo++){var co=Is[oo],u0=co.toLowerCase(),m0=co[0].toUpperCase()+co.slice(1);Nt(u0,"on"+m0)}Nt(Kc,"onAnimationEnd"),Nt(Zc,"onAnimationIteration"),Nt(Jc,"onAnimationStart"),Nt("dblclick","onDoubleClick"),Nt("focusin","onFocus"),Nt("focusout","onBlur"),Nt(Ch,"onTransitionRun"),Nt(Th,"onTransitionStart"),Nt(Mh,"onTransitionCancel"),Nt(Wc,"onTransitionEnd"),Ja("onMouseEnter",["mouseout","mouseover"]),Ja("onMouseLeave",["mouseout","mouseover"]),Ja("onPointerEnter",["pointerout","pointerover"]),Ja("onPointerLeave",["pointerout","pointerover"]),za("onChange","change click focusin focusout input keydown keyup selectionchange".split(" ")),za("onSelect","focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" ")),za("onBeforeInput",["compositionend","keypress","textInput","paste"]),za("onCompositionEnd","compositionend focusout keydown keypress keyup mousedown".split(" ")),za("onCompositionStart","compositionstart focusout keydown keypress keyup mousedown".split(" ")),za("onCompositionUpdate","compositionupdate focusout keydown keypress keyup mousedown".split(" "));var vn="abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange resize seeked seeking stalled suspend timeupdate volumechange waiting".split(" "),f0=new Set("beforetoggle cancel close invalid load scroll scrollend toggle".split(" ").concat(vn));function hm(e,t){t=(t&4)!==0;for(var a=0;a<e.length;a++){var i=e[a],l=i.event;i=i.listeners;e:{var s=void 0;if(t)for(var o=i.length-1;0<=o;o--){var u=i[o],h=u.instance,k=u.currentTarget;if(u=u.listener,h!==s&&l.isPropagationStopped())break e;s=u,l.currentTarget=k;try{s(l)}catch(M){kl(M)}l.currentTarget=null,s=h}else for(o=0;o<i.length;o++){if(u=i[o],h=u.instance,k=u.currentTarget,u=u.listener,h!==s&&l.isPropagationStopped())break e;s=u,l.currentTarget=k;try{s(l)}catch(M){kl(M)}l.currentTarget=null,s=h}}}}function re(e,t){var a=t[js];a===void 0&&(a=t[js]=new Set);var i=e+"__bubble";a.has(i)||(gm(t,e,2,!1),a.add(i))}function uo(e,t,a){var i=0;t&&(i|=4),gm(a,e,i,t)}var Gl="_reactListening"+Math.random().toString(36).slice(2);function mo(e){if(!e[Gl]){e[Gl]=!0,cc.forEach(function(a){a!=="selectionchange"&&(f0.has(a)||uo(a,!1,e),uo(a,!0,e))});var t=e.nodeType===9?e:e.ownerDocument;t===null||t[Gl]||(t[Gl]=!0,uo("selectionchange",!1,t))}}function gm(e,t,a,i){switch(Gm(t)){case 2:var l=G0;break;case 8:l=Y0;break;default:l=ko}a=l.bind(null,t,a,e),l=void 0,!Rs||t!=="touchstart"&&t!=="touchmove"&&t!=="wheel"||(l=!0),i?l!==void 0?e.addEventListener(t,a,{capture:!0,passive:l}):e.addEventListener(t,a,!0):l!==void 0?e.addEventListener(t,a,{passive:l}):e.addEventListener(t,a,!1)}function fo(e,t,a,i,l){var s=i;if((t&1)===0&&(t&2)===0&&i!==null)e:for(;;){if(i===null)return;var o=i.tag;if(o===3||o===4){var u=i.stateNode.containerInfo;if(u===l)break;if(o===4)for(o=i.return;o!==null;){var h=o.tag;if((h===3||h===4)&&o.stateNode.containerInfo===l)return;o=o.return}for(;u!==null;){if(o=Ia(u),o===null)return;if(h=o.tag,h===5||h===6||h===26||h===27){i=s=o;continue e}u=u.parentNode}}i=i.return}Ac(function(){var k=s,M=Ms(a),U=[];e:{var z=Fc.get(e);if(z!==void 0){var T=el,te=e;switch(e){case"keypress":if($n(a)===0)break e;case"keydown":case"keyup":T=rh;break;case"focusin":te="focus",T=Hs;break;case"focusout":te="blur",T=Hs;break;case"beforeblur":case"afterblur":T=Hs;break;case"click":if(a.button===2)break e;case"auxclick":case"dblclick":case"mousedown":case"mousemove":case"mouseup":case"mouseout":case"mouseover":case"contextmenu":T=kc;break;case"drag":case"dragend":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"dragstart":case"drop":T=Jp;break;case"touchcancel":case"touchend":case"touchmove":case"touchstart":T=dh;break;case Kc:case Zc:case Jc:T=$p;break;case Wc:T=mh;break;case"scroll":case"scrollend":T=Kp;break;case"wheel":T=ph;break;case"copy":case"cut":case"paste":T=eh;break;case"gotpointercapture":case"lostpointercapture":case"pointercancel":case"pointerdown":case"pointermove":case"pointerout":case"pointerover":case"pointerup":T=Ec;break;case"toggle":case"beforetoggle":T=gh}var F=(t&4)!==0,ve=!F&&(e==="scroll"||e==="scrollend"),A=F?z!==null?z+"Capture":null:z;F=[];for(var b=k,S;b!==null;){var R=b;if(S=R.stateNode,R=R.tag,R!==5&&R!==26&&R!==27||S===null||A===null||(R=_i(b,A),R!=null&&F.push(wn(b,R,S))),ve)break;b=b.return}0<F.length&&(z=new T(z,te,null,a,M),U.push({event:z,listeners:F}))}}if((t&7)===0){e:{if(z=e==="mouseover"||e==="pointerover",T=e==="mouseout"||e==="pointerout",z&&a!==Ts&&(te=a.relatedTarget||a.fromElement)&&(Ia(te)||te[Va]))break e;if((T||z)&&(z=M.window===M?M:(z=M.ownerDocument)?z.defaultView||z.parentWindow:window,T?(te=a.relatedTarget||a.toElement,T=k,te=te?Ia(te):null,te!==null&&(ve=p(te),F=te.tag,te!==ve||F!==5&&F!==27&&F!==6)&&(te=null)):(T=null,te=k),T!==te)){if(F=kc,R="onMouseLeave",A="onMouseEnter",b="mouse",(e==="pointerout"||e==="pointerover")&&(F=Ec,R="onPointerLeave",A="onPointerEnter",b="pointer"),ve=T==null?z:Hi(T),S=te==null?z:Hi(te),z=new F(R,b+"leave",T,a,M),z.target=ve,z.relatedTarget=S,R=null,Ia(M)===k&&(F=new F(A,b+"enter",te,a,M),F.target=S,F.relatedTarget=ve,R=F),ve=R,T&&te)t:{for(F=T,A=te,b=0,S=F;S;S=ki(S))b++;for(S=0,R=A;R;R=ki(R))S++;for(;0<b-S;)F=ki(F),b--;for(;0<S-b;)A=ki(A),S--;for(;b--;){if(F===A||A!==null&&F===A.alternate)break t;F=ki(F),A=ki(A)}F=null}else F=null;T!==null&&xm(U,z,T,F,!1),te!==null&&ve!==null&&xm(U,ve,te,F,!0)}}e:{if(z=k?Hi(k):window,T=z.nodeName&&z.nodeName.toLowerCase(),T==="select"||T==="input"&&z.type==="file")var I=Bc;else if(Oc(z))if(Hc)I=kh;else{I=Nh;var le=Ah}else T=z.nodeName,!T||T.toLowerCase()!=="input"||z.type!=="checkbox"&&z.type!=="radio"?k&&Cs(k.elementType)&&(I=Bc):I=Sh;if(I&&(I=I(e,k))){Uc(U,I,a,M);break e}le&&le(e,z,k),e==="focusout"&&k&&z.type==="number"&&k.memoizedProps.value!=null&&Es(z,"number",z.value)}switch(le=k?Hi(k):window,e){case"focusin":(Oc(le)||le.contentEditable==="true")&&(ai=le,Qs=k,Ii=null);break;case"focusout":Ii=Qs=ai=null;break;case"mousedown":Xs=!0;break;case"contextmenu":case"mouseup":case"dragend":Xs=!1,Vc(U,a,M);break;case"selectionchange":if(Eh)break;case"keydown":case"keyup":Vc(U,a,M)}var K;if(Ls)e:{switch(e){case"compositionstart":var $="onCompositionStart";break e;case"compositionend":$="onCompositionEnd";break e;case"compositionupdate":$="onCompositionUpdate";break e}$=void 0}else ti?Dc(e,a)&&($="onCompositionEnd"):e==="keydown"&&a.keyCode===229&&($="onCompositionStart");$&&(Cc&&a.locale!=="ko"&&(ti||$!=="onCompositionStart"?$==="onCompositionEnd"&&ti&&(K=Nc()):(na=M,Os="value"in na?na.value:na.textContent,ti=!0)),le=Yl(k,$),0<le.length&&($=new zc($,e,null,a,M),U.push({event:$,listeners:le}),K?$.data=K:(K=Rc(a),K!==null&&($.data=K)))),(K=bh?yh(e,a):vh(e,a))&&($=Yl(k,"onBeforeInput"),0<$.length&&(le=new zc("onBeforeInput","beforeinput",null,a,M),U.push({event:le,listeners:$}),le.data=K)),d0(U,e,k,a,M)}hm(U,t)})}function wn(e,t,a){return{instance:e,listener:t,currentTarget:a}}function Yl(e,t){for(var a=t+"Capture",i=[];e!==null;){var l=e,s=l.stateNode;if(l=l.tag,l!==5&&l!==26&&l!==27||s===null||(l=_i(e,a),l!=null&&i.unshift(wn(e,l,s)),l=_i(e,t),l!=null&&i.push(wn(e,l,s))),e.tag===3)return i;e=e.return}return[]}function ki(e){if(e===null)return null;do e=e.return;while(e&&e.tag!==5&&e.tag!==27);return e||null}function xm(e,t,a,i,l){for(var s=t._reactName,o=[];a!==null&&a!==i;){var u=a,h=u.alternate,k=u.stateNode;if(u=u.tag,h!==null&&h===i)break;u!==5&&u!==26&&u!==27||k===null||(h=k,l?(k=_i(a,s),k!=null&&o.unshift(wn(a,k,h))):l||(k=_i(a,s),k!=null&&o.push(wn(a,k,h)))),a=a.return}o.length!==0&&e.push({event:t,listeners:o})}var p0=/\r\n?/g,h0=/\u0000|\uFFFD/g;function bm(e){return(typeof e=="string"?e:""+e).replace(p0,`
`).replace(h0,"")}function ym(e,t){return t=bm(t),bm(e)===t}function ql(){}function ye(e,t,a,i,l,s){switch(a){case"children":typeof i=="string"?t==="body"||t==="textarea"&&i===""||$a(e,i):(typeof i=="number"||typeof i=="bigint")&&t!=="body"&&$a(e,""+i);break;case"className":Kn(e,"class",i);break;case"tabIndex":Kn(e,"tabindex",i);break;case"dir":case"role":case"viewBox":case"width":case"height":Kn(e,a,i);break;case"style":wc(e,i,s);break;case"data":if(t!=="object"){Kn(e,"data",i);break}case"src":case"href":if(i===""&&(t!=="a"||a!=="href")){e.removeAttribute(a);break}if(i==null||typeof i=="function"||typeof i=="symbol"||typeof i=="boolean"){e.removeAttribute(a);break}i=Wn(""+i),e.setAttribute(a,i);break;case"action":case"formAction":if(typeof i=="function"){e.setAttribute(a,"javascript:throw new Error('A React form was unexpectedly submitted. If you called form.submit() manually, consider using form.requestSubmit() instead. If you\\'re trying to use event.stopPropagation() in a submit event handler, consider also calling event.preventDefault().')");break}else typeof s=="function"&&(a==="formAction"?(t!=="input"&&ye(e,t,"name",l.name,l,null),ye(e,t,"formEncType",l.formEncType,l,null),ye(e,t,"formMethod",l.formMethod,l,null),ye(e,t,"formTarget",l.formTarget,l,null)):(ye(e,t,"encType",l.encType,l,null),ye(e,t,"method",l.method,l,null),ye(e,t,"target",l.target,l,null)));if(i==null||typeof i=="symbol"||typeof i=="boolean"){e.removeAttribute(a);break}i=Wn(""+i),e.setAttribute(a,i);break;case"onClick":i!=null&&(e.onclick=ql);break;case"onScroll":i!=null&&re("scroll",e);break;case"onScrollEnd":i!=null&&re("scrollend",e);break;case"dangerouslySetInnerHTML":if(i!=null){if(typeof i!="object"||!("__html"in i))throw Error(c(61));if(a=i.__html,a!=null){if(l.children!=null)throw Error(c(60));e.innerHTML=a}}break;case"multiple":e.multiple=i&&typeof i!="function"&&typeof i!="symbol";break;case"muted":e.muted=i&&typeof i!="function"&&typeof i!="symbol";break;case"suppressContentEditableWarning":case"suppressHydrationWarning":case"defaultValue":case"defaultChecked":case"innerHTML":case"ref":break;case"autoFocus":break;case"xlinkHref":if(i==null||typeof i=="function"||typeof i=="boolean"||typeof i=="symbol"){e.removeAttribute("xlink:href");break}a=Wn(""+i),e.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",a);break;case"contentEditable":case"spellCheck":case"draggable":case"value":case"autoReverse":case"externalResourcesRequired":case"focusable":case"preserveAlpha":i!=null&&typeof i!="function"&&typeof i!="symbol"?e.setAttribute(a,""+i):e.removeAttribute(a);break;case"inert":case"allowFullScreen":case"async":case"autoPlay":case"controls":case"default":case"defer":case"disabled":case"disablePictureInPicture":case"disableRemotePlayback":case"formNoValidate":case"hidden":case"loop":case"noModule":case"noValidate":case"open":case"playsInline":case"readOnly":case"required":case"reversed":case"scoped":case"seamless":case"itemScope":i&&typeof i!="function"&&typeof i!="symbol"?e.setAttribute(a,""):e.removeAttribute(a);break;case"capture":case"download":i===!0?e.setAttribute(a,""):i!==!1&&i!=null&&typeof i!="function"&&typeof i!="symbol"?e.setAttribute(a,i):e.removeAttribute(a);break;case"cols":case"rows":case"size":case"span":i!=null&&typeof i!="function"&&typeof i!="symbol"&&!isNaN(i)&&1<=i?e.setAttribute(a,i):e.removeAttribute(a);break;case"rowSpan":case"start":i==null||typeof i=="function"||typeof i=="symbol"||isNaN(i)?e.removeAttribute(a):e.setAttribute(a,i);break;case"popover":re("beforetoggle",e),re("toggle",e),In(e,"popover",i);break;case"xlinkActuate":Bt(e,"http://www.w3.org/1999/xlink","xlink:actuate",i);break;case"xlinkArcrole":Bt(e,"http://www.w3.org/1999/xlink","xlink:arcrole",i);break;case"xlinkRole":Bt(e,"http://www.w3.org/1999/xlink","xlink:role",i);break;case"xlinkShow":Bt(e,"http://www.w3.org/1999/xlink","xlink:show",i);break;case"xlinkTitle":Bt(e,"http://www.w3.org/1999/xlink","xlink:title",i);break;case"xlinkType":Bt(e,"http://www.w3.org/1999/xlink","xlink:type",i);break;case"xmlBase":Bt(e,"http://www.w3.org/XML/1998/namespace","xml:base",i);break;case"xmlLang":Bt(e,"http://www.w3.org/XML/1998/namespace","xml:lang",i);break;case"xmlSpace":Bt(e,"http://www.w3.org/XML/1998/namespace","xml:space",i);break;case"is":In(e,"is",i);break;case"innerText":case"textContent":break;default:(!(2<a.length)||a[0]!=="o"&&a[0]!=="O"||a[1]!=="n"&&a[1]!=="N")&&(a=Vp.get(a)||a,In(e,a,i))}}function po(e,t,a,i,l,s){switch(a){case"style":wc(e,i,s);break;case"dangerouslySetInnerHTML":if(i!=null){if(typeof i!="object"||!("__html"in i))throw Error(c(61));if(a=i.__html,a!=null){if(l.children!=null)throw Error(c(60));e.innerHTML=a}}break;case"children":typeof i=="string"?$a(e,i):(typeof i=="number"||typeof i=="bigint")&&$a(e,""+i);break;case"onScroll":i!=null&&re("scroll",e);break;case"onScrollEnd":i!=null&&re("scrollend",e);break;case"onClick":i!=null&&(e.onclick=ql);break;case"suppressContentEditableWarning":case"suppressHydrationWarning":case"innerHTML":case"ref":break;case"innerText":case"textContent":break;default:if(!dc.hasOwnProperty(a))e:{if(a[0]==="o"&&a[1]==="n"&&(l=a.endsWith("Capture"),t=a.slice(2,l?a.length-7:void 0),s=e[Pe]||null,s=s!=null?s[a]:null,typeof s=="function"&&e.removeEventListener(t,s,l),typeof i=="function")){typeof s!="function"&&s!==null&&(a in e?e[a]=null:e.hasAttribute(a)&&e.removeAttribute(a)),e.addEventListener(t,i,l);break e}a in e?e[a]=i:i===!0?e.setAttribute(a,""):In(e,a,i)}}}function Xe(e,t,a){switch(t){case"div":case"span":case"svg":case"path":case"a":case"g":case"p":case"li":break;case"img":re("error",e),re("load",e);var i=!1,l=!1,s;for(s in a)if(a.hasOwnProperty(s)){var o=a[s];if(o!=null)switch(s){case"src":i=!0;break;case"srcSet":l=!0;break;case"children":case"dangerouslySetInnerHTML":throw Error(c(137,t));default:ye(e,t,s,o,a,null)}}l&&ye(e,t,"srcSet",a.srcSet,a,null),i&&ye(e,t,"src",a.src,a,null);return;case"input":re("invalid",e);var u=s=o=l=null,h=null,k=null;for(i in a)if(a.hasOwnProperty(i)){var M=a[i];if(M!=null)switch(i){case"name":l=M;break;case"type":o=M;break;case"checked":h=M;break;case"defaultChecked":k=M;break;case"value":s=M;break;case"defaultValue":u=M;break;case"children":case"dangerouslySetInnerHTML":if(M!=null)throw Error(c(137,t));break;default:ye(e,t,i,M,a,null)}}xc(e,s,u,h,k,o,l,!1),Zn(e);return;case"select":re("invalid",e),i=o=s=null;for(l in a)if(a.hasOwnProperty(l)&&(u=a[l],u!=null))switch(l){case"value":s=u;break;case"defaultValue":o=u;break;case"multiple":i=u;default:ye(e,t,l,u,a,null)}t=s,a=o,e.multiple=!!i,t!=null?Fa(e,!!i,t,!1):a!=null&&Fa(e,!!i,a,!0);return;case"textarea":re("invalid",e),s=l=i=null;for(o in a)if(a.hasOwnProperty(o)&&(u=a[o],u!=null))switch(o){case"value":i=u;break;case"defaultValue":l=u;break;case"children":s=u;break;case"dangerouslySetInnerHTML":if(u!=null)throw Error(c(91));break;default:ye(e,t,o,u,a,null)}yc(e,i,l,s),Zn(e);return;case"option":for(h in a)if(a.hasOwnProperty(h)&&(i=a[h],i!=null))switch(h){case"selected":e.selected=i&&typeof i!="function"&&typeof i!="symbol";break;default:ye(e,t,h,i,a,null)}return;case"dialog":re("beforetoggle",e),re("toggle",e),re("cancel",e),re("close",e);break;case"iframe":case"object":re("load",e);break;case"video":case"audio":for(i=0;i<vn.length;i++)re(vn[i],e);break;case"image":re("error",e),re("load",e);break;case"details":re("toggle",e);break;case"embed":case"source":case"link":re("error",e),re("load",e);case"area":case"base":case"br":case"col":case"hr":case"keygen":case"meta":case"param":case"track":case"wbr":case"menuitem":for(k in a)if(a.hasOwnProperty(k)&&(i=a[k],i!=null))switch(k){case"children":case"dangerouslySetInnerHTML":throw Error(c(137,t));default:ye(e,t,k,i,a,null)}return;default:if(Cs(t)){for(M in a)a.hasOwnProperty(M)&&(i=a[M],i!==void 0&&po(e,t,M,i,a,void 0));return}}for(u in a)a.hasOwnProperty(u)&&(i=a[u],i!=null&&ye(e,t,u,i,a,null))}function g0(e,t,a,i){switch(t){case"div":case"span":case"svg":case"path":case"a":case"g":case"p":case"li":break;case"input":var l=null,s=null,o=null,u=null,h=null,k=null,M=null;for(T in a){var U=a[T];if(a.hasOwnProperty(T)&&U!=null)switch(T){case"checked":break;case"value":break;case"defaultValue":h=U;default:i.hasOwnProperty(T)||ye(e,t,T,null,i,U)}}for(var z in i){var T=i[z];if(U=a[z],i.hasOwnProperty(z)&&(T!=null||U!=null))switch(z){case"type":s=T;break;case"name":l=T;break;case"checked":k=T;break;case"defaultChecked":M=T;break;case"value":o=T;break;case"defaultValue":u=T;break;case"children":case"dangerouslySetInnerHTML":if(T!=null)throw Error(c(137,t));break;default:T!==U&&ye(e,t,z,T,i,U)}}zs(e,o,u,h,k,M,s,l);return;case"select":T=o=u=z=null;for(s in a)if(h=a[s],a.hasOwnProperty(s)&&h!=null)switch(s){case"value":break;case"multiple":T=h;default:i.hasOwnProperty(s)||ye(e,t,s,null,i,h)}for(l in i)if(s=i[l],h=a[l],i.hasOwnProperty(l)&&(s!=null||h!=null))switch(l){case"value":z=s;break;case"defaultValue":u=s;break;case"multiple":o=s;default:s!==h&&ye(e,t,l,s,i,h)}t=u,a=o,i=T,z!=null?Fa(e,!!a,z,!1):!!i!=!!a&&(t!=null?Fa(e,!!a,t,!0):Fa(e,!!a,a?[]:"",!1));return;case"textarea":T=z=null;for(u in a)if(l=a[u],a.hasOwnProperty(u)&&l!=null&&!i.hasOwnProperty(u))switch(u){case"value":break;case"children":break;default:ye(e,t,u,null,i,l)}for(o in i)if(l=i[o],s=a[o],i.hasOwnProperty(o)&&(l!=null||s!=null))switch(o){case"value":z=l;break;case"defaultValue":T=l;break;case"children":break;case"dangerouslySetInnerHTML":if(l!=null)throw Error(c(91));break;default:l!==s&&ye(e,t,o,l,i,s)}bc(e,z,T);return;case"option":for(var te in a)if(z=a[te],a.hasOwnProperty(te)&&z!=null&&!i.hasOwnProperty(te))switch(te){case"selected":e.selected=!1;break;default:ye(e,t,te,null,i,z)}for(h in i)if(z=i[h],T=a[h],i.hasOwnProperty(h)&&z!==T&&(z!=null||T!=null))switch(h){case"selected":e.selected=z&&typeof z!="function"&&typeof z!="symbol";break;default:ye(e,t,h,z,i,T)}return;case"img":case"link":case"area":case"base":case"br":case"col":case"embed":case"hr":case"keygen":case"meta":case"param":case"source":case"track":case"wbr":case"menuitem":for(var F in a)z=a[F],a.hasOwnProperty(F)&&z!=null&&!i.hasOwnProperty(F)&&ye(e,t,F,null,i,z);for(k in i)if(z=i[k],T=a[k],i.hasOwnProperty(k)&&z!==T&&(z!=null||T!=null))switch(k){case"children":case"dangerouslySetInnerHTML":if(z!=null)throw Error(c(137,t));break;default:ye(e,t,k,z,i,T)}return;default:if(Cs(t)){for(var ve in a)z=a[ve],a.hasOwnProperty(ve)&&z!==void 0&&!i.hasOwnProperty(ve)&&po(e,t,ve,void 0,i,z);for(M in i)z=i[M],T=a[M],!i.hasOwnProperty(M)||z===T||z===void 0&&T===void 0||po(e,t,M,z,i,T);return}}for(var A in a)z=a[A],a.hasOwnProperty(A)&&z!=null&&!i.hasOwnProperty(A)&&ye(e,t,A,null,i,z);for(U in i)z=i[U],T=a[U],!i.hasOwnProperty(U)||z===T||z==null&&T==null||ye(e,t,U,z,i,T)}var ho=null,go=null;function Ql(e){return e.nodeType===9?e:e.ownerDocument}function vm(e){switch(e){case"http://www.w3.org/2000/svg":return 1;case"http://www.w3.org/1998/Math/MathML":return 2;default:return 0}}function wm(e,t){if(e===0)switch(t){case"svg":return 1;case"math":return 2;default:return 0}return e===1&&t==="foreignObject"?0:e}function xo(e,t){return e==="textarea"||e==="noscript"||typeof t.children=="string"||typeof t.children=="number"||typeof t.children=="bigint"||typeof t.dangerouslySetInnerHTML=="object"&&t.dangerouslySetInnerHTML!==null&&t.dangerouslySetInnerHTML.__html!=null}var bo=null;function x0(){var e=window.event;return e&&e.type==="popstate"?e===bo?!1:(bo=e,!0):(bo=null,!1)}var jm=typeof setTimeout=="function"?setTimeout:void 0,b0=typeof clearTimeout=="function"?clearTimeout:void 0,Am=typeof Promise=="function"?Promise:void 0,y0=typeof queueMicrotask=="function"?queueMicrotask:typeof Am<"u"?function(e){return Am.resolve(null).then(e).catch(v0)}:jm;function v0(e){setTimeout(function(){throw e})}function va(e){return e==="head"}function Nm(e,t){var a=t,i=0,l=0;do{var s=a.nextSibling;if(e.removeChild(a),s&&s.nodeType===8)if(a=s.data,a==="/$"){if(0<i&&8>i){a=i;var o=e.ownerDocument;if(a&1&&jn(o.documentElement),a&2&&jn(o.body),a&4)for(a=o.head,jn(a),o=a.firstChild;o;){var u=o.nextSibling,h=o.nodeName;o[Bi]||h==="SCRIPT"||h==="STYLE"||h==="LINK"&&o.rel.toLowerCase()==="stylesheet"||a.removeChild(o),o=u}}if(l===0){e.removeChild(s),Tn(t);return}l--}else a==="$"||a==="$?"||a==="$!"?l++:i=a.charCodeAt(0)-48;else i=0;a=s}while(a);Tn(t)}function yo(e){var t=e.firstChild;for(t&&t.nodeType===10&&(t=t.nextSibling);t;){var a=t;switch(t=t.nextSibling,a.nodeName){case"HTML":case"HEAD":case"BODY":yo(a),As(a);continue;case"SCRIPT":case"STYLE":continue;case"LINK":if(a.rel.toLowerCase()==="stylesheet")continue}e.removeChild(a)}}function w0(e,t,a,i){for(;e.nodeType===1;){var l=a;if(e.nodeName.toLowerCase()!==t.toLowerCase()){if(!i&&(e.nodeName!=="INPUT"||e.type!=="hidden"))break}else if(i){if(!e[Bi])switch(t){case"meta":if(!e.hasAttribute("itemprop"))break;return e;case"link":if(s=e.getAttribute("rel"),s==="stylesheet"&&e.hasAttribute("data-precedence"))break;if(s!==l.rel||e.getAttribute("href")!==(l.href==null||l.href===""?null:l.href)||e.getAttribute("crossorigin")!==(l.crossOrigin==null?null:l.crossOrigin)||e.getAttribute("title")!==(l.title==null?null:l.title))break;return e;case"style":if(e.hasAttribute("data-precedence"))break;return e;case"script":if(s=e.getAttribute("src"),(s!==(l.src==null?null:l.src)||e.getAttribute("type")!==(l.type==null?null:l.type)||e.getAttribute("crossorigin")!==(l.crossOrigin==null?null:l.crossOrigin))&&s&&e.hasAttribute("async")&&!e.hasAttribute("itemprop"))break;return e;default:return e}}else if(t==="input"&&e.type==="hidden"){var s=l.name==null?null:""+l.name;if(l.type==="hidden"&&e.getAttribute("name")===s)return e}else return e;if(e=kt(e.nextSibling),e===null)break}return null}function j0(e,t,a){if(t==="")return null;for(;e.nodeType!==3;)if((e.nodeType!==1||e.nodeName!=="INPUT"||e.type!=="hidden")&&!a||(e=kt(e.nextSibling),e===null))return null;return e}function vo(e){return e.data==="$!"||e.data==="$?"&&e.ownerDocument.readyState==="complete"}function A0(e,t){var a=e.ownerDocument;if(e.data!=="$?"||a.readyState==="complete")t();else{var i=function(){t(),a.removeEventListener("DOMContentLoaded",i)};a.addEventListener("DOMContentLoaded",i),e._reactRetry=i}}function kt(e){for(;e!=null;e=e.nextSibling){var t=e.nodeType;if(t===1||t===3)break;if(t===8){if(t=e.data,t==="$"||t==="$!"||t==="$?"||t==="F!"||t==="F")break;if(t==="/$")return null}}return e}var wo=null;function Sm(e){e=e.previousSibling;for(var t=0;e;){if(e.nodeType===8){var a=e.data;if(a==="$"||a==="$!"||a==="$?"){if(t===0)return e;t--}else a==="/$"&&t++}e=e.previousSibling}return null}function km(e,t,a){switch(t=Ql(a),e){case"html":if(e=t.documentElement,!e)throw Error(c(452));return e;case"head":if(e=t.head,!e)throw Error(c(453));return e;case"body":if(e=t.body,!e)throw Error(c(454));return e;default:throw Error(c(451))}}function jn(e){for(var t=e.attributes;t.length;)e.removeAttributeNode(t[0]);As(e)}var jt=new Map,zm=new Set;function Xl(e){return typeof e.getRootNode=="function"?e.getRootNode():e.nodeType===9?e:e.ownerDocument}var Wt=Q.d;Q.d={f:N0,r:S0,D:k0,C:z0,L:E0,m:C0,X:M0,S:T0,M:D0};function N0(){var e=Wt.f(),t=Ul();return e||t}function S0(e){var t=Ka(e);t!==null&&t.tag===5&&t.type==="form"?Kd(t):Wt.r(e)}var zi=typeof document>"u"?null:document;function Em(e,t,a){var i=zi;if(i&&typeof t=="string"&&t){var l=ht(t);l='link[rel="'+e+'"][href="'+l+'"]',typeof a=="string"&&(l+='[crossorigin="'+a+'"]'),zm.has(l)||(zm.add(l),e={rel:e,crossOrigin:a,href:t},i.querySelector(l)===null&&(t=i.createElement("link"),Xe(t,"link",e),_e(t),i.head.appendChild(t)))}}function k0(e){Wt.D(e),Em("dns-prefetch",e,null)}function z0(e,t){Wt.C(e,t),Em("preconnect",e,t)}function E0(e,t,a){Wt.L(e,t,a);var i=zi;if(i&&e&&t){var l='link[rel="preload"][as="'+ht(t)+'"]';t==="image"&&a&&a.imageSrcSet?(l+='[imagesrcset="'+ht(a.imageSrcSet)+'"]',typeof a.imageSizes=="string"&&(l+='[imagesizes="'+ht(a.imageSizes)+'"]')):l+='[href="'+ht(e)+'"]';var s=l;switch(t){case"style":s=Ei(e);break;case"script":s=Ci(e)}jt.has(s)||(e=v({rel:"preload",href:t==="image"&&a&&a.imageSrcSet?void 0:e,as:t},a),jt.set(s,e),i.querySelector(l)!==null||t==="style"&&i.querySelector(An(s))||t==="script"&&i.querySelector(Nn(s))||(t=i.createElement("link"),Xe(t,"link",e),_e(t),i.head.appendChild(t)))}}function C0(e,t){Wt.m(e,t);var a=zi;if(a&&e){var i=t&&typeof t.as=="string"?t.as:"script",l='link[rel="modulepreload"][as="'+ht(i)+'"][href="'+ht(e)+'"]',s=l;switch(i){case"audioworklet":case"paintworklet":case"serviceworker":case"sharedworker":case"worker":case"script":s=Ci(e)}if(!jt.has(s)&&(e=v({rel:"modulepreload",href:e},t),jt.set(s,e),a.querySelector(l)===null)){switch(i){case"audioworklet":case"paintworklet":case"serviceworker":case"sharedworker":case"worker":case"script":if(a.querySelector(Nn(s)))return}i=a.createElement("link"),Xe(i,"link",e),_e(i),a.head.appendChild(i)}}}function T0(e,t,a){Wt.S(e,t,a);var i=zi;if(i&&e){var l=Za(i).hoistableStyles,s=Ei(e);t=t||"default";var o=l.get(s);if(!o){var u={loading:0,preload:null};if(o=i.querySelector(An(s)))u.loading=5;else{e=v({rel:"stylesheet",href:e,"data-precedence":t},a),(a=jt.get(s))&&jo(e,a);var h=o=i.createElement("link");_e(h),Xe(h,"link",e),h._p=new Promise(function(k,M){h.onload=k,h.onerror=M}),h.addEventListener("load",function(){u.loading|=1}),h.addEventListener("error",function(){u.loading|=2}),u.loading|=4,Vl(o,t,i)}o={type:"stylesheet",instance:o,count:1,state:u},l.set(s,o)}}}function M0(e,t){Wt.X(e,t);var a=zi;if(a&&e){var i=Za(a).hoistableScripts,l=Ci(e),s=i.get(l);s||(s=a.querySelector(Nn(l)),s||(e=v({src:e,async:!0},t),(t=jt.get(l))&&Ao(e,t),s=a.createElement("script"),_e(s),Xe(s,"link",e),a.head.appendChild(s)),s={type:"script",instance:s,count:1,state:null},i.set(l,s))}}function D0(e,t){Wt.M(e,t);var a=zi;if(a&&e){var i=Za(a).hoistableScripts,l=Ci(e),s=i.get(l);s||(s=a.querySelector(Nn(l)),s||(e=v({src:e,async:!0,type:"module"},t),(t=jt.get(l))&&Ao(e,t),s=a.createElement("script"),_e(s),Xe(s,"link",e),a.head.appendChild(s)),s={type:"script",instance:s,count:1,state:null},i.set(l,s))}}function Cm(e,t,a,i){var l=(l=ae.current)?Xl(l):null;if(!l)throw Error(c(446));switch(e){case"meta":case"title":return null;case"style":return typeof a.precedence=="string"&&typeof a.href=="string"?(t=Ei(a.href),a=Za(l).hoistableStyles,i=a.get(t),i||(i={type:"style",instance:null,count:0,state:null},a.set(t,i)),i):{type:"void",instance:null,count:0,state:null};case"link":if(a.rel==="stylesheet"&&typeof a.href=="string"&&typeof a.precedence=="string"){e=Ei(a.href);var s=Za(l).hoistableStyles,o=s.get(e);if(o||(l=l.ownerDocument||l,o={type:"stylesheet",instance:null,count:0,state:{loading:0,preload:null}},s.set(e,o),(s=l.querySelector(An(e)))&&!s._p&&(o.instance=s,o.state.loading=5),jt.has(e)||(a={rel:"preload",as:"style",href:a.href,crossOrigin:a.crossOrigin,integrity:a.integrity,media:a.media,hrefLang:a.hrefLang,referrerPolicy:a.referrerPolicy},jt.set(e,a),s||R0(l,e,a,o.state))),t&&i===null)throw Error(c(528,""));return o}if(t&&i!==null)throw Error(c(529,""));return null;case"script":return t=a.async,a=a.src,typeof a=="string"&&t&&typeof t!="function"&&typeof t!="symbol"?(t=Ci(a),a=Za(l).hoistableScripts,i=a.get(t),i||(i={type:"script",instance:null,count:0,state:null},a.set(t,i)),i):{type:"void",instance:null,count:0,state:null};default:throw Error(c(444,e))}}function Ei(e){return'href="'+ht(e)+'"'}function An(e){return'link[rel="stylesheet"]['+e+"]"}function Tm(e){return v({},e,{"data-precedence":e.precedence,precedence:null})}function R0(e,t,a,i){e.querySelector('link[rel="preload"][as="style"]['+t+"]")?i.loading=1:(t=e.createElement("link"),i.preload=t,t.addEventListener("load",function(){return i.loading|=1}),t.addEventListener("error",function(){return i.loading|=2}),Xe(t,"link",a),_e(t),e.head.appendChild(t))}function Ci(e){return'[src="'+ht(e)+'"]'}function Nn(e){return"script[async]"+e}function Mm(e,t,a){if(t.count++,t.instance===null)switch(t.type){case"style":var i=e.querySelector('style[data-href~="'+ht(a.href)+'"]');if(i)return t.instance=i,_e(i),i;var l=v({},a,{"data-href":a.href,"data-precedence":a.precedence,href:null,precedence:null});return i=(e.ownerDocument||e).createElement("style"),_e(i),Xe(i,"style",l),Vl(i,a.precedence,e),t.instance=i;case"stylesheet":l=Ei(a.href);var s=e.querySelector(An(l));if(s)return t.state.loading|=4,t.instance=s,_e(s),s;i=Tm(a),(l=jt.get(l))&&jo(i,l),s=(e.ownerDocument||e).createElement("link"),_e(s);var o=s;return o._p=new Promise(function(u,h){o.onload=u,o.onerror=h}),Xe(s,"link",i),t.state.loading|=4,Vl(s,a.precedence,e),t.instance=s;case"script":return s=Ci(a.src),(l=e.querySelector(Nn(s)))?(t.instance=l,_e(l),l):(i=a,(l=jt.get(s))&&(i=v({},a),Ao(i,l)),e=e.ownerDocument||e,l=e.createElement("script"),_e(l),Xe(l,"link",i),e.head.appendChild(l),t.instance=l);case"void":return null;default:throw Error(c(443,t.type))}else t.type==="stylesheet"&&(t.state.loading&4)===0&&(i=t.instance,t.state.loading|=4,Vl(i,a.precedence,e));return t.instance}function Vl(e,t,a){for(var i=a.querySelectorAll('link[rel="stylesheet"][data-precedence],style[data-precedence]'),l=i.length?i[i.length-1]:null,s=l,o=0;o<i.length;o++){var u=i[o];if(u.dataset.precedence===t)s=u;else if(s!==l)break}s?s.parentNode.insertBefore(e,s.nextSibling):(t=a.nodeType===9?a.head:a,t.insertBefore(e,t.firstChild))}function jo(e,t){e.crossOrigin==null&&(e.crossOrigin=t.crossOrigin),e.referrerPolicy==null&&(e.referrerPolicy=t.referrerPolicy),e.title==null&&(e.title=t.title)}function Ao(e,t){e.crossOrigin==null&&(e.crossOrigin=t.crossOrigin),e.referrerPolicy==null&&(e.referrerPolicy=t.referrerPolicy),e.integrity==null&&(e.integrity=t.integrity)}var Il=null;function Dm(e,t,a){if(Il===null){var i=new Map,l=Il=new Map;l.set(a,i)}else l=Il,i=l.get(a),i||(i=new Map,l.set(a,i));if(i.has(e))return i;for(i.set(e,null),a=a.getElementsByTagName(e),l=0;l<a.length;l++){var s=a[l];if(!(s[Bi]||s[Ke]||e==="link"&&s.getAttribute("rel")==="stylesheet")&&s.namespaceURI!=="http://www.w3.org/2000/svg"){var o=s.getAttribute(t)||"";o=e+o;var u=i.get(o);u?u.push(s):i.set(o,[s])}}return i}function Rm(e,t,a){e=e.ownerDocument||e,e.head.insertBefore(a,t==="title"?e.querySelector("head > title"):null)}function O0(e,t,a){if(a===1||t.itemProp!=null)return!1;switch(e){case"meta":case"title":return!0;case"style":if(typeof t.precedence!="string"||typeof t.href!="string"||t.href==="")break;return!0;case"link":if(typeof t.rel!="string"||typeof t.href!="string"||t.href===""||t.onLoad||t.onError)break;switch(t.rel){case"stylesheet":return e=t.disabled,typeof t.precedence=="string"&&e==null;default:return!0}case"script":if(t.async&&typeof t.async!="function"&&typeof t.async!="symbol"&&!t.onLoad&&!t.onError&&t.src&&typeof t.src=="string")return!0}return!1}function Om(e){return!(e.type==="stylesheet"&&(e.state.loading&3)===0)}var Sn=null;function U0(){}function B0(e,t,a){if(Sn===null)throw Error(c(475));var i=Sn;if(t.type==="stylesheet"&&(typeof a.media!="string"||matchMedia(a.media).matches!==!1)&&(t.state.loading&4)===0){if(t.instance===null){var l=Ei(a.href),s=e.querySelector(An(l));if(s){e=s._p,e!==null&&typeof e=="object"&&typeof e.then=="function"&&(i.count++,i=Kl.bind(i),e.then(i,i)),t.state.loading|=4,t.instance=s,_e(s);return}s=e.ownerDocument||e,a=Tm(a),(l=jt.get(l))&&jo(a,l),s=s.createElement("link"),_e(s);var o=s;o._p=new Promise(function(u,h){o.onload=u,o.onerror=h}),Xe(s,"link",a),t.instance=s}i.stylesheets===null&&(i.stylesheets=new Map),i.stylesheets.set(t,e),(e=t.state.preload)&&(t.state.loading&3)===0&&(i.count++,t=Kl.bind(i),e.addEventListener("load",t),e.addEventListener("error",t))}}function H0(){if(Sn===null)throw Error(c(475));var e=Sn;return e.stylesheets&&e.count===0&&No(e,e.stylesheets),0<e.count?function(t){var a=setTimeout(function(){if(e.stylesheets&&No(e,e.stylesheets),e.unsuspend){var i=e.unsuspend;e.unsuspend=null,i()}},6e4);return e.unsuspend=t,function(){e.unsuspend=null,clearTimeout(a)}}:null}function Kl(){if(this.count--,this.count===0){if(this.stylesheets)No(this,this.stylesheets);else if(this.unsuspend){var e=this.unsuspend;this.unsuspend=null,e()}}}var Zl=null;function No(e,t){e.stylesheets=null,e.unsuspend!==null&&(e.count++,Zl=new Map,t.forEach(_0,e),Zl=null,Kl.call(e))}function _0(e,t){if(!(t.state.loading&4)){var a=Zl.get(e);if(a)var i=a.get(null);else{a=new Map,Zl.set(e,a);for(var l=e.querySelectorAll("link[data-precedence],style[data-precedence]"),s=0;s<l.length;s++){var o=l[s];(o.nodeName==="LINK"||o.getAttribute("media")!=="not all")&&(a.set(o.dataset.precedence,o),i=o)}i&&a.set(null,i)}l=t.instance,o=l.getAttribute("data-precedence"),s=a.get(o)||i,s===i&&a.set(null,l),a.set(o,l),this.count++,i=Kl.bind(this),l.addEventListener("load",i),l.addEventListener("error",i),s?s.parentNode.insertBefore(l,s.nextSibling):(e=e.nodeType===9?e.head:e,e.insertBefore(l,e.firstChild)),t.state.loading|=4}}var kn={$$typeof:J,Provider:null,Consumer:null,_currentValue:ee,_currentValue2:ee,_threadCount:0};function L0(e,t,a,i,l,s,o,u){this.tag=1,this.containerInfo=e,this.pingCache=this.current=this.pendingChildren=null,this.timeoutHandle=-1,this.callbackNode=this.next=this.pendingContext=this.context=this.cancelPendingCommit=null,this.callbackPriority=0,this.expirationTimes=ys(-1),this.entangledLanes=this.shellSuspendCounter=this.errorRecoveryDisabledLanes=this.expiredLanes=this.warmLanes=this.pingedLanes=this.suspendedLanes=this.pendingLanes=0,this.entanglements=ys(0),this.hiddenUpdates=ys(null),this.identifierPrefix=i,this.onUncaughtError=l,this.onCaughtError=s,this.onRecoverableError=o,this.pooledCache=null,this.pooledCacheLanes=0,this.formState=u,this.incompleteTransitions=new Map}function Um(e,t,a,i,l,s,o,u,h,k,M,U){return e=new L0(e,t,a,o,u,h,k,U),t=1,s===!0&&(t|=24),s=ot(3,null,null,t),e.current=s,s.stateNode=e,t=nr(),t.refCount++,e.pooledCache=t,t.refCount++,s.memoizedState={element:i,isDehydrated:a,cache:t},or(s),e}function Bm(e){return e?(e=si,e):si}function Hm(e,t,a,i,l,s){l=Bm(l),i.context===null?i.context=l:i.pendingContext=l,i=ra(t),i.payload={element:a},s=s===void 0?null:s,s!==null&&(i.callback=s),a=oa(e,i,t),a!==null&&(ft(a,e,t),tn(a,e,t))}function _m(e,t){if(e=e.memoizedState,e!==null&&e.dehydrated!==null){var a=e.retryLane;e.retryLane=a!==0&&a<t?a:t}}function So(e,t){_m(e,t),(e=e.alternate)&&_m(e,t)}function Lm(e){if(e.tag===13){var t=li(e,67108864);t!==null&&ft(t,e,67108864),So(e,67108864)}}var Jl=!0;function G0(e,t,a,i){var l=D.T;D.T=null;var s=Q.p;try{Q.p=2,ko(e,t,a,i)}finally{Q.p=s,D.T=l}}function Y0(e,t,a,i){var l=D.T;D.T=null;var s=Q.p;try{Q.p=8,ko(e,t,a,i)}finally{Q.p=s,D.T=l}}function ko(e,t,a,i){if(Jl){var l=zo(i);if(l===null)fo(e,t,i,Wl,a),Ym(e,i);else if(Q0(l,e,t,a,i))i.stopPropagation();else if(Ym(e,i),t&4&&-1<q0.indexOf(e)){for(;l!==null;){var s=Ka(l);if(s!==null)switch(s.tag){case 3:if(s=s.stateNode,s.current.memoizedState.isDehydrated){var o=ka(s.pendingLanes);if(o!==0){var u=s;for(u.pendingLanes|=2,u.entangledLanes|=2;o;){var h=1<<31-st(o);u.entanglements[1]|=h,o&=~h}Rt(s),(he&6)===0&&(Rl=Et()+500,yn(0))}}break;case 13:u=li(s,2),u!==null&&ft(u,s,2),Ul(),So(s,2)}if(s=zo(i),s===null&&fo(e,t,i,Wl,a),s===l)break;l=s}l!==null&&i.stopPropagation()}else fo(e,t,i,null,a)}}function zo(e){return e=Ms(e),Eo(e)}var Wl=null;function Eo(e){if(Wl=null,e=Ia(e),e!==null){var t=p(e);if(t===null)e=null;else{var a=t.tag;if(a===13){if(e=y(t),e!==null)return e;e=null}else if(a===3){if(t.stateNode.current.memoizedState.isDehydrated)return t.tag===3?t.stateNode.containerInfo:null;e=null}else t!==e&&(e=null)}}return Wl=e,null}function Gm(e){switch(e){case"beforetoggle":case"cancel":case"click":case"close":case"contextmenu":case"copy":case"cut":case"auxclick":case"dblclick":case"dragend":case"dragstart":case"drop":case"focusin":case"focusout":case"input":case"invalid":case"keydown":case"keypress":case"keyup":case"mousedown":case"mouseup":case"paste":case"pause":case"play":case"pointercancel":case"pointerdown":case"pointerup":case"ratechange":case"reset":case"resize":case"seeked":case"submit":case"toggle":case"touchcancel":case"touchend":case"touchstart":case"volumechange":case"change":case"selectionchange":case"textInput":case"compositionstart":case"compositionend":case"compositionupdate":case"beforeblur":case"afterblur":case"beforeinput":case"blur":case"fullscreenchange":case"focus":case"hashchange":case"popstate":case"select":case"selectstart":return 2;case"drag":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"mousemove":case"mouseout":case"mouseover":case"pointermove":case"pointerout":case"pointerover":case"scroll":case"touchmove":case"wheel":case"mouseenter":case"mouseleave":case"pointerenter":case"pointerleave":return 8;case"message":switch(zp()){case ec:return 2;case tc:return 8;case qn:case Ep:return 32;case ac:return 268435456;default:return 32}default:return 32}}var Co=!1,wa=null,ja=null,Aa=null,zn=new Map,En=new Map,Na=[],q0="mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset".split(" ");function Ym(e,t){switch(e){case"focusin":case"focusout":wa=null;break;case"dragenter":case"dragleave":ja=null;break;case"mouseover":case"mouseout":Aa=null;break;case"pointerover":case"pointerout":zn.delete(t.pointerId);break;case"gotpointercapture":case"lostpointercapture":En.delete(t.pointerId)}}function Cn(e,t,a,i,l,s){return e===null||e.nativeEvent!==s?(e={blockedOn:t,domEventName:a,eventSystemFlags:i,nativeEvent:s,targetContainers:[l]},t!==null&&(t=Ka(t),t!==null&&Lm(t)),e):(e.eventSystemFlags|=i,t=e.targetContainers,l!==null&&t.indexOf(l)===-1&&t.push(l),e)}function Q0(e,t,a,i,l){switch(t){case"focusin":return wa=Cn(wa,e,t,a,i,l),!0;case"dragenter":return ja=Cn(ja,e,t,a,i,l),!0;case"mouseover":return Aa=Cn(Aa,e,t,a,i,l),!0;case"pointerover":var s=l.pointerId;return zn.set(s,Cn(zn.get(s)||null,e,t,a,i,l)),!0;case"gotpointercapture":return s=l.pointerId,En.set(s,Cn(En.get(s)||null,e,t,a,i,l)),!0}return!1}function qm(e){var t=Ia(e.target);if(t!==null){var a=p(t);if(a!==null){if(t=a.tag,t===13){if(t=y(a),t!==null){e.blockedOn=t,Bp(e.priority,function(){if(a.tag===13){var i=mt();i=vs(i);var l=li(a,i);l!==null&&ft(l,a,i),So(a,i)}});return}}else if(t===3&&a.stateNode.current.memoizedState.isDehydrated){e.blockedOn=a.tag===3?a.stateNode.containerInfo:null;return}}}e.blockedOn=null}function Fl(e){if(e.blockedOn!==null)return!1;for(var t=e.targetContainers;0<t.length;){var a=zo(e.nativeEvent);if(a===null){a=e.nativeEvent;var i=new a.constructor(a.type,a);Ts=i,a.target.dispatchEvent(i),Ts=null}else return t=Ka(a),t!==null&&Lm(t),e.blockedOn=a,!1;t.shift()}return!0}function Qm(e,t,a){Fl(e)&&a.delete(t)}function X0(){Co=!1,wa!==null&&Fl(wa)&&(wa=null),ja!==null&&Fl(ja)&&(ja=null),Aa!==null&&Fl(Aa)&&(Aa=null),zn.forEach(Qm),En.forEach(Qm)}function $l(e,t){e.blockedOn===t&&(e.blockedOn=null,Co||(Co=!0,r.unstable_scheduleCallback(r.unstable_NormalPriority,X0)))}var Pl=null;function Xm(e){Pl!==e&&(Pl=e,r.unstable_scheduleCallback(r.unstable_NormalPriority,function(){Pl===e&&(Pl=null);for(var t=0;t<e.length;t+=3){var a=e[t],i=e[t+1],l=e[t+2];if(typeof i!="function"){if(Eo(i||a)===null)continue;break}var s=Ka(a);s!==null&&(e.splice(t,3),t-=3,zr(s,{pending:!0,data:l,method:a.method,action:i},i,l))}}))}function Tn(e){function t(h){return $l(h,e)}wa!==null&&$l(wa,e),ja!==null&&$l(ja,e),Aa!==null&&$l(Aa,e),zn.forEach(t),En.forEach(t);for(var a=0;a<Na.length;a++){var i=Na[a];i.blockedOn===e&&(i.blockedOn=null)}for(;0<Na.length&&(a=Na[0],a.blockedOn===null);)qm(a),a.blockedOn===null&&Na.shift();if(a=(e.ownerDocument||e).$$reactFormReplay,a!=null)for(i=0;i<a.length;i+=3){var l=a[i],s=a[i+1],o=l[Pe]||null;if(typeof s=="function")o||Xm(a);else if(o){var u=null;if(s&&s.hasAttribute("formAction")){if(l=s,o=s[Pe]||null)u=o.formAction;else if(Eo(l)!==null)continue}else u=o.action;typeof u=="function"?a[i+1]=u:(a.splice(i,3),i-=3),Xm(a)}}}function To(e){this._internalRoot=e}es.prototype.render=To.prototype.render=function(e){var t=this._internalRoot;if(t===null)throw Error(c(409));var a=t.current,i=mt();Hm(a,i,e,t,null,null)},es.prototype.unmount=To.prototype.unmount=function(){var e=this._internalRoot;if(e!==null){this._internalRoot=null;var t=e.containerInfo;Hm(e.current,2,null,e,null,null),Ul(),t[Va]=null}};function es(e){this._internalRoot=e}es.prototype.unstable_scheduleHydration=function(e){if(e){var t=rc();e={blockedOn:null,target:e,priority:t};for(var a=0;a<Na.length&&t!==0&&t<Na[a].priority;a++);Na.splice(a,0,e),a===0&&qm(e)}};var Vm=m.version;if(Vm!=="19.1.0")throw Error(c(527,Vm,"19.1.0"));Q.findDOMNode=function(e){var t=e._reactInternals;if(t===void 0)throw typeof e.render=="function"?Error(c(188)):(e=Object.keys(e).join(","),Error(c(268,e)));return e=w(t),e=e!==null?g(e):null,e=e===null?null:e.stateNode,e};var V0={bundleType:0,version:"19.1.0",rendererPackageName:"react-dom",currentDispatcherRef:D,reconcilerVersion:"19.1.0"};if(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__<"u"){var ts=__REACT_DEVTOOLS_GLOBAL_HOOK__;if(!ts.isDisabled&&ts.supportsFiber)try{Ri=ts.inject(V0),lt=ts}catch{}}return Dn.createRoot=function(e,t){if(!f(e))throw Error(c(299));var a=!1,i="",l=ru,s=ou,o=cu,u=null;return t!=null&&(t.unstable_strictMode===!0&&(a=!0),t.identifierPrefix!==void 0&&(i=t.identifierPrefix),t.onUncaughtError!==void 0&&(l=t.onUncaughtError),t.onCaughtError!==void 0&&(s=t.onCaughtError),t.onRecoverableError!==void 0&&(o=t.onRecoverableError),t.unstable_transitionCallbacks!==void 0&&(u=t.unstable_transitionCallbacks)),t=Um(e,1,!1,null,null,a,i,l,s,o,u,null),e[Va]=t.current,mo(e),new To(t)},Dn.hydrateRoot=function(e,t,a){if(!f(e))throw Error(c(299));var i=!1,l="",s=ru,o=ou,u=cu,h=null,k=null;return a!=null&&(a.unstable_strictMode===!0&&(i=!0),a.identifierPrefix!==void 0&&(l=a.identifierPrefix),a.onUncaughtError!==void 0&&(s=a.onUncaughtError),a.onCaughtError!==void 0&&(o=a.onCaughtError),a.onRecoverableError!==void 0&&(u=a.onRecoverableError),a.unstable_transitionCallbacks!==void 0&&(h=a.unstable_transitionCallbacks),a.formState!==void 0&&(k=a.formState)),t=Um(e,1,!0,t,a??null,i,l,s,o,u,h,k),t.context=Bm(null),a=t.current,i=mt(),i=vs(i),l=ra(i),l.callback=null,oa(a,l,i),a=i,t.current.lanes=a,Ui(t,a),Rt(t),e[Va]=t.current,mo(e),new es(t)},Dn.version="19.1.0",Dn}var tf;function ig(){if(tf)return Ro.exports;tf=1;function r(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(r)}catch(m){console.error(m)}}return r(),Ro.exports=ag(),Ro.exports}var ng=ig();/**
 * react-router v7.9.1
 *
 ...
 *
 * @license MIT
 */var af="popstate";function lg(r={}){function m(c,f){let{pathname:p,search:y,hash:C}=c.location;return Qo("",{pathname:p,search:y,hash:C},f.state&&f.state.usr||null,f.state&&f.state.key||"default")}function d(c,f){return typeof f=="string"?f:On(f)}return rg(m,d,null,r)}function Ee(r,m){if(r===!1||r===null||typeof r>"u")throw new Error(m)}function Ot(r,m){if(!r){typeof console<"u"&&console.warn(m);try{throw new Error(m)}catch{}}}function sg(){return Math.random().toString(36).substring(2,10)}function nf(r,m){return{usr:r.state,key:r.key,idx:m}}function Qo(r,m,d=null,c){return{pathname:typeof r=="string"?r:r.pathname,search:"",hash:"",...typeof m=="string"?Mi(m):m,state:d,key:m&&m.key||c||sg()}}function On({pathname:r="/",search:m="",hash:d=""}){return m&&m!=="?"&&(r+=m.charAt(0)==="?"?m:"?"+m),d&&d!=="#"&&(r+=d.charAt(0)==="#"?d:"#"+d),r}function Mi(r){let m={};if(r){let d=r.indexOf("#");d>=0&&(m.hash=r.substring(d),r=r.substring(0,d));let c=r.indexOf("?");c>=0&&(m.search=r.substring(c),r=r.substring(0,c)),r&&(m.pathname=r)}return m}function rg(r,m,d,c={}){let{window:f=document.defaultView,v5Compat:p=!1}=c,y=f.history,C="POP",w=null,g=v();g==null&&(g=0,y.replaceState({...y.state,idx:g},""));function v(){return(y.state||{idx:null}).idx}function j(){C="POP";let G=v(),B=G==null?null:G-g;g=G,w&&w({action:C,location:Y.location,delta:B})}function E(G,B){C="PUSH";let L=Qo(Y.location,G,B);g=v()+1;let J=nf(L,g),me=Y.createHref(L);try{y.pushState(J,"",me)}catch(Z){if(Z instanceof DOMException&&Z.name==="DataCloneError")throw Z;f.location.assign(me)}p&&w&&w({action:C,location:Y.location,delta:1})}function O(G,B){C="REPLACE";let L=Qo(Y.location,G,B);g=v();let J=nf(L,g),me=Y.createHref(L);y.replaceState(J,"",me),p&&w&&w({action:C,location:Y.location,delta:0})}function _(G){return og(G)}let Y={get action(){return C},get location(){return r(f,y)},listen(G){if(w)throw new Error("A history only accepts one active listener");return f.addEventListener(af,j),w=G,()=>{f.removeEventListener(af,j),w=null}},createHref(G){return m(f,G)},createURL:_,encodeLocation(G){let B=_(G);return{pathname:B.pathname,search:B.search,hash:B.hash}},push:E,replace:O,go(G){return y.go(G)}};return Y}function og(r,m=!1){let d="http://localhost";typeof window<"u"&&(d=window.location.origin!=="null"?window.location.origin:window.location.href),Ee(d,"No window.location.(origin|href) available to create URL");let c=typeof r=="string"?r:On(r);return c=c.replace(/ $/,"%20"),!m&&c.startsWith("//")&&(c=d+c),new URL(c,d)}function qf(r,m,d="/"){return cg(r,m,d,!1)}function cg(r,m,d,c){let f=typeof m=="string"?Mi(m):m,p=$t(f.pathname||"/",d);if(p==null)return null;let y=Qf(r);dg(y);let C=null;for(let w=0;C==null&&w<y.length;++w){let g=wg(p);C=yg(y[w],g,c)}return C}function Qf(r,m=[],d=[],c="",f=!1){let p=(y,C,w=f,g)=>{let v={relativePath:g===void 0?y.path||"":g,caseSensitive:y.caseSensitive===!0,childrenIndex:C,route:y};if(v.relativePath.startsWith("/")){if(!v.relativePath.startsWith(c)&&w)return;Ee(v.relativePath.startsWith(c),`Absolute route path "${v.relativePath}" nested under path "${c}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),v.relativePath=v.relativePath.slice(c.length)}let j=Ft([c,v.relativePath]),E=d.concat(v);y.children&&y.children.length>0&&(Ee(y.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${j}".`),Qf(y.children,m,E,j,w)),!(y.path==null&&!y.index)&&m.push({path:j,score:xg(j,y.index),routesMeta:E})};return r.forEach((y,C)=>{if(y.path===""||!y.path?.includes("?"))p(y,C);else for(let w of Xf(y.path))p(y,C,!0,w)}),m}function Xf(r){let m=r.split("/");if(m.length===0)return[];let[d,...c]=m,f=d.endsWith("?"),p=d.replace(/\?$/,"");if(c.length===0)return f?[p,""]:[p];let y=Xf(c.join("/")),C=[];return C.push(...y.map(w=>w===""?p:[p,w].join("/"))),f&&C.push(...y),C.map(w=>r.startsWith("/")&&w===""?"/":w)}function dg(r){r.sort((m,d)=>m.score!==d.score?d.score-m.score:bg(m.routesMeta.map(c=>c.childrenIndex),d.routesMeta.map(c=>c.childrenIndex)))}var ug=/^:[\w-]+$/,mg=3,fg=2,pg=1,hg=10,gg=-2,lf=r=>r==="*";function xg(r,m){let d=r.split("/"),c=d.length;return d.some(lf)&&(c+=gg),m&&(c+=fg),d.filter(f=>!lf(f)).reduce((f,p)=>f+(ug.test(p)?mg:p===""?pg:hg),c)}function bg(r,m){return r.length===m.length&&r.slice(0,-1).every((c,f)=>c===m[f])?r[r.length-1]-m[m.length-1]:0}function yg(r,m,d=!1){let{routesMeta:c}=r,f={},p="/",y=[];for(let C=0;C<c.length;++C){let w=c[C],g=C===c.length-1,v=p==="/"?m:m.slice(p.length)||"/",j=os({path:w.relativePath,caseSensitive:w.caseSensitive,end:g},v),E=w.route;if(!j&&g&&d&&!c[c.length-1].route.index&&(j=os({path:w.relativePath,caseSensitive:w.caseSensitive,end:!1},v)),!j)return null;Object.assign(f,j.params),y.push({params:f,pathname:Ft([p,j.pathname]),pathnameBase:Sg(Ft([p,j.pathnameBase])),route:E}),j.pathnameBase!=="/"&&(p=Ft([p,j.pathnameBase]))}return y}function os(r,m){typeof r=="string"&&(r={path:r,caseSensitive:!1,end:!0});let[d,c]=vg(r.path,r.caseSensitive,r.end),f=m.match(d);if(!f)return null;let p=f[0],y=p.replace(/(.)\/+$/,"$1"),C=f.slice(1);return{params:c.reduce((g,{paramName:v,isOptional:j},E)=>{if(v==="*"){let _=C[E]||"";y=p.slice(0,p.length-_.length).replace(/(.)\/+$/,"$1")}const O=C[E];return j&&!O?g[v]=void 0:g[v]=(O||"").replace(/%2F/g,"/"),g},{}),pathname:p,pathnameBase:y,pattern:r}}function vg(r,m=!1,d=!0){Ot(r==="*"||!r.endsWith("*")||r.endsWith("/*"),`Route path "${r}" will be treated as if it were "${r.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${r.replace(/\*$/,"/*")}".`);let c=[],f="^"+r.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(y,C,w)=>(c.push({paramName:C,isOptional:w!=null}),w?"/?([^\\/]+)?":"/([^\\/]+)")).replace(/\/([\w-]+)\?(\/|$)/g,"(/$1)?$2");return r.endsWith("*")?(c.push({paramName:"*"}),f+=r==="*"||r==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):d?f+="\\/*$":r!==""&&r!=="/"&&(f+="(?:(?=\\/|$))"),[new RegExp(f,m?void 0:"i"),c]}function wg(r){try{return r.split("/").map(m=>decodeURIComponent(m).replace(/\//g,"%2F")).join("/")}catch(m){return Ot(!1,`The URL path "${r}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${m}).`),r}}function $t(r,m){if(m==="/")return r;if(!r.toLowerCase().startsWith(m.toLowerCase()))return null;let d=m.endsWith("/")?m.length-1:m.length,c=r.charAt(d);return c&&c!=="/"?null:r.slice(d)||"/"}function jg(r,m="/"){let{pathname:d,search:c="",hash:f=""}=typeof r=="string"?Mi(r):r;return{pathname:d?d.startsWith("/")?d:Ag(d,m):m,search:kg(c),hash:zg(f)}}function Ag(r,m){let d=m.replace(/\/+$/,"").split("/");return r.split("/").forEach(f=>{f===".."?d.length>1&&d.pop():f!=="."&&d.push(f)}),d.length>1?d.join("/"):"/"}function Ho(r,m,d,c){return`Cannot include a '${r}' character in a manually specified \`to.${m}\` field [${JSON.stringify(c)}].  Please separate it out to the \`to.${d}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function Ng(r){return r.filter((m,d)=>d===0||m.route.path&&m.route.path.length>0)}function Vf(r){let m=Ng(r);return m.map((d,c)=>c===m.length-1?d.pathname:d.pathnameBase)}function If(r,m,d,c=!1){let f;typeof r=="string"?f=Mi(r):(f={...r},Ee(!f.pathname||!f.pathname.includes("?"),Ho("?","pathname","search",f)),Ee(!f.pathname||!f.pathname.includes("#"),Ho("#","pathname","hash",f)),Ee(!f.search||!f.search.includes("#"),Ho("#","search","hash",f)));let p=r===""||f.pathname==="",y=p?"/":f.pathname,C;if(y==null)C=d;else{let j=m.length-1;if(!c&&y.startsWith("..")){let E=y.split("/");for(;E[0]==="..";)E.shift(),j-=1;f.pathname=E.join("/")}C=j>=0?m[j]:"/"}let w=jg(f,C),g=y&&y!=="/"&&y.endsWith("/"),v=(p||y===".")&&d.endsWith("/");return!w.pathname.endsWith("/")&&(g||v)&&(w.pathname+="/"),w}var Ft=r=>r.join("/").replace(/\/\/+/g,"/"),Sg=r=>r.replace(/\/+$/,"").replace(/^\/*/,"/"),kg=r=>!r||r==="?"?"":r.startsWith("?")?r:"?"+r,zg=r=>!r||r==="#"?"":r.startsWith("#")?r:"#"+r;function Eg(r){return r!=null&&typeof r.status=="number"&&typeof r.statusText=="string"&&typeof r.internal=="boolean"&&"data"in r}var Kf=["POST","PUT","PATCH","DELETE"];new Set(Kf);var Cg=["GET",...Kf];new Set(Cg);var Di=N.createContext(null);Di.displayName="DataRouter";var us=N.createContext(null);us.displayName="DataRouterState";N.createContext(!1);var Zf=N.createContext({isTransitioning:!1});Zf.displayName="ViewTransition";var Tg=N.createContext(new Map);Tg.displayName="Fetchers";var Mg=N.createContext(null);Mg.displayName="Await";var Ut=N.createContext(null);Ut.displayName="Navigation";var Bn=N.createContext(null);Bn.displayName="Location";var Pt=N.createContext({outlet:null,matches:[],isDataRoute:!1});Pt.displayName="Route";var Zo=N.createContext(null);Zo.displayName="RouteError";function Dg(r,{relative:m}={}){Ee(Hn(),"useHref() may be used only in the context of a <Router> component.");let{basename:d,navigator:c}=N.useContext(Ut),{hash:f,pathname:p,search:y}=_n(r,{relative:m}),C=p;return d!=="/"&&(C=p==="/"?d:Ft([d,p])),c.createHref({pathname:C,search:y,hash:f})}function Hn(){return N.useContext(Bn)!=null}function Xa(){return Ee(Hn(),"useLocation() may be used only in the context of a <Router> component."),N.useContext(Bn).location}var Jf="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function Wf(r){N.useContext(Ut).static||N.useLayoutEffect(r)}function Rg(){let{isDataRoute:r}=N.useContext(Pt);return r?Ig():Og()}function Og(){Ee(Hn(),"useNavigate() may be used only in the context of a <Router> component.");let r=N.useContext(Di),{basename:m,navigator:d}=N.useContext(Ut),{matches:c}=N.useContext(Pt),{pathname:f}=Xa(),p=JSON.stringify(Vf(c)),y=N.useRef(!1);return Wf(()=>{y.current=!0}),N.useCallback((w,g={})=>{if(Ot(y.current,Jf),!y.current)return;if(typeof w=="number"){d.go(w);return}let v=If(w,JSON.parse(p),f,g.relative==="path");r==null&&m!=="/"&&(v.pathname=v.pathname==="/"?m:Ft([m,v.pathname])),(g.replace?d.replace:d.push)(v,g.state,g)},[m,d,p,f,r])}N.createContext(null);function _n(r,{relative:m}={}){let{matches:d}=N.useContext(Pt),{pathname:c}=Xa(),f=JSON.stringify(Vf(d));return N.useMemo(()=>If(r,JSON.parse(f),c,m==="path"),[r,f,c,m])}function Ug(r,m){return Ff(r,m)}function Ff(r,m,d,c,f){Ee(Hn(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:p}=N.useContext(Ut),{matches:y}=N.useContext(Pt),C=y[y.length-1],w=C?C.params:{},g=C?C.pathname:"/",v=C?C.pathnameBase:"/",j=C&&C.route;{let L=j&&j.path||"";$f(g,!j||L.endsWith("*")||L.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${g}" (under <Route path="${L}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${L}"> to <Route path="${L==="/"?"*":`${L}/*`}">.`)}let E=Xa(),O;if(m){let L=typeof m=="string"?Mi(m):m;Ee(v==="/"||L.pathname?.startsWith(v),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${v}" but pathname "${L.pathname}" was given in the \`location\` prop.`),O=L}else O=E;let _=O.pathname||"/",Y=_;if(v!=="/"){let L=v.replace(/^\//,"").split("/");Y="/"+_.replace(/^\//,"").split("/").slice(L.length).join("/")}let G=qf(r,{pathname:Y});Ot(j||G!=null,`No routes matched location "${O.pathname}${O.search}${O.hash}" `),Ot(G==null||G[G.length-1].route.element!==void 0||G[G.length-1].route.Component!==void 0||G[G.length-1].route.lazy!==void 0,`Matched leaf route at location "${O.pathname}${O.search}${O.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let B=Gg(G&&G.map(L=>Object.assign({},L,{params:Object.assign({},w,L.params),pathname:Ft([v,p.encodeLocation?p.encodeLocation(L.pathname).pathname:L.pathname]),pathnameBase:L.pathnameBase==="/"?v:Ft([v,p.encodeLocation?p.encodeLocation(L.pathnameBase).pathname:L.pathnameBase])})),y,d,c,f);return m&&B?N.createElement(Bn.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...O},navigationType:"POP"}},B):B}function Bg(){let r=Vg(),m=Eg(r)?`${r.status} ${r.statusText}`:r instanceof Error?r.message:JSON.stringify(r),d=r instanceof Error?r.stack:null,c="rgba(200,200,200, 0.5)",f={padding:"0.5rem",backgroundColor:c},p={padding:"2px 4px",backgroundColor:c},y=null;return console.error("Error handled by React Router default ErrorBoundary:",r),y=N.createElement(N.Fragment,null,N.createElement("p",null,"💿 Hey developer 👋"),N.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",N.createElement("code",{style:p},"ErrorBoundary")," or"," ",N.createElement("code",{style:p},"errorElement")," prop on your route.")),N.createElement(N.Fragment,null,N.createElement("h2",null,"Unexpected Application Error!"),N.createElement("h3",{style:{fontStyle:"italic"}},m),d?N.createElement("pre",{style:f},d):null,y)}var Hg=N.createElement(Bg,null),_g=class extends N.Component{constructor(r){super(r),this.state={location:r.location,revalidation:r.revalidation,error:r.error}}static getDerivedStateFromError(r){return{error:r}}static getDerivedStateFromProps(r,m){return m.location!==r.location||m.revalidation!=="idle"&&r.revalidation==="idle"?{error:r.error,location:r.location,revalidation:r.revalidation}:{error:r.error!==void 0?r.error:m.error,location:m.location,revalidation:r.revalidation||m.revalidation}}componentDidCatch(r,m){this.props.unstable_onError?this.props.unstable_onError(r,m):console.error("React Router caught the following error during render",r)}render(){return this.state.error!==void 0?N.createElement(Pt.Provider,{value:this.props.routeContext},N.createElement(Zo.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function Lg({routeContext:r,match:m,children:d}){let c=N.useContext(Di);return c&&c.static&&c.staticContext&&(m.route.errorElement||m.route.ErrorBoundary)&&(c.staticContext._deepestRenderedBoundaryId=m.route.id),N.createElement(Pt.Provider,{value:r},d)}function Gg(r,m=[],d=null,c=null,f=null){if(r==null){if(!d)return null;if(d.errors)r=d.matches;else if(m.length===0&&!d.initialized&&d.matches.length>0)r=d.matches;else return null}let p=r,y=d?.errors;if(y!=null){let g=p.findIndex(v=>v.route.id&&y?.[v.route.id]!==void 0);Ee(g>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(y).join(",")}`),p=p.slice(0,Math.min(p.length,g+1))}let C=!1,w=-1;if(d)for(let g=0;g<p.length;g++){let v=p[g];if((v.route.HydrateFallback||v.route.hydrateFallbackElement)&&(w=g),v.route.id){let{loaderData:j,errors:E}=d,O=v.route.loader&&!j.hasOwnProperty(v.route.id)&&(!E||E[v.route.id]===void 0);if(v.route.lazy||O){C=!0,w>=0?p=p.slice(0,w+1):p=[p[0]];break}}}return p.reduceRight((g,v,j)=>{let E,O=!1,_=null,Y=null;d&&(E=y&&v.route.id?y[v.route.id]:void 0,_=v.route.errorElement||Hg,C&&(w<0&&j===0?($f("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),O=!0,Y=null):w===j&&(O=!0,Y=v.route.hydrateFallbackElement||null)));let G=m.concat(p.slice(0,j+1)),B=()=>{let L;return E?L=_:O?L=Y:v.route.Component?L=N.createElement(v.route.Component,null):v.route.element?L=v.route.element:L=g,N.createElement(Lg,{match:v,routeContext:{outlet:g,matches:G,isDataRoute:d!=null},children:L})};return d&&(v.route.ErrorBoundary||v.route.errorElement||j===0)?N.createElement(_g,{location:d.location,revalidation:d.revalidation,component:_,error:E,children:B(),routeContext:{outlet:null,matches:G,isDataRoute:!0},unstable_onError:c}):B()},null)}function Jo(r){return`${r} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Yg(r){let m=N.useContext(Di);return Ee(m,Jo(r)),m}function qg(r){let m=N.useContext(us);return Ee(m,Jo(r)),m}function Qg(r){let m=N.useContext(Pt);return Ee(m,Jo(r)),m}function Wo(r){let m=Qg(r),d=m.matches[m.matches.length-1];return Ee(d.route.id,`${r} can only be used on routes that contain a unique "id"`),d.route.id}function Xg(){return Wo("useRouteId")}function Vg(){let r=N.useContext(Zo),m=qg("useRouteError"),d=Wo("useRouteError");return r!==void 0?r:m.errors?.[d]}function Ig(){let{router:r}=Yg("useNavigate"),m=Wo("useNavigate"),d=N.useRef(!1);return Wf(()=>{d.current=!0}),N.useCallback(async(f,p={})=>{Ot(d.current,Jf),d.current&&(typeof f=="number"?r.navigate(f):await r.navigate(f,{fromRouteId:m,...p}))},[r,m])}var sf={};function $f(r,m,d){!m&&!sf[r]&&(sf[r]=!0,Ot(!1,d))}N.memo(Kg);function Kg({routes:r,future:m,state:d,unstable_onError:c}){return Ff(r,void 0,d,c,m)}function zt(r){Ee(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function Zg({basename:r="/",children:m=null,location:d,navigationType:c="POP",navigator:f,static:p=!1}){Ee(!Hn(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let y=r.replace(/^\/*/,"/"),C=N.useMemo(()=>({basename:y,navigator:f,static:p,future:{}}),[y,f,p]);typeof d=="string"&&(d=Mi(d));let{pathname:w="/",search:g="",hash:v="",state:j=null,key:E="default"}=d,O=N.useMemo(()=>{let _=$t(w,y);return _==null?null:{location:{pathname:_,search:g,hash:v,state:j,key:E},navigationType:c}},[y,w,g,v,j,E,c]);return Ot(O!=null,`<Router basename="${y}"> is not able to match the URL "${w}${g}${v}" because it does not start with the basename, so the <Router> won't render anything.`),O==null?null:N.createElement(Ut.Provider,{value:C},N.createElement(Bn.Provider,{children:m,value:O}))}function Jg({children:r,location:m}){return Ug(Xo(r),m)}function Xo(r,m=[]){let d=[];return N.Children.forEach(r,(c,f)=>{if(!N.isValidElement(c))return;let p=[...m,f];if(c.type===N.Fragment){d.push.apply(d,Xo(c.props.children,p));return}Ee(c.type===zt,`[${typeof c.type=="string"?c.type:c.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),Ee(!c.props.index||!c.props.children,"An index route cannot have child routes.");let y={id:c.props.id||p.join("-"),caseSensitive:c.props.caseSensitive,element:c.props.element,Component:c.props.Component,index:c.props.index,path:c.props.path,loader:c.props.loader,action:c.props.action,hydrateFallbackElement:c.props.hydrateFallbackElement,HydrateFallback:c.props.HydrateFallback,errorElement:c.props.errorElement,ErrorBoundary:c.props.ErrorBoundary,hasErrorBoundary:c.props.hasErrorBoundary===!0||c.props.ErrorBoundary!=null||c.props.errorElement!=null,shouldRevalidate:c.props.shouldRevalidate,handle:c.props.handle,lazy:c.props.lazy};c.props.children&&(y.children=Xo(c.props.children,p)),d.push(y)}),d}var ls="get",ss="application/x-www-form-urlencoded";function ms(r){return r!=null&&typeof r.tagName=="string"}function Wg(r){return ms(r)&&r.tagName.toLowerCase()==="button"}function Fg(r){return ms(r)&&r.tagName.toLowerCase()==="form"}function $g(r){return ms(r)&&r.tagName.toLowerCase()==="input"}function Pg(r){return!!(r.metaKey||r.altKey||r.ctrlKey||r.shiftKey)}function e1(r,m){return r.button===0&&(!m||m==="_self")&&!Pg(r)}var as=null;function t1(){if(as===null)try{new FormData(document.createElement("form"),0),as=!1}catch{as=!0}return as}var a1=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function _o(r){return r!=null&&!a1.has(r)?(Ot(!1,`"${r}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${ss}"`),null):r}function i1(r,m){let d,c,f,p,y;if(Fg(r)){let C=r.getAttribute("action");c=C?$t(C,m):null,d=r.getAttribute("method")||ls,f=_o(r.getAttribute("enctype"))||ss,p=new FormData(r)}else if(Wg(r)||$g(r)&&(r.type==="submit"||r.type==="image")){let C=r.form;if(C==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let w=r.getAttribute("formaction")||C.getAttribute("action");if(c=w?$t(w,m):null,d=r.getAttribute("formmethod")||C.getAttribute("method")||ls,f=_o(r.getAttribute("formenctype"))||_o(C.getAttribute("enctype"))||ss,p=new FormData(C,r),!t1()){let{name:g,type:v,value:j}=r;if(v==="image"){let E=g?`${g}.`:"";p.append(`${E}x`,"0"),p.append(`${E}y`,"0")}else g&&p.append(g,j)}}else{if(ms(r))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');d=ls,c=null,f=ss,y=r}return p&&f==="text/plain"&&(y=p,p=void 0),{action:c,method:d.toLowerCase(),encType:f,formData:p,body:y}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function Fo(r,m){if(r===!1||r===null||typeof r>"u")throw new Error(m)}function n1(r,m,d){let c=typeof r=="string"?new URL(r,typeof window>"u"?"server://singlefetch/":window.location.origin):r;return c.pathname==="/"?c.pathname=`_root.${d}`:m&&$t(c.pathname,m)==="/"?c.pathname=`${m.replace(/\/$/,"")}/_root.${d}`:c.pathname=`${c.pathname.replace(/\/$/,"")}.${d}`,c}async function l1(r,m){if(r.id in m)return m[r.id];try{let d=await import(r.module);return m[r.id]=d,d}catch(d){return console.error(`Error loading route module \`${r.module}\`, reloading page...`),console.error(d),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function s1(r){return r==null?!1:r.href==null?r.rel==="preload"&&typeof r.imageSrcSet=="string"&&typeof r.imageSizes=="string":typeof r.rel=="string"&&typeof r.href=="string"}async function r1(r,m,d){let c=await Promise.all(r.map(async f=>{let p=m.routes[f.route.id];if(p){let y=await l1(p,d);return y.links?y.links():[]}return[]}));return u1(c.flat(1).filter(s1).filter(f=>f.rel==="stylesheet"||f.rel==="preload").map(f=>f.rel==="stylesheet"?{...f,rel:"prefetch",as:"style"}:{...f,rel:"prefetch"}))}function rf(r,m,d,c,f,p){let y=(w,g)=>d[g]?w.route.id!==d[g].route.id:!0,C=(w,g)=>d[g].pathname!==w.pathname||d[g].route.path?.endsWith("*")&&d[g].params["*"]!==w.params["*"];return p==="assets"?m.filter((w,g)=>y(w,g)||C(w,g)):p==="data"?m.filter((w,g)=>{let v=c.routes[w.route.id];if(!v||!v.hasLoader)return!1;if(y(w,g)||C(w,g))return!0;if(w.route.shouldRevalidate){let j=w.route.shouldRevalidate({currentUrl:new URL(f.pathname+f.search+f.hash,window.origin),currentParams:d[0]?.params||{},nextUrl:new URL(r,window.origin),nextParams:w.params,defaultShouldRevalidate:!0});if(typeof j=="boolean")return j}return!0}):[]}function o1(r,m,{includeHydrateFallback:d}={}){return c1(r.map(c=>{let f=m.routes[c.route.id];if(!f)return[];let p=[f.module];return f.clientActionModule&&(p=p.concat(f.clientActionModule)),f.clientLoaderModule&&(p=p.concat(f.clientLoaderModule)),d&&f.hydrateFallbackModule&&(p=p.concat(f.hydrateFallbackModule)),f.imports&&(p=p.concat(f.imports)),p}).flat(1))}function c1(r){return[...new Set(r)]}function d1(r){let m={},d=Object.keys(r).sort();for(let c of d)m[c]=r[c];return m}function u1(r,m){let d=new Set;return new Set(m),r.reduce((c,f)=>{let p=JSON.stringify(d1(f));return d.has(p)||(d.add(p),c.push({key:p,link:f})),c},[])}function Pf(){let r=N.useContext(Di);return Fo(r,"You must render this element inside a <DataRouterContext.Provider> element"),r}function m1(){let r=N.useContext(us);return Fo(r,"You must render this element inside a <DataRouterStateContext.Provider> element"),r}var $o=N.createContext(void 0);$o.displayName="FrameworkContext";function ep(){let r=N.useContext($o);return Fo(r,"You must render this element inside a <HydratedRouter> element"),r}function f1(r,m){let d=N.useContext($o),[c,f]=N.useState(!1),[p,y]=N.useState(!1),{onFocus:C,onBlur:w,onMouseEnter:g,onMouseLeave:v,onTouchStart:j}=m,E=N.useRef(null);N.useEffect(()=>{if(r==="render"&&y(!0),r==="viewport"){let Y=B=>{B.forEach(L=>{y(L.isIntersecting)})},G=new IntersectionObserver(Y,{threshold:.5});return E.current&&G.observe(E.current),()=>{G.disconnect()}}},[r]),N.useEffect(()=>{if(c){let Y=setTimeout(()=>{y(!0)},100);return()=>{clearTimeout(Y)}}},[c]);let O=()=>{f(!0)},_=()=>{f(!1),y(!1)};return d?r!=="intent"?[p,E,{}]:[p,E,{onFocus:Rn(C,O),onBlur:Rn(w,_),onMouseEnter:Rn(g,O),onMouseLeave:Rn(v,_),onTouchStart:Rn(j,O)}]:[!1,E,{}]}function Rn(r,m){return d=>{r&&r(d),d.defaultPrevented||m(d)}}function p1({page:r,...m}){let{router:d}=Pf(),c=N.useMemo(()=>qf(d.routes,r,d.basename),[d.routes,r,d.basename]);return c?N.createElement(g1,{page:r,matches:c,...m}):null}function h1(r){let{manifest:m,routeModules:d}=ep(),[c,f]=N.useState([]);return N.useEffect(()=>{let p=!1;return r1(r,m,d).then(y=>{p||f(y)}),()=>{p=!0}},[r,m,d]),c}function g1({page:r,matches:m,...d}){let c=Xa(),{manifest:f,routeModules:p}=ep(),{basename:y}=Pf(),{loaderData:C,matches:w}=m1(),g=N.useMemo(()=>rf(r,m,w,f,c,"data"),[r,m,w,f,c]),v=N.useMemo(()=>rf(r,m,w,f,c,"assets"),[r,m,w,f,c]),j=N.useMemo(()=>{if(r===c.pathname+c.search+c.hash)return[];let _=new Set,Y=!1;if(m.forEach(B=>{let L=f.routes[B.route.id];!L||!L.hasLoader||(!g.some(J=>J.route.id===B.route.id)&&B.route.id in C&&p[B.route.id]?.shouldRevalidate||L.hasClientLoader?Y=!0:_.add(B.route.id))}),_.size===0)return[];let G=n1(r,y,"data");return Y&&_.size>0&&G.searchParams.set("_routes",m.filter(B=>_.has(B.route.id)).map(B=>B.route.id).join(",")),[G.pathname+G.search]},[y,C,c,f,g,m,r,p]),E=N.useMemo(()=>o1(v,f),[v,f]),O=h1(v);return N.createElement(N.Fragment,null,j.map(_=>N.createElement("link",{key:_,rel:"prefetch",as:"fetch",href:_,...d})),E.map(_=>N.createElement("link",{key:_,rel:"modulepreload",href:_,...d})),O.map(({key:_,link:Y})=>N.createElement("link",{key:_,nonce:d.nonce,...Y})))}function x1(...r){return m=>{r.forEach(d=>{typeof d=="function"?d(m):d!=null&&(d.current=m)})}}var tp=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{tp&&(window.__reactRouterVersion="7.9.1")}catch{}function b1({basename:r,children:m,window:d}){let c=N.useRef();c.current==null&&(c.current=lg({window:d,v5Compat:!0}));let f=c.current,[p,y]=N.useState({action:f.action,location:f.location}),C=N.useCallback(w=>{N.startTransition(()=>y(w))},[y]);return N.useLayoutEffect(()=>f.listen(C),[f,C]),N.createElement(Zg,{basename:r,children:m,location:p.location,navigationType:p.action,navigator:f})}var ap=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,ip=N.forwardRef(function({onClick:m,discover:d="render",prefetch:c="none",relative:f,reloadDocument:p,replace:y,state:C,target:w,to:g,preventScrollReset:v,viewTransition:j,...E},O){let{basename:_}=N.useContext(Ut),Y=typeof g=="string"&&ap.test(g),G,B=!1;if(typeof g=="string"&&Y&&(G=g,tp))try{let P=new URL(window.location.href),ce=g.startsWith("//")?new URL(P.protocol+g):new URL(g),we=$t(ce.pathname,_);ce.origin===P.origin&&we!=null?g=we+ce.search+ce.hash:B=!0}catch{Ot(!1,`<Link to="${g}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let L=Dg(g,{relative:f}),[J,me,Z]=f1(c,E),xe=j1(g,{replace:y,state:C,target:w,preventScrollReset:v,relative:f,viewTransition:j});function pe(P){m&&m(P),P.defaultPrevented||xe(P)}let X=N.createElement("a",{...E,...Z,href:G||L,onClick:B||p?m:pe,ref:x1(O,me),target:w,"data-discover":!Y&&d==="render"?"true":void 0});return J&&!Y?N.createElement(N.Fragment,null,X,N.createElement(p1,{page:L})):X});ip.displayName="Link";var y1=N.forwardRef(function({"aria-current":m="page",caseSensitive:d=!1,className:c="",end:f=!1,style:p,to:y,viewTransition:C,children:w,...g},v){let j=_n(y,{relative:g.relative}),E=Xa(),O=N.useContext(us),{navigator:_,basename:Y}=N.useContext(Ut),G=O!=null&&z1(j)&&C===!0,B=_.encodeLocation?_.encodeLocation(j).pathname:j.pathname,L=E.pathname,J=O&&O.navigation&&O.navigation.location?O.navigation.location.pathname:null;d||(L=L.toLowerCase(),J=J?J.toLowerCase():null,B=B.toLowerCase()),J&&Y&&(J=$t(J,Y)||J);const me=B!=="/"&&B.endsWith("/")?B.length-1:B.length;let Z=L===B||!f&&L.startsWith(B)&&L.charAt(me)==="/",xe=J!=null&&(J===B||!f&&J.startsWith(B)&&J.charAt(B.length)==="/"),pe={isActive:Z,isPending:xe,isTransitioning:G},X=Z?m:void 0,P;typeof c=="function"?P=c(pe):P=[c,Z?"active":null,xe?"pending":null,G?"transitioning":null].filter(Boolean).join(" ");let ce=typeof p=="function"?p(pe):p;return N.createElement(ip,{...g,"aria-current":X,className:P,ref:v,style:ce,to:y,viewTransition:C},typeof w=="function"?w(pe):w)});y1.displayName="NavLink";var v1=N.forwardRef(({discover:r="render",fetcherKey:m,navigate:d,reloadDocument:c,replace:f,state:p,method:y=ls,action:C,onSubmit:w,relative:g,preventScrollReset:v,viewTransition:j,...E},O)=>{let _=S1(),Y=k1(C,{relative:g}),G=y.toLowerCase()==="get"?"get":"post",B=typeof C=="string"&&ap.test(C),L=J=>{if(w&&w(J),J.defaultPrevented)return;J.preventDefault();let me=J.nativeEvent.submitter,Z=me?.getAttribute("formmethod")||y;_(me||J.currentTarget,{fetcherKey:m,method:Z,navigate:d,replace:f,state:p,relative:g,preventScrollReset:v,viewTransition:j})};return N.createElement("form",{ref:O,method:G,action:Y,onSubmit:c?w:L,...E,"data-discover":!B&&r==="render"?"true":void 0})});v1.displayName="Form";function w1(r){return`${r} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function np(r){let m=N.useContext(Di);return Ee(m,w1(r)),m}function j1(r,{target:m,replace:d,state:c,preventScrollReset:f,relative:p,viewTransition:y}={}){let C=Rg(),w=Xa(),g=_n(r,{relative:p});return N.useCallback(v=>{if(e1(v,m)){v.preventDefault();let j=d!==void 0?d:On(w)===On(g);C(r,{replace:j,state:c,preventScrollReset:f,relative:p,viewTransition:y})}},[w,C,g,d,c,m,r,f,p,y])}var A1=0,N1=()=>`__${String(++A1)}__`;function S1(){let{router:r}=np("useSubmit"),{basename:m}=N.useContext(Ut),d=Xg();return N.useCallback(async(c,f={})=>{let{action:p,method:y,encType:C,formData:w,body:g}=i1(c,m);if(f.navigate===!1){let v=f.fetcherKey||N1();await r.fetch(v,d,f.action||p,{preventScrollReset:f.preventScrollReset,formData:w,body:g,formMethod:f.method||y,formEncType:f.encType||C,flushSync:f.flushSync})}else await r.navigate(f.action||p,{preventScrollReset:f.preventScrollReset,formData:w,body:g,formMethod:f.method||y,formEncType:f.encType||C,replace:f.replace,state:f.state,fromRouteId:d,flushSync:f.flushSync,viewTransition:f.viewTransition})},[r,m,d])}function k1(r,{relative:m}={}){let{basename:d}=N.useContext(Ut),c=N.useContext(Pt);Ee(c,"useFormAction must be used inside a RouteContext");let[f]=c.matches.slice(-1),p={..._n(r||".",{relative:m})},y=Xa();if(r==null){p.search=y.search;let C=new URLSearchParams(p.search),w=C.getAll("index");if(w.some(v=>v==="")){C.delete("index"),w.filter(j=>j).forEach(j=>C.append("index",j));let v=C.toString();p.search=v?`?${v}`:""}}return(!r||r===".")&&f.route.index&&(p.search=p.search?p.search.replace(/^\?/,"?index&"):"?index"),d!=="/"&&(p.pathname=p.pathname==="/"?d:Ft([d,p.pathname])),On(p)}function z1(r,{relative:m}={}){let d=N.useContext(Zf);Ee(d!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:c}=np("useViewTransitionState"),f=_n(r,{relative:m});if(!d.isTransitioning)return!1;let p=$t(d.currentLocation.pathname,c)||d.currentLocation.pathname,y=$t(d.nextLocation.pathname,c)||d.nextLocation.pathname;return os(f.pathname,y)!=null||os(f.pathname,p)!=null}const lp="/assets/profile-Dvg5Mrpq.png",E1="/assets/email-BmktBa-H.png";function ea(){return n.jsx("header",{className:"header",children:n.jsx("div",{className:"content-container",children:n.jsxs("div",{className:"header-content",children:[n.jsx("a",{href:"/",children:n.jsx("div",{className:"logo",children:n.jsx("img",{src:lp,alt:"Shreayaa Srinivasan Logo",className:"custom-logo"})})}),n.jsxs("nav",{className:"nav-links",children:[n.jsx("a",{href:"/",onClick:r=>{if(r.preventDefault(),window.location.pathname==="/"){const m=document.getElementById("google-cloud");m&&m.scrollIntoView({behavior:"smooth"})}else sessionStorage.setItem("scrollTo","google-cloud"),window.location.href="/"},children:"WORK"}),n.jsx("a",{href:"/about",children:"ABOUT"}),n.jsx("a",{href:"https://drive.google.com/file/d/1npO4k4AAveQdBizDO5rMsA64DmfxBzLA/view?usp=sharing",target:"_blank",rel:"noopener noreferrer",children:"RESUME"}),n.jsx("a",{href:"mailto:shreayaasrini@gmail.com",title:"Email me",style:{lineHeight:0},children:n.jsx("img",{src:E1,alt:"Email",style:{width:"20px",height:"20px",objectFit:"contain"}})})]})]})})})}function of(){return n.jsxs("svg",{className:"footer-arrow",viewBox:"0 0 46 40",fill:"none","aria-hidden":"true",xmlns:"http://www.w3.org/2000/svg",children:[n.jsx("path",{d:"M 40 34 C 28 28, 20 18, 8 7",stroke:"white",strokeWidth:"2.2",strokeLinecap:"round"}),n.jsx("path",{d:"M 8 7 L 19 10 M 8 7 L 11 18",stroke:"white",strokeWidth:"2.2",strokeLinecap:"round"})]})}function Ln(){return n.jsx("footer",{className:"footer",children:n.jsxs("div",{className:"footer-content",children:[n.jsx("div",{className:"footer-message",children:n.jsx("h3",{children:"Let's Connect! 🤝"})}),n.jsxs("div",{className:"footer-links",children:[n.jsxs("a",{className:"footer-link",href:"https://www.linkedin.com/in/shreayaa-nadagudy-srinivasan-b41a271a8/",target:"_blank",rel:"noopener noreferrer",children:[n.jsx(of,{}),n.jsx("span",{children:"LinkedIn"})]}),n.jsxs("a",{className:"footer-link",href:"mailto:shreayaasrini@gmail.com",children:[n.jsx(of,{}),n.jsx("span",{children:"Email"})]})]}),n.jsx("p",{className:"footer-copyright",children:"Designed + Coded with 🩷 by Shreayaa Srinivasan © 2026"})]})})}const C1="/assets/heroImage-CWryvvzx.png",T1="/assets/Venn-wSdGeou3.png",Vo="/assets/trophy-B47DuTBs.png",M1="/assets/Gilly-Nl1MrirQ.jpeg";/**
 * @license lucide-react v0.543.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const D1=r=>r.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),R1=r=>r.replace(/^([A-Z])|[\s-_]+(\w)/g,(m,d,c)=>c?c.toUpperCase():d.toLowerCase()),cf=r=>{const m=R1(r);return m.charAt(0).toUpperCase()+m.slice(1)},sp=(...r)=>r.filter((m,d,c)=>!!m&&m.trim()!==""&&c.indexOf(m)===d).join(" ").trim(),O1=r=>{for(const m in r)if(m.startsWith("aria-")||m==="role"||m==="title")return!0};/**
 * @license lucide-react v0.543.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const B1=N.forwardRef(({color:r="currentColor",size:m=24,strokeWidth:d=2,absoluteStrokeWidth:c,className:f="",children:p,iconNode:y,...C},w)=>N.createElement("svg",{ref:w,...U1,width:m,height:m,stroke:r,strokeWidth:c?Number(d)*24/Number(m):d,className:sp("lucide",f),...!p&&!O1(C)&&{"aria-hidden":"true"},...C},[...y.map(([g,v])=>N.createElement(g,v)),...Array.isArray(p)?p:[p]]));/**
 * @license lucide-react v0.543.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Gn=(r,m)=>{const d=N.forwardRef(({className:c,...f},p)=>N.createElement(B1,{ref:p,iconNode:m,className:sp(`lucide-${D1(cf(r))}`,`lucide-${r}`,c),...f}));return d.displayName=cf(r),d};/**
 * @license lucide-react v0.543.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 And then starting Nov 2025 I have been working with a PhD student, Jeremy Faulk, creating and testing interactive systems that connect physiological sensors (e.g., heart rate monitors) with real-time lighting and sound applications (e.g., Philips Hue, Ableton Live), while logging and processing experimental data using Python.`,hl:["diving into co-design research with remote mental health support systems","creating and testing interactive systems","experimental data using Python"]},{date:"Present",place:"Actively looking for full-time roles",type:"job",bodyPlace:!0,badge:"Open to relocation nationwide"}];function Ax(r,m=[]){if(!m.length)return r;const d=m.map(p=>p.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")),c=new RegExp(`(${d.join("|")})`,"g");return r.split(c).map((p,y)=>m.includes(p)?n.jsx("span",{className:"journey-hl",children:p},y):p)}const Nx=[{img:rx,rotate:"-4deg",landscape:!1},{img:ox,rotate:"3deg",landscape:!1},{img:cx,rotate:"-2deg",landscape:!0},{img:dx,rotate:"5deg",landscape:!1},{img:ux,rotate:"-3deg",landscape:!1},{img:mx,rotate:"2deg",landscape:!1},{img:fx,rotate:"-5deg",landscape:!1},{img:gx,rotate:"3deg",landscape:!1},{img:px,rotate:"4deg",landscape:!0},{img:hx,rotate:"-2deg",landscape:!1},{img:xx,rotate:"-4deg",landscape:!0},{img:bx,rotate:"2deg",landscape:!0},{img:yx,rotate:"-3deg",landscape:!1},{img:vx,rotate:"4deg",landscape:!1},{img:wx,rotate:"-2deg",landscape:!1}],Lo=[{src:I1,alt:"Figma",rotate:"-8deg",x:"15%",y:"5%",size:52},{src:K1,alt:"Miro",rotate:"6deg",x:"62%",y:"3%",size:46},{src:Z1,alt:"Notion",rotate:"-4deg",x:"38%",y:"14%",size:44},{src:J1,alt:"GitHub",rotate:"9deg",x:"72%",y:"18%",size:48},{src:W1,alt:"Vue",rotate:"-6deg",x:"20%",y:"28%",size:42},{src:F1,alt:"Slack",rotate:"5deg",x:"55%",y:"32%",size:44},{src:$1,alt:"R",rotate:"-9deg",x:"10%",y:"48%",size:40},{src:P1,alt:"Claude Code",rotate:"7deg",x:"68%",y:"46%",size:46},{src:ex,alt:"Python",rotate:"-5deg",x:"30%",y:"56%",size:42},{src:tx,alt:"Webflow",rotate:"8deg",x:"75%",y:"62%",size:40},{src:ax,alt:"Adobe CC",rotate:"-7deg",x:"18%",y:"70%",size:42},{src:ix,alt:"SQL",rotate:"6deg",x:"58%",y:"74%",size:40},{src:nx,alt:"React JS",rotate:"-4deg",x:"40%",y:"84%",size:38},{src:lx,alt:"Framer",rotate:"5deg",x:"45%",y:"38%",size:38}];function Sx(){const r=N.useRef([]),m=N.useRef(null);N.useEffect(()=>{const j=new IntersectionObserver(E=>E.forEach(O=>{O.isIntersecting&&O.target.classList.add("in")}),{threshold:.12,rootMargin:"0px 0px -40px 0px"});return r.current.forEach(E=>E&&j.observe(E)),()=>j.disconnect()},[]);const d=j=>{j&&!r.current.includes(j)&&r.current.push(j)},c=()=>{const j=m.current;if(!j)return;const E=performance.now(),O=_=>{j.scrollLeft=Math.max(0,(j.scrollWidth-j.clientWidth)/2),_-E<700&&requestAnimationFrame(O)};requestAnimationFrame(O)},[f,p]=N.useState(()=>Lo.map(()=>null)),y=N.useRef(0),C=N.useRef(null),w=(j,E)=>{if(f[E]||!C.current)return;const O=j.currentTarget.getBoundingClientRect(),_=C.current.getBoundingClientRect(),Y=y.current++,G=(Math.random()-.5)*_.width*.26,B=(Math.random()-.5)*10,L=Math.min(Y*6,40),J=_.left+_.width*.36+G,me=_.top+_.height*.56-L+B,Z=J-(O.left+O.width/2),xe=me-(O.top+O.height/2),pe=(Math.random()-.5)*70;p(X=>X.map((P,ce)=>ce===E?{tx:Z,ty:xe,spin:pe,z:100+Y}:P))},g=()=>{y.current=0,p(Lo.map(()=>null))},v=f.some(Boolean);return n.jsxs("div",{className:"about-page",children:[n.jsx("style",{children:`
      ...
      `}),n.jsx(ea,{}),n.jsxs("div",{className:"cs-hero",children:[n.jsx("img",{src:ps,alt:"Routes to Roots — Final Product",className:"cs-hero-img"}),n.jsx("p",{className:"cs-hero-subtitle",children:"Final Product View"})]}),n.jsxs("div",{className:"cs-page-layout",children:[n.jsx("aside",{className:"cs-sidebar","aria-label":"Section navigation",children:n.jsx("nav",{className:"cs-sidebar-nav",children:G.map(B=>n.jsx("a",{href:`#${B.id}`,className:`cs-sidebar-link${d===B.id?" active":""}`,onClick:L=>{L.preventDefault(),document.getElementById(B.id)?.scrollIntoView({behavior:"smooth",block:"start"})},children:B.label},B.id))})}),n.jsxs("div",{className:"cs-content",children:[n.jsxs("div",{className:"cs-intro",id:"context",children:[n.jsx("div",{className:"cs-tags fade-up",children:["UX Research","Interaction Design","Cultural Probes","Auto Ethnography","Diary Studies"].map(B=>n.jsx("span",{className:"cs-tag",children:B},B))}),n.jsx("p",{className:"cs-sublabel fade-up",children:"What is this project?"}),n.jsx("p",{className:"cs-oneliner fade-up",children:"Designed a research-driven solution to support students who want to practice their cultural hobbies and manage them along with hectic academic schedules."}),n.jsxs("div",{className:"cs-meta fade-up",children:[n.jsxs("div",{className:"cs-meta-row cs-meta-row-top",children:[n.jsxs("div",{className:"cs-meta-cell",children:[n.jsx("div",{className:"cs-meta-key",children:"Institution"}),n.jsx("div",{className:"cs-meta-val",children:"Cornell University"})]}),n.jsxs("div",{className:"cs-meta-cell",children:[n.jsx("div",{className:"cs-meta-key",children:"My Role"}),n.jsx("div",{className:"cs-meta-val",children:"UX Researcher & Interaction Designer"})]}),n.jsxs("div",{className:"cs-meta-cell",children:[n.jsx("div",{className:"cs-meta-key",children:"Timeline"}),n.jsx("div",{className:"cs-meta-val",children:"13 Weeks · May 2025"})]})]}),n.jsx("div",{className:"cs-meta-row cs-meta-row-mid",children:n.jsxs("div",{className:"cs-meta-cell cs-meta-team",children:[n.jsx("div",{className:"cs-meta-key",children:"Team"}),n.jsx("div",{className:"cs-meta-team-avatars","aria-label":"Project team",children:Y.map(B=>n.jsxs("div",{className:"cs-meta-team-role",children:[n.jsx("img",{src:B.avatar,alt:"",className:"cs-team-avatar"}),n.jsx("div",{className:"cs-team-role-label",children:B.name})]},B.name))})]})}),n.jsx("div",{className:"cs-meta-row cs-meta-row-tools",children:n.jsxs("div",{className:"cs-meta-cell cs-meta-tools",children:[n.jsx("div",{className:"cs-meta-key",children:"Tools"}),n.jsx("div",{className:"cs-tool-logos",children:_.map(B=>n.jsxs("div",{className:"cs-tool-item",children:[n.jsx("img",{src:B.src,alt:B.name,title:B.name,className:"cs-tool-logo"}),n.jsx("p",{className:"cs-tool-name",children:B.name})]},B.name))})]})})]})]}),n.jsxs("div",{className:"cs-section",id:"overview",children:[n.jsx("p",{className:"cs-section-label",children:"Overview"}),n.jsxs("div",{className:"cs-body fade-up",children:[n.jsx("p",{className:"cs-bold-intro",children:"Cornell brings together students from culturally diverse backgrounds."}),n.jsx("p",{children:"And somewhere between orientation week and finals season, a lot of them quietly stop doing the things that they grew up loving, traditional cooking, dance, music, art, the cultural hobbies that tied them to home."}),n.jsxs("p",{children:["It is because they ",n.jsx("span",{className:"cs-highlight",children:"struggle to maintain these hobbies while navigating the demands of university life."})," Because there was no time, no space, no community, and honestly, no easy way to find any of those things."]}),n.jsxs("p",{children:["Now you might think that there are cultural clubs one could join. But they're not built for this. To join ",n.jsx("span",{className:"cs-highlight",children:"most cultural clubs, you need to already be skilled."})," They're not designed for the student who grew up folding dumplings with their grandmother, or who learned Bharatanatyam basics as a child but never trained formally, someone who loves the practice, feels culturally grounded by it, and wants to get back to it, but has no entry point. There was ",n.jsx("span",{className:"cs-highlight",children:"no one holistic system where you could pursue your own cultural hobby at your own level"}),", stumble into someone else's tradition, and feel welcome doing either. That gap is what we were designing for."]}),n.jsxs("p",{children:["Over the course of this project, we ran ",n.jsx("span",{className:"cs-highlight",children:"contextual interviews"}),", designed and distributed ",n.jsx("span",{className:"cs-highlight",children:"physical cultural probe kits"})," to participants, conducted an ",n.jsx("span",{className:"cs-highlight",children:"autoethnographic research"})," within our research team, synthesized everything through ",n.jsx("span",{className:"cs-highlight",children:"affinity mapping and personas"}),", and landed on a ",n.jsx("span",{className:"cs-highlight",children:"design concept"}),". This case study is a gist of my process throughout this project."]})]})]}),n.jsxs("div",{className:"cs-section",id:"problem",children:[n.jsx("p",{className:"cs-section-label",children:"Problem"}),n.jsx("div",{className:"cs-body",children:n.jsx("p",{className:"cs-bold-intro fade-up problem-lead",children:"Once the problem was clear, we put forth a list of research questions to guide us through the research process."})}),n.jsx(Po,{cards:Px})]}),n.jsxs("div",{className:"cs-section",id:"solution-preview",children:[n.jsx("p",{className:"cs-section-label",children:"Solution Preview"}),n.jsx("p",{className:"cs-solution-oneliner fade-up",children:"Here is a walkthrough of the final design solution."}),n.jsx("div",{className:"cs-video-wrap fade-up",children:n.jsx("iframe",{src:"https://www.youtube.com/embed/NbugF3D0B9k",title:"Routes to Roots — Final Design Demo",frameBorder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share",allowFullScreen:!0})}),n.jsxs("button",{className:"cs-skip-btn fade-up",onClick:O,children:[n.jsx("span",{className:"cs-skip-icon","aria-hidden":!0,children:n.jsx("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:n.jsx("path",{d:"M12 5v10M7 12l5 5 5-5"})})}),n.jsx("span",{className:"cs-skip-label",children:"In a hurry? Skip to the final design"})]})]}),n.jsxs("div",{className:"cs-section",id:"impact",ref:w,children:[n.jsx("p",{className:"cs-section-label",children:"Key Outputs"}),n.jsxs("div",{className:"impact-row",children:[n.jsx(At,{end:10,suffix:"+",inView:r,label:"Cornell students recruited across cultural clubs as research participants"}),n.jsx(At,{end:2,suffix:"",inView:r,label:"Complementary research methods in this mixed-method research study (cultural probes and autoethnography)"}),n.jsx(At,{end:1,suffix:"",inView:r,label:"High-fidelity prototype presented to the class"})]}),n.jsx("p",{className:"impact-note fade-up",children:'The most meaningful impact was winning "Best Project for Social Impact and Uniqueness" amongst 75+ students.'})]}),n.jsxs("div",{className:"cs-section",id:"design-process",children:[n.jsx("p",{className:"cs-section-label",children:"Research Process"}),n.jsx("p",{className:"process-intro fade-up",children:"The research process was messy and interesting. Every diary study entry surfaced the emotional depth of the problem, and every research method revealed something we had overlooked."}),n.jsxs("div",{className:"process-timeline",children:[n.jsxs("div",{className:"process-step",children:[n.jsxs("div",{className:"ps-content fade-up",children:[n.jsx("div",{className:"ps-img",children:n.jsx("img",{src:Xx,alt:"Contextual interviews"})}),n.jsx("p",{className:"ps-num",children:"01"}),n.jsx("h3",{className:"ps-title",children:"Contextual Interviews"}),n.jsx("p",{className:"ps-text",children:"We started off the research process by interviewing and observing students who practiced cultural hobbies. We wanted to understand what these hobbies meant to the users and analyze the space that we had to design for."})]}),n.jsx("div",{})]}),n.jsx(Ve,{flip:!1}),n.jsxs("div",{className:"process-step",children:[n.jsx("div",{}),n.jsxs("div",{className:"ps-content fade-up",children:[n.jsx("div",{className:"ps-img",children:n.jsx("img",{src:zf,alt:"Cultural probe kit",className:"clickable-image",onClick:()=>g([zf,Vx,Ix,Kx,Zx],0)})}),n.jsx("p",{className:"image-subtext",children:"Click to browse the full probe kit →"}),n.jsx("p",{className:"ps-num",children:"02"}),n.jsx("h3",{className:"ps-title",children:"Method: Cultural Probes & Diary Studies"}),n.jsxs("p",{className:"ps-text",children:[n.jsx("strong",{children:"Why?"})," The first method was a cultural probe kit. We wanted participants to show us things they couldn't easily say out loud. So we chose a cultural probe kit with scrapbooks, postcards, and timeline maps, low-pressure creative materials that let emotions surface naturally, without the awkwardness of a formal interview. Alongside that, we had them fill out daily diary prompts for a week, capturing their actual routines in real time."]})]})]}),n.jsx(Ve,{flip:!0}),n.jsxs("div",{className:"process-step",children:[n.jsxs("div",{className:"ps-content fade-up",children:[n.jsx("div",{className:"ps-img",children:n.jsx("img",{src:Cf,alt:"Persona",className:"clickable-image",onClick:()=>g(Cf)})}),n.jsx("p",{className:"image-subtext",children:"Click to view in detail"}),n.jsx("p",{className:"ps-num",children:"03"}),n.jsx("h3",{className:"ps-title",children:"Persona Creation"}),n.jsx("p",{className:"ps-text",children:"Once we had completed probe kits and conducted exit interviews with participants. The findings from method 1 helped us weave a persona representing the user group we were solving for."})]}),n.jsx("div",{})]}),n.jsx(Ve,{flip:!1}),n.jsxs("div",{className:"process-step",children:[n.jsx("div",{}),n.jsxs("div",{className:"ps-content fade-up",children:[n.jsx("div",{className:"ps-img",children:n.jsx("img",{src:Tf,alt:"Autoethnography study",className:"clickable-image",onClick:()=>g(Tf)})}),n.jsx("p",{className:"image-subtext",children:"Click to view in detail"}),n.jsx("p",{className:"ps-num",children:"04"}),n.jsx("h3",{className:"ps-title",children:"Method: Autoethnography"}),n.jsxs("p",{className:"ps-text",children:[n.jsx("strong",{children:"Why?"})," Every person on our team came from a culturally diverse background, and most of us had felt that quiet drift away from our own cultural practices at some point in college. So it made sense to turn inward. We ran an autoethnography study after Method 1, making ourselves the participants. We genuinely fit the people we were designing for, and there's something you can only learn from your own honest experience that no interview script can pull out of someone else."]})]})]}),n.jsx(Ve,{flip:!0}),n.jsxs("div",{className:"process-step",children:[n.jsxs("div",{className:"ps-content fade-up",children:[n.jsx("div",{className:"ps-img",children:n.jsx("img",{src:Ef,alt:"Findings & synthesis",className:"clickable-image",onClick:()=>g([Ef,Jx,Wx,Fx],0)})}),n.jsx("p",{className:"image-subtext",children:"Click to browse the findings →"}),n.jsx("p",{className:"ps-num",children:"05"}),n.jsx("h3",{className:"ps-title",children:"Findings"}),n.jsx("p",{className:"ps-list-label",children:"The cultural probe method revealed:"}),n.jsxs("ul",{className:"ps-sublist",children:[n.jsx("li",{children:"Cultural hobbies help the students to sustain a connection to their heritage and strengthen social bonds."}),n.jsx("li",{children:"Cultural hobbies act as anchors of self-identity and aspiration."}),n.jsx("li",{children:"Cultural engagement is often deprioritized in hectic academic schedules"})]}),n.jsx("p",{className:"ps-list-label",children:"The autoethnography study revealed:"}),n.jsxs("ul",{className:"ps-sublist",children:[n.jsx("li",{children:"Most apps lacked built-in motivators, resulting in self-driven participation."}),n.jsx("li",{children:"Participants desired tools for reflection and growth tracking."}),n.jsx("li",{children:"Cultural connection fluctuated with the tone and depth of content."})]})]}),n.jsx("div",{})]}),n.jsx(Ve,{flip:!1}),n.jsxs("div",{className:"process-step",children:[n.jsx("div",{}),n.jsxs("div",{className:"ps-content fade-up",children:[n.jsx("div",{className:"ps-img",children:n.jsx("img",{src:Mf,alt:"Design ideation sketches",className:"clickable-image",onClick:()=>g(Mf)})}),n.jsx("p",{className:"image-subtext",children:"Click to view in detail"}),n.jsx("p",{className:"ps-num",children:"06"}),n.jsx("h3",{className:"ps-title",children:"Design Ideation"}),n.jsx("p",{className:"ps-text",children:"We sketched low-fidelity sketches of multiple concepts, including apps, community boards, and event platforms. A competitor analysis of existing hobby apps (YouTube, Duolingo-style trackers, cooking platforms) revealed they all prioritized productivity over cultural connection."}),n.jsx("p",{className:"ps-text",children:n.jsx("strong",{children:"We decided not to build another app."})})]})]}),n.jsx(Ve,{flip:!0}),n.jsxs("div",{className:"process-step",children:[n.jsxs("div",{className:"ps-content fade-up",children:[n.jsx("div",{className:"ps-img",children:n.jsx("img",{src:Df,alt:"Routes to Roots kiosk concept",className:"clickable-image",onClick:()=>g(Df)})}),n.jsx("p",{className:"image-subtext",children:"Click to view in detail"}),n.jsx("p",{className:"ps-num",children:"07"}),n.jsx("h3",{className:"ps-title",children:"Final Design"}),n.jsx("p",{className:"ps-text",children:"We developed a final concept, Routes to Roots, a physical kiosk placed in visible spaces across the Cornell campus (eg, Duffield, Sage Atrium). It offers students an accessible, reflective way to rediscover and connect with their cultural hobbies through peers, events, and visible spaces. The kiosk steps in to fill the gaps of:"}),n.jsxs("ul",{className:"ps-sublist",children:[n.jsxs("li",{children:[n.jsx("strong",{children:"Visibility:"})," Making culturally meaningful hobbies public and discoverable."]}),n.jsxs("li",{children:[n.jsx("strong",{children:"Agency:"})," Empowering students to define and share their own practices."]}),n.jsxs("li",{children:[n.jsx("strong",{children:"Emotional resonance:"})," Prioritizing curiosity and reflection over achievement."]})]})]}),n.jsx("div",{})]})]})]}),n.jsxs("div",{className:"cs-section",id:"final-design",children:[n.jsx("p",{className:"cs-section-label",children:"Final Design"}),n.jsxs("div",{className:"fd-grid fade-up",children:[n.jsxs("div",{className:"fd-item",children:[n.jsx("img",{src:Rf,alt:"Final design concept 1",className:"clickable-image",onClick:()=>g(Rf)}),n.jsx("p",{className:"image-subtext",children:"Click to view in detail →"})]}),n.jsxs("div",{className:"fd-item",children:[n.jsx("img",{src:Of,alt:"Final design concept 2",className:"clickable-image",onClick:()=>g(Of)}),n.jsx("p",{className:"image-subtext",children:"Click to view in detail →"})]}),n.jsxs("div",{className:"fd-item",children:[n.jsx("img",{src:Uf,alt:"Final design concept 3",className:"clickable-image",onClick:()=>g(Uf)}),n.jsx("p",{className:"image-subtext",children:"Click to view in detail →"})]}),n.jsxs("div",{className:"fd-item",children:[n.jsx("img",{src:Bf,alt:"Final design concept 4",className:"clickable-image",onClick:()=>g(Bf)}),n.jsx("p",{className:"image-subtext",children:"Click to view in detail →"})]})]})]}),n.jsxs("div",{className:"cs-section",id:"not-to-build",children:[n.jsx("p",{className:"cs-section-label",children:"What We Decided Not to Build & Why"}),n.jsxs("div",{className:"ntb-list",children:[n.jsxs("div",{className:"ntb-item fade-up",children:[n.jsx("h3",{className:"ntb-item-title",children:"A physical cultural center"}),n.jsx("p",{className:"ntb-desc",children:"One concept we seriously explored was a dedicated campus space with different rooms dedicated to different hobbies: instruments you could borrow, art supplies, and cooking equipment. The idea was that if you used to play violin as a kid but don't have one here, you shouldn't have to buy a new one just to reconnect with something that's always been part of you. It was a compelling concept. But we kept coming back to the same problem: visibility. Cornell is already full of resources that students don't know about. A cultural center, however well-equipped, risks becoming just another thing that exists on campus without reaching the people who need it most, exactly like the cultural clubs we started this project trying to understand. So we let it go."})]}),n.jsxs("div",{className:"ntb-item fade-up",children:[n.jsx("h3",{className:"ntb-item-title",children:"A mobile app"}),n.jsx("p",{className:"ntb-desc",children:"Our autoethnography showed clearly that apps don't sustain cultural engagement on their own. Emotional connection doesn't come from an app; it comes from a triggering memory. An app would have replicated the same hollow experience we were trying to fix."})]})]})]}),n.jsxs("div",{className:"cs-section",id:"takeaways",children:[n.jsx("p",{className:"cs-section-label",children:"3 Things That This Project Taught Me"}),n.jsxs("div",{className:"learnings-list",children:[n.jsxs("div",{className:"learning-item fade-up",children:[n.jsx("span",{className:"learning-n",children:"1"}),n.jsxs("p",{className:"learning-text",children:[n.jsx("strong",{children:"Design beyond usability."}),` This project shifted something for me. I'm used to asking "Is this intuitive?" or "Can users complete the task?" But Routes to Roots asked a completely different question: Does this make someone feel like they belong? Designing for that, for the feeling of being seen, required me to slow down and sit with the research in a way I hadn't before. It was uncomfortable in a good way.`]})]}),n.jsxs("div",{className:"learning-item fade-up",children:[n.jsx("span",{className:"learning-n",children:"2"}),n.jsxs("p",{className:"learning-text",children:[n.jsx("strong",{children:"Mixed method research is highly useful when used the right way."})," Cultural probes let participants show us things they couldn't have said in an interview, grief about lost hobbies, longing in a postcard, pride in a scrapbook drawing. Autoethnography let us feel those same things ourselves. Neither would have been enough on its own. Together, they gave us a kind of view of the problem that I think showed up in the depth of our final design."]})]}),n.jsxs("div",{className:"learning-item fade-up",children:[n.jsx("span",{className:"learning-n",children:"3"}),n.jsxs("p",{className:"learning-text",children:[n.jsx("strong",{children:"Not only this project but this course taught me that the most impactful design is not always an app or something digital."})," That sounds obvious when I say it out loud, but it really wasn't during the project. Every design instinct pulls you toward a screen. What changed for us was paying attention to where students actually were, walking through Duffield, sitting in Sage Atrium, passing through spaces they use every single day. A kiosk in those spaces does something an app notification never could: it catches you when you weren't looking for it."]})]})]})]}),n.jsxs("div",{className:"cs-section",id:"skills",children:[n.jsx("p",{className:"cs-section-label",children:"Skills Gained Through This Project"}),n.jsx("div",{className:"skills-pills",children:["Cultural Probes Design","Diary Study","Autoethnography","Affinity Mapping","Persona Development","Interaction Design","Kiosk UX","Figma Prototyping","Qualitative Data Analysis","R (data visualization)","Physical Research Artifact Design"].map(B=>n.jsx("span",{className:"skill-pill fade-up",children:B},B))})]}),n.jsxs("div",{className:"cs-section",id:"people",children:[n.jsx("p",{className:"cs-section-label",children:"The People Behind All This"}),n.jsx("div",{className:"people-img-wrap fade-up",children:n.jsx("img",{src:$x,alt:"Routes to Roots team"})})]}),n.jsx("div",{className:"cs-the-end",children:n.jsx("p",{className:"cs-the-end-text fade-up",children:"THE END"})})]})]}),n.jsxs("div",{className:"see-next",children:[n.jsx("p",{className:"see-next-label fade-up",children:"See Next"}),n.jsxs("div",{className:"see-next-grid",children:[n.jsxs("a",{href:"/google-cloud-case-study",className:"see-next-card fade-up",children:[n.jsx("img",{src:fs,alt:"Google Cloud Capstone",className:"see-next-img"}),n.jsxs("div",{className:"see-next-body",children:[n.jsx("h3",{className:"see-next-title",children:"Google Cloud Capstone"}),n.jsx("p",{className:"see-next-desc",children:"Designed a linear onboarding flow that reimagines how cloud platforms can guide non-technical users."})]})]}),n.jsxs("a",{href:"/ithaca-soap-case-study",className:"see-next-card fade-up",children:[n.jsx("img",{src:Un,alt:"Ithaca Soap Redesign",className:"see-next-img"}),n.jsxs("div",{className:"see-next-body",children:[n.jsx("h3",{className:"see-next-title",children:"Ithaca Soap Redesign"}),n.jsx("p",{className:"see-next-desc",children:"Designed and developed a sustainable-first mobile app using Vue.js for a small business called Ithaca Soap."})]})]})]})]}),n.jsx(Ln,{}),f&&n.jsx("div",{className:"image-modal-overlay",onClick:v,children:n.jsxs("div",{className:"image-modal-content",onClick:B=>B.stopPropagation(),children:[n.jsx("button",{className:"image-modal-close",onClick:v,children:"×"}),f.length>1&&n.jsx("button",{className:"image-modal-nav prev",onClick:E,"aria-label":"Previous image",children:n.jsx("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.2",children:n.jsx("path",{d:"M15 18l-6-6 6-6"})})}),n.jsx("img",{src:f[y],alt:"Enlarged view"}),f.length>1&&n.jsx("button",{className:"image-modal-nav next",onClick:j,"aria-label":"Next image",children:n.jsx("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.2",children:n.jsx("path",{d:"M9 18l6-6-6-6"})})}),f.length>1&&n.jsxs("div",{className:"image-modal-counter",children:[y+1," / ",f.length]})]})})]})}const t2="/assets/storyboard1-fBactef1.png",a2="/assets/storyboard2-Dq1tlHVE.png",i2="/assets/storyboard3-NQAMn8Tz.png",n2="/assets/prototype1-CqnRYqh1.png",l2="/assets/prototype2-wMH44h2A.png",s2="/assets/prototype3-CAUpV1-q.png",r2="/assets/prototype4-BHIa9hNy.png",o2="/assets/prototype5-CsczmHRT.png",Hf=[{id:1,title:"Overview",content:n.jsxs("div",{children:[n.jsx("p",{children:`Imagine landing in a new country for the first time. You're excited, nervous, and ready to meet people, except every introduction turns into a mini struggle. Your name gets mispronounced again and again. You start shortening it, giving an "easy version," or just avoiding correcting people altogether. Over time, this chips away at your confidence in classrooms, networking events, and even casual conversations.`}),n.jsxs("p",{children:["That frustration sparked our team's project: ",n.jsx("strong",{children:"iName"})," — a mobile and wearable app designed to make introductions smoother by helping people pronounce and remember names correctly while also honoring the cultural stories behind them."]})]})},{id:2,title:"My Role",content:n.jsxs("div",{children:[n.jsx("p",{children:"I wore many hats in this project:"}),n.jsxs("ul",{children:[n.jsxs("li",{children:["As a ",n.jsx("strong",{children:"researcher"}),", I interviewed international participants, analyzed the data, and conducted usability tests."]}),n.jsxs("li",{children:["As a ",n.jsx("strong",{children:"strategist"}),", I sketched and storyboarded scenarios, imagining how technology could work in real life."]}),n.jsxs("li",{children:["As a ",n.jsx("strong",{children:"designer"}),", I built prototypes in Figma, turning our rough sketches into something people could actually use."]})]}),n.jsx("p",{children:"More than anything, I focused on making sure the voices of our users stayed at the center of every decision."})]})},{id:3,title:"Understanding Our Users",content:n.jsxs("div",{children:[n.jsx("p",{children:"We focused on non-native English speakers at Cornell — students, visiting scholars, and newcomers navigating a new world."}),n.jsx("p",{children:`One student told us, "I stopped correcting because I was tired of repeating my name ten times." Another said, "It feels like I'm asking people for too much just to say it right."`}),n.jsx("p",{children:"These stories shaped our problem: people don't just need their names pronounced correctly; they need their identity respected and remembered."})]})},{id:4,title:"Design Process",content:n.jsxs("div",{children:[n.jsx("h4",{children:"01 Research"}),n.jsx("p",{children:"Our research showed that existing solutions like Google Translate or simple name tags fell short; they either lacked cultural context, felt outdated, or weren't built just for social/professional environments."}),n.jsx("p",{children:'We also explored tools like RescueTime in the productivity space (from our inspiration case) and saw a parallel: they solved the "what" but not the "how." Similarly, apps stored names, but none combined memory, pronunciation, and cultural meaning in one. That gap was our opportunity.'}),n.jsx("h4",{children:"02 Early Concepts"}),n.jsx("p",{children:"We started with imagination. What if you could rent smart glasses at an event, and when you met someone new, their name floated above them with the correct pronunciation whispered in your ear?"}),n.jsx("p",{children:"What if there was an interactive map that let you dive into the syllables of Irish, Mandarin, or Hindi names?"}),n.jsx("p",{children:"What if, before a networking event, you could know the names of all the attendees so you never had to stumble through introductions again?"}),n.jsx("p",{children:'These "what ifs" turned into sketches, and the sketches turned into storyboards.'}),n.jsx("ul",{children:n.jsx("li",{children:"Liu, a student from China, records his pronunciation during sign-up, finally feeling like people will hear his name the way his family intended."})}),n.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"1rem",margin:"2rem 0"},children:[n.jsx("img",{src:t2,alt:"Storyboard panels 1-2: User signs up and tries iName app"}),n.jsx("img",{src:a2,alt:"Storyboard panels 3-4: User learns phonics and accesses family name pronunciation"}),n.jsx("img",{src:i2,alt:"Storyboard panels 5-6: User explores China/Mandarin meaning and successfully uses iName"})]}),n.jsx("h4",{children:"03 Prototyping"}),n.jsx("p",{children:"From there, we built wireframes: clean flows for creating profiles, saving names, exploring the world map, and connecting to smart devices. As fidelity increased, we experimented with typography, color palettes, and interactions until the app felt warm and inclusive."}),n.jsx("h4",{children:"04 Testing"}),n.jsx("p",{children:"Then came the real test: putting iName into the hands of students. We gave them tasks like signing up, saving names from a group, or exploring the cultural map. That's when we realized some things weren't working:"}),n.jsxs("ul",{children:[n.jsx("li",{children:'The "Starred Names" icon confused people; nobody knew what it did.'}),n.jsx("li",{children:"The Explore map looked pretty, but users didn't know they could click into it."}),n.jsx("li",{children:"Dense blocks of cultural content overwhelmed readers."}),n.jsx("li",{children:"Everyone wanted profile pictures to connect faces with names."})]}),n.jsx("p",{children:"So we iterated"}),n.jsxs("ul",{children:[n.jsx("li",{children:'We turned "Starred Names" into a clearly labeled Saved tab.'}),n.jsx("li",{children:"We added tooltips and markers to the map."}),n.jsx("li",{children:"We broke content into bite-sized sections with visuals."}),n.jsx("li",{children:"We redesigned event attendee lists into profile cards with photos and play buttons."})]}),n.jsx("p",{children:"Each cycle of testing pulled us closer to the product our users actually needed."})]})},{id:5,title:"Final Design Solution",content:n.jsxs("div",{children:[n.jsx("p",{children:"The final iName experience combines mobile and wearable design with fun features:"}),n.jsxs("ul",{children:[n.jsxs("li",{children:[n.jsx("strong",{children:"Sign Up"}),": Users can record their pronunciation, add phonetic hints, and share the meaning of their name."]}),n.jsxs("li",{children:[n.jsx("strong",{children:"Explore"}),": An interactive world map that connects names to cultures, syllables, and stories."]}),n.jsxs("li",{children:[n.jsx("strong",{children:"Saved"}),": A dedicated space to bookmark and organize names you want to remember for events."]}),n.jsxs("li",{children:[n.jsx("strong",{children:"Event Prep"}),": Attendees get pronunciation reminders ahead of time."]}),n.jsxs("li",{children:[n.jsx("strong",{children:"Smart Devices"}),": Glasses and earbuds that display and pronounce names in real time at events."]})]}),n.jsxs("div",{style:{display:"flex",flexWrap:"nowrap",gap:"2rem",justifyContent:"center",alignItems:"flex-start",margin:"2.5rem 0",overflowX:"auto",width:"calc(100% + 480px)",marginLeft:"-240px",marginRight:"-240px",paddingLeft:"240px",paddingRight:"240px"},children:[n.jsx("div",{style:{flex:"0 0 auto",display:"flex",justifyContent:"center"},children:n.jsx("img",{src:n2,alt:"Sign Up screen",style:{maxWidth:"100%",maxHeight:"480px",height:"auto"}})}),n.jsx("div",{style:{flex:"0 0 auto",display:"flex",justifyContent:"center"},children:n.jsx("img",{src:l2,alt:"Profile screen",style:{maxWidth:"100%",maxHeight:"480px",height:"auto"}})}),n.jsx("div",{style:{flex:"0 0 auto",display:"flex",justifyContent:"center"},children:n.jsx("img",{src:s2,alt:"Groups screen",style:{maxWidth:"100%",maxHeight:"480px",height:"auto"}})}),n.jsx("div",{style:{flex:"0 0 auto",display:"flex",justifyContent:"center"},children:n.jsx("img",{src:r2,alt:"Explore screen",style:{maxWidth:"100%",maxHeight:"480px",height:"auto"}})}),n.jsx("div",{style:{flex:"0 0 auto",display:"flex",justifyContent:"center"},children:n.jsx("img",{src:o2,alt:"Devices screen",style:{maxWidth:"100%",maxHeight:"480px",height:"auto"}})})]}),n.jsxs("div",{style:{marginTop:"1.5rem"},children:[n.jsx("h3",{style:{margin:0,color:"var(--text-secondary)"},children:"Watch how the solution works in real life"}),n.jsx("div",{style:{maxWidth:"100%",marginTop:"1rem",borderRadius:"12px"},children:n.jsx("iframe",{width:"100%",height:"506",src:"https://www.youtube.com/embed/hC4MDLmYAGg",title:"iName Showcase",frameBorder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share",allowFullScreen:!0,style:{borderRadius:"12px",width:"100%",maxWidth:"900px",height:"506px",display:"block"}})})]})]})},{id:6,title:"What Did I Learn?",content:n.jsx("div",{children:n.jsxs("ul",{children:[n.jsx("li",{children:"Storyboards helped us communicate user needs more vividly to our team, ensuring alignment before we invested in prototypes."}),n.jsx("li",{children:"During think-aloud sessions, the most valuable feedback came from moments of hesitation, when users weren't sure what to tap or why a feature existed."}),n.jsx("li",{children:"Learning to observe confusion without intervening gave me clearer signals on where the design was failing."})]})})}];function c2(){const r=d=>{const c=document.getElementById(`section-${d}`);c&&c.scrollIntoView({behavior:"smooth",block:"start"})},m=()=>{window.scrollTo({top:0,behavior:"smooth"})};return N.useEffect(()=>{const d={threshold:.1,rootMargin:"0px 0px -100px 0px"},c=new IntersectionObserver(p=>{p.forEach(y=>{y.isIntersecting&&y.target.classList.add("visible")})},d);return document.querySelectorAll(".fade-in-up, .fade-in-left, .fade-in-right").forEach(p=>c.observe(p)),()=>c.disconnect()},[]),n.jsxs("div",{className:"app",children:[n.jsx("style",{children:`
        ...
        * {
        ...
        `}),n.jsx(ea,{}),n.jsx("div",{className:"case-study-layout",children:n.jsxs("div",{className:"content-container",children:[n.jsx("div",{className:"mockup-section",children:n.jsx("img",{src:cp,alt:"rShiny Project Mockup",className:"mockup-image"})}),n.jsxs("div",{className:"project-metadata",children:[n.jsxs("div",{className:"metadata-item",children:[n.jsx("div",{className:"metadata-label",children:"Role"}),n.jsx("div",{className:"metadata-value",children:"Data Scientist"})]}),n.jsxs("div",{className:"metadata-item",children:[n.jsx("div",{className:"metadata-label",children:"Team"}),n.jsx("div",{className:"metadata-value",children:"Shreayaa, Xihan, and Yuzu"})]}),n.jsxs("div",{className:"metadata-item",children:[n.jsx("div",{className:"metadata-label",children:"Timeline"}),n.jsx("div",{className:"metadata-value",children:"Aug 2024 - Dec 2024"})]})]}),n.jsx("div",{className:"cascade-section",children:n.jsxs("div",{className:"cascade-container",children:[Lf.map(d=>n.jsx("div",{className:"cascade-card",onClick:()=>r(d.id),children:n.jsx("h3",{children:d.title})},d.id)),n.jsx("div",{className:"play-button",onClick:()=>r(1),children:n.jsx("div",{className:"play-icon"})})]})})]})}),n.jsx("div",{className:"content-sections",children:Lf.map(d=>n.jsxs("div",{id:`section-${d.id}`,className:"content-section",children:[n.jsx("div",{className:"section-header",children:n.jsx("h2",{className:"section-title",children:d.title})}),n.jsx("div",{className:"section-content",children:d.content})]},d.id))}),n.jsxs("div",{className:"nav-buttons",children:[n.jsxs("a",{href:"/#work",className:"nav-button primary",children:["View My Other Work",n.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:n.jsx("path",{d:"M7 17L17 7M17 7H7M17 7V17"})})]}),n.jsxs("button",{onClick:m,className:"nav-button secondary",children:[n.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:n.jsx("path",{d:"M18 15L12 9L6 15"})}),"Back to Top"]})]}),n.jsx("footer",{className:"footer",children:n.jsxs("div",{className:"footer-content",children:[n.jsx("div",{className:"footer-message",children:n.jsx("h3",{children:"Like my work? Hit me up with a hi 😊"})}),n.jsxs("div",{className:"footer-links",children:[n.jsx("a",{href:"https://www.linkedin.com/in/shreayaa-nadagudy-srinivasan-b41a271a8/",target:"_blank",rel:"noopener noreferrer",title:"LinkedIn",children:n.jsx("svg",{className:"footer-icon",viewBox:"0 0 24 24",fill:"currentColor",children:n.jsx("path",{d:"M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"})})}),n.jsx("a",{href:"https://medium.com/@shreayaa",target:"_blank",rel:"noopener noreferrer",title:"Medium",children:n.jsx("svg",{className:"footer-icon",viewBox:"0 0 24 24",fill:"currentColor",children:n.jsx("path",{d:"M13.54 12a6.8 6.8 0 01-6.77 6.82A6.8 6.8 0 010 12a6.8 6.8 0 016.77-6.82A6.8 6.8 0 0113.54 12zM20.96 12c0 3.54-1.51 6.42-3.38 6.42-1.87 0-3.39-2.88-3.39-6.42s1.52-6.42 3.39-6.42 3.38 2.88 3.38 6.42M24 12c0 3.17-.53 5.75-1.19 5.75-.66 0-1.19-2.58-1.19-5.75s.53-5.75 1.19-5.75C23.47 6.25 24 8.83 24 12z"})})}),n.jsx("a",{href:"https://dribbble.com",target:"_blank",rel:"noopener noreferrer",title:"Dribbble",children:n.jsx("svg",{className:"footer-icon",viewBox:"0 0 24 24",fill:"currentColor",children:n.jsx("path",{d:"M12 24C5.385 24 0 18.615 0 12S5.385 0 12 0s12 5.385 12 12-5.385 12-12 12zm10.12-10.358c-.35-.11-3.17-.953-6.384-.438 1.34 3.684 1.887 6.684 1.992 7.308 2.3-1.555 3.936-4.02 4.395-6.87zm-6.115 7.808c-.153-.9-.75-4.032-2.19-7.77l-.066.02c-5.79 2.015-7.86 6.025-8.04 6.4 1.74 1.36 3.92 2.166 6.29 2.166 1.42 0 2.77-.29 4-.816zm-11.62-2.58c.232-.4 3.045-5.055 8.332-6.765.135-.045.27-.084.405-.12-.26-.585-.54-1.167-.832-1.74C7.17 11.775 2.206 11.71 1.756 11.7l-.004.312c0 2.633.998 5.037 2.634 6.855zm-2.42-8.955c.46.008 4.683.026 9.477-1.248-1.698-3.018-3.53-5.558-3.8-5.928-2.868 1.35-5.01 3.99-5.676 7.17zM9.6 2.052c.282.38 2.145 2.914 3.822 6 3.645-1.365 5.19-3.44 5.373-3.702-1.81-1.61-4.19-2.586-6.795-2.586-.825 0-1.63.1-2.4.285zm10.335 3.483c-.218.29-1.935 2.493-5.724 4.04.24.49.47.985.68 1.486.08.18.15.36.22.53 3.41-.43 6.8.26 7.14.33-.02-2.42-.88-4.64-2.31-6.38z"})})}),n.jsx("a",{href:"mailto:shreayaasrini@gmail.com",title:"Email",children:n.jsx("svg",{className:"footer-icon",viewBox:"0 0 24 24",fill:"currentColor",children:n.jsx("path",{d:"M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 0 1 0 19.366V5.457c0-.904.732-1.636 1.636-1.636h1.818L12 11.73l8.545-7.909h1.818c.904 0 1.636.732 1.636 1.636 Z"})})})]}),n.jsx("p",{className:"footer-copyright",children:"Designed + Coded with ❤️ by Shreayaa Srinivasan © 2026"})]})})]})}const Gf=23060,qo=12,Np=[{id:"rose",name:"Rose",petal:"#e27396",center:"#a73e5a"},{id:"tulip",name:"Tulip",petal:"#ea9ab2",center:"#c55577",petals:5,rx:8,ry:15,cr:6},{id:"sunflower",name:"Sunflower",petal:"#f6c453",center:"#7a5230",petals:13,rx:5,ry:16,cr:11},{id:"daisy",name:"Daisy",petal:"#ffffff",center:"#f6c453",petals:11,rx:5,ry:13,cr:7},{id:"lavender",name:"Lavender",petal:"#b39ddb",center:"#7e57c2"},{id:"sapling",name:"Sapling",petal:"#7cb342",center:"#5d4037"}],rs=r=>Np.find(m=>m.id===r);function x2({seed:r}){if(r.id==="sapling")return n.jsxs("g",{children:[n.jsx("circle",{cx:50,cy:40,r:17,fill:"#8bc34a"}),n.jsx("circle",{cx:36,cy:50,r:13,fill:"#689f38"}),n.jsx("circle",{cx:64,cy:50,r:13,fill:"#7cb342"}),n.jsx("circle",{cx:50,cy:54,r:15,fill:"#7cb342"}),n.jsx("circle",{cx:45,cy:44,r:9,fill:"#9ccc65"})]});if(r.id==="lavender")return n.jsxs("g",{children:[Array.from({length:7}).map((C,w)=>n.jsx("circle",{cx:50+(w%2?4:-4),cy:20+w*5,r:5,fill:r.petal},w)),n.jsx("circle",{cx:50,cy:18,r:4,fill:"#9575cd"})]});if(r.id==="rose")return n.jsxs("g",{children:[Array.from({length:6}).map((C,w)=>n.jsx("ellipse",{cx:50,cy:24,rx:7,ry:13,fill:r.petal,transform:`rotate(${360/6*w} 50 38)`},`o${w}`)),Array.from({length:5}).map((C,w)=>n.jsx("ellipse",{cx:50,cy:30,rx:5,ry:8,fill:"#d65f82",transform:`rotate(${360/5*w+36} 50 38)`},`i${w}`)),n.jsx("circle",{cx:50,cy:38,r:6,fill:r.center})]});const c=r.petals||8,f=r.rx||6,p=r.ry||13,y=r.cr||9;return n.jsxs("g",{children:[Array.from({length:c}).map((C,w)=>n.jsx("ellipse",{cx:50,cy:38-p+1,rx:f,ry:p,fill:r.petal,stroke:r.id==="daisy"?"#f0d7c0":"none",strokeWidth:r.id==="daisy"?.6:0,transform:`rotate(${360/c*w} 50 38)`},w)),n.jsx("circle",{cx:50,cy:38,r:y,fill:r.center})]})}function Yf({seedId:r,stage:m}){const d=rs(r);if(!d)return null;if(m===0)return n.jsxs("svg",{viewBox:"0 0 100 120",className:"plant-svg",children:[n.jsx("ellipse",{cx:50,cy:101,rx:10,ry:7,fill:"#6d4c2f"}),n.jsx("path",{d:"M50 96 q3 4 0 8",stroke:"#8a6440",strokeWidth:"1.5",fill:"none"})]});const c=m===2,f=c?42:82,p=c?74:88,y=c?12:8;return n.jsxs("svg",{viewBox:"0 0 100 120",className:"plant-svg",children:[n.jsx("path",{d:`M50 108 Q 47 ${(108+f)/2} 50 ${f}`,stroke:"#5a8f3c",strokeWidth:c?5:4,fill:"none",strokeLinecap:"round"}),n.jsx("ellipse",{cx:50-y,cy:p,rx:y,ry:y*.55,fill:"#6aa84f",transform:`rotate(-28 ${50-y} ${p})`}),n.jsx("ellipse",{cx:50+y,cy:p,rx:y,ry:y*.55,fill:"#7cb85f",transform:`rotate(28 ${50+y} ${p})`}),c&&n.jsx(x2,{seed:d})]})}const ns=(r,m)=>{try{const d=localStorage.getItem(r);return d===null?m:JSON.parse(d)}catch{return m}};function b2(){const[r,m]=N.useState(()=>ns("garden_step","seeds")),[d,c]=N.useState(()=>ns("garden_chosen",[])),[f,p]=N.useState(null),[y,C]=N.useState(()=>{const X=ns("garden_plots",null);return Array.isArray(X)&&X.length===qo?X:Array(qo).fill(null)}),[w,g]=N.useState(()=>ns("garden_planted",0)),[v,j]=N.useState(null),[E,O]=N.useState(null),[_,Y]=N.useState(null);N.useEffect(()=>{r==="garden"&&d.length&&!d.includes(f)&&p(d[0])},[r,d,f]),N.useEffect(()=>{localStorage.setItem("garden_step",JSON.stringify(r))},[r]),N.useEffect(()=>{localStorage.setItem("garden_chosen",JSON.stringify(d))},[d]),N.useEffect(()=>{localStorage.setItem("garden_plots",JSON.stringify(y))},[y]),N.useEffect(()=>{localStorage.setItem("garden_planted",JSON.stringify(w))},[w]);const G=X=>{c(P=>P.includes(X)?P.filter(ce=>ce!==X):[...P,X])},B=N.useCallback(X=>{const P=y[X];if(!P){if(!f)return;C(ce=>{const we=[...ce];return we[X]={seedId:f,stage:0},we});return}if(P.stage<2){const ce=P.stage+1;C(we=>{const Me=[...we];return Me[X]={...P,stage:ce},Me}),j(X),setTimeout(()=>j(we=>we===X?null:we),750),ce===2&&(g(we=>we+1),O(X),setTimeout(()=>O(we=>we===X?null:we),1300));return}Y(X),setTimeout(()=>Y(ce=>ce===X?null:ce),500)},[y,f]),L=()=>{window.confirm("Clear your garden? Your total planted count stays.")&&C(Array(qo).fill(null))},J=()=>{d.length&&(p(d[0]),m("garden"))},me=Math.min(100,w/Gf*100),Z=y.some(X=>!X),xe=y.some(X=>X&&X.stage<2);let pe;return y.some(Boolean)?xe?pe="Click a seedling to water it 💧 — water it twice and it blooms.":Z?pe="Keep sowing, or water any seedlings until they bloom.":pe="Your garden is in full bloom! 🌸 Reset it to plant more.":pe=f?`Click any plot to sow your ${rs(f).name.toLowerCase()}.`:"Pick a seed from your pouch below, then click a plot to sow it.",n.jsxs("div",{className:"app",children:[n.jsx("style",{children:`
        @import url('https://fonts.googleapis.com/css2?family=Fjalla+One&display=swap');
      ...
      `}),n.jsx("header",{className:"header",children:n.jsx("div",{className:"content-container",children:n.jsxs("div",{className:"header-content",children:[n.jsx("a",{href:"/",children:n.jsx("div",{className:"logo",children:n.jsx("img",{src:lp,alt:"Shreayaa Srinivasan Logo",className:"custom-logo"})})}),n.jsxs("nav",{className:"nav-links",children:[n.jsx("a",{href:"/",onClick:X=>{X.preventDefault(),sessionStorage.setItem("scrollTo","google-cloud"),window.location.href="/"},children:"WORK"}),n.jsx("a",{href:"/about",children:"ABOUT"}),n.jsx("a",{href:"/garden",className:"active-leaf",title:"The Garden",children:n.jsx(df,{size:20})})]})]})})}),n.jsx("section",{className:"garden-wrap",children:n.jsxs("div",{className:"content-container",children:[n.jsxs("div",{className:"garden-head",children:[n.jsx("h1",{children:r==="seeds"?"Plant a little garden 🌱":"Your garden"}),n.jsx("p",{children:r==="seeds"?"Pick the seeds you’d like to grow. Every plant you raise here counts toward the world record.":"Sow your seeds, water them, and watch them bloom. Each bloom is one more toward the record."})]}),n.jsxs("div",{className:"record-card",children:[n.jsxs("div",{className:"record-top",children:[n.jsxs("span",{className:"record-count",children:[w.toLocaleString()," ",n.jsxs("small",{children:["/ ",Gf.toLocaleString()]})]}),n.jsxs("span",{className:"record-label",children:[n.jsx("span",{role:"img","aria-label":"tree",style:{marginRight:".35em"},children:"🌳"}),"plants grown toward the 24-hour world record"]})]}),n.jsx("div",{className:"record-bar",children:n.jsx("div",{className:"record-fill",style:{width:`${me}%`}})})]}),r==="seeds"&&n.jsxs(n.Fragment,{children:[n.jsx("div",{className:"seed-grid",children:Np.map(X=>{const P=d.includes(X.id);return n.jsxs("div",{className:`seed-packet ${P?"selected":""}`,onClick:()=>G(X.id),role:"button",tabIndex:0,onKeyDown:ce=>{(ce.key==="Enter"||ce.key===" ")&&(ce.preventDefault(),G(X.id))},"aria-pressed":P,children:[P&&n.jsx("span",{className:"seed-check",children:"✓"}),n.jsx(Yf,{seedId:X.id,stage:2}),n.jsx("div",{className:"seed-name",children:X.name})]},X.id)})}),n.jsx("div",{className:"center-actions",children:n.jsxs("button",{className:"btn btn-primary",onClick:J,disabled:!d.length,children:[n.jsx(df,{size:20})," Go to my garden",d.length?` (${d.length})`:""]})})]}),r==="garden"&&n.jsxs(n.Fragment,{children:[n.jsxs("div",{className:"garden-toolbar",children:[n.jsxs("button",{className:"btn btn-ghost",onClick:()=>m("seeds"),children:[n.jsx(_1,{size:16})," Choose seeds"]}),n.jsx("div",{className:"seed-pouch",children:d.map(X=>{const P=rs(X);return n.jsxs("button",{className:`pouch-seed ${f===X?"active":""}`,onClick:()=>p(X),children:[n.jsx("span",{className:"swatch",style:{background:P.petal}}),P.name]},X)})})]}),n.jsx("p",{className:"hint",children:pe}),n.jsx("div",{className:"garden-grid",children:y.map((X,P)=>{const ce=!X,we=X&&X.stage===2,Me=["plot",ce?"empty":"planted",ce&&f?"sowable":"",we?"bloomed":"",v===P?"sowing":"",E===P?"grown":"",_===P?"wiggle":""].filter(Boolean).join(" ");return n.jsxs("div",{className:Me,onClick:()=>B(P),role:"button",tabIndex:0,"aria-label":ce?"Empty plot":`${rs(X.seedId).name}, ${["seed","sprout","bloom"][X.stage]}`,onKeyDown:We=>{(We.key==="Enter"||We.key===" ")&&(We.preventDefault(),B(P))},children:[X&&n.jsx(Yf,{seedId:X.seedId,stage:X.stage}),v===P&&n.jsx("div",{className:"droplets",children:[20,42,60,78].map((We,$e)=>n.jsx("span",{className:"droplet",style:{left:`${We}%`,animationDelay:`${$e*.08}s`}},$e))}),E===P&&n.jsx("div",{className:"sparkles",children:["✨","🌟","✨"].map((We,$e)=>n.jsx("span",{className:"sparkle",style:{left:`${25+$e*25}%`,top:"30%",animationDelay:`${$e*.12}s`},children:We},$e))})]},P)})}),n.jsx("div",{className:"garden-footer-actions",children:n.jsxs("button",{className:"btn btn-ghost",onClick:L,children:[n.jsx(X1,{size:16})," Clear garden"]})})]})]})}),n.jsx("footer",{className:"footer",children:n.jsxs("div",{className:"footer-content",children:[n.jsx("h3",{children:"Grow something today 🌷"}),n.jsx("p",{className:"footer-copyright",children:"Designed + Coded with 🩷 by Shreayaa Srinivasan © 2026"})]})})]})}function y2(){const[r,m]=N.useState(0),[d,c]=N.useState(""),[f,p]=N.useState(!1),y=F0.useMemo(()=>["designer.","researcher.","strategist."],[]);N.useEffect(()=>{const E=setTimeout(()=>{const O=y[r];f?(c(O.substring(0,d.length-1)),d===""&&(p(!1),m(_=>(_+1)%y.length))):(c(O.substring(0,d.length+1)),d===O&&setTimeout(()=>p(!0),1500))},f?50:80);return()=>clearTimeout(E)},[d,f,r,y]);const C=N.useRef([]),w=N.useRef(null),[g,v]=N.useState(!1);N.useEffect(()=>{const E=[];return C.current.forEach((O,_)=>{if(O){const Y=new IntersectionObserver(G=>{G.forEach(B=>{B.isIntersecting&&(B.target.style.animationDelay=`${_*.2}s`,B.target.classList.add("animate-in"))})},{threshold:.1,rootMargin:"-100px"});Y.observe(O),E.push(Y)}}),()=>{E.forEach(O=>O.disconnect())}},[]),N.useEffect(()=>{const E=w.current;if(!E)return;const O=new IntersectionObserver(([_])=>{_.isIntersecting&&(v(!0),O.disconnect())},{threshold:.2,rootMargin:"-80px"});return O.observe(E),()=>O.disconnect()},[]),N.useEffect(()=>{const E=()=>{const O=sessionStorage.getItem("scrollTo");if(O){const _=document.getElementById(O);_&&setTimeout(()=>_.scrollIntoView({behavior:"smooth"}),50),sessionStorage.removeItem("scrollTo")}};return E(),window.addEventListener("storage",E),()=>window.removeEventListener("storage",E)},[]);const j=E=>{window.location.href=E};return n.jsxs("div",{className:"app",children:[n.jsx("style",{children:`
        @import url('https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;700&display=swap');
