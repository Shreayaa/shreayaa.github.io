...
Please change the parent <Route path="${q}"> to <Route path="${q==="/"?"*":`${q}/*`}">.`)}let H=qa(),Y;if(f){let q=typeof f=="string"?An(f):f;je(k==="/"||q.pathname?.startsWith(k),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${k}" but pathname "${q.pathname}" was given in the \`location\` prop.`),Y=q}else Y=H;let V=Y.pathname||"/",F=V;if(k!=="/"){let q=k.replace(/^\//,"").split("/");F="/"+V.replace(/^\//,"").split("/").slice(q.length).join("/")}let G=l0(s,{pathname:F});Ct(O||G!=null,`No routes matched location "${Y.pathname}${Y.search}${Y.hash}" `),Ct(G==null||G[G.length-1].route.element!==void 0||G[G.length-1].route.Component!==void 0||G[G.length-1].route.lazy!==void 0,`Matched leaf route at location "${Y.pathname}${Y.search}${Y.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let Q=Ip(G&&G.map(q=>Object.assign({},q,{params:Object.assign({},S,q.params),pathname:Wt([k,p.encodeLocation?p.encodeLocation(q.pathname).pathname:q.pathname]),pathnameBase:q.pathnameBase==="/"?k:Wt([k,p.encodeLocation?p.encodeLocation(q.pathnameBase).pathname:q.pathnameBase])})),b,d,c,m);return f&&Q?T.createElement(Di.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...Y},navigationType:"POP"}},Q):Q}function Zp(){let s=t1(),f=_p(s)?`${s.status} ${s.statusText}`:s instanceof Error?s.message:JSON.stringify(s),d=s instanceof Error?s.stack:null,c="rgba(200,200,200, 0.5)",m={padding:"0.5rem",backgroundColor:c},p={padding:"2px 4px",backgroundColor:c},b=null;return console.error("Error handled by React Router default ErrorBoundary:",s),b=T.createElement(T.Fragment,null,T.createElement("p",null,"💿 Hey developer 👋"),T.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",T.createElement("code",{style:p},"ErrorBoundary")," or"," ",T.createElement("code",{style:p},"errorElement")," prop on your route.")),T.createElement(T.Fragment,null,T.createElement("h2",null,"Unexpected Application Error!"),T.createElement("h3",{style:{fontStyle:"italic"}},f),d?T.createElement("pre",{style:m},d):null,b)}var Kp=T.createElement(Zp,null),Wp=class extends T.Component{constructor(s){super(s),this.state={location:s.location,revalidation:s.revalidation,error:s.error}}static getDerivedStateFromError(s){return{error:s}}static getDerivedStateFromProps(s,f){return f.location!==s.location||f.revalidation!=="idle"&&s.revalidation==="idle"?{error:s.error,location:s.location,revalidation:s.revalidation}:{error:s.error!==void 0?s.error:f.error,location:f.location,revalidation:s.revalidation||f.revalidation}}componentDidCatch(s,f){this.props.unstable_onError?this.props.unstable_onError(s,f):console.error("React Router caught the following error during render",s)}render(){return this.state.error!==void 0?T.createElement(It.Provider,{value:this.props.routeContext},T.createElement(Hs.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function Jp({routeContext:s,match:f,children:d}){let c=T.useContext(Cn);return c&&c.static&&c.staticContext&&(f.route.errorElement||f.route.ErrorBoundary)&&(c.staticContext._deepestRenderedBoundaryId=f.route.id),T.createElement(It.Provider,{value:s},d)}function Ip(s,f=[],d=null,c=null,m=null){if(s==null){if(!d)return null;if(d.errors)s=d.matches;else if(f.length===0&&!d.initialized&&d.matches.length>0)s=d.matches;else return null}let p=s,b=d?.errors;if(b!=null){let y=p.findIndex(k=>k.route.id&&b?.[k.route.id]!==void 0);je(y>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(b).join(",")}`),p=p.slice(0,Math.min(p.length,y+1))}let E=!1,S=-1;if(d)for(let y=0;y<p.length;y++){let k=p[y];if((k.route.HydrateFallback||k.route.hydrateFallbackElement)&&(S=y),k.route.id){let{loaderData:O,errors:H}=d,Y=k.route.loader&&!O.hasOwnProperty(k.route.id)&&(!H||H[k.route.id]===void 0);if(k.route.lazy||Y){E=!0,S>=0?p=p.slice(0,S+1):p=[p[0]];break}}}return p.reduceRight((y,k,O)=>{let H,Y=!1,V=null,F=null;d&&(H=b&&k.route.id?b[k.route.id]:void 0,V=k.route.errorElement||Kp,E&&(S<0&&O===0?(p0("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),Y=!0,F=null):S===O&&(Y=!0,F=k.route.hydrateFallbackElement||null)));let G=f.concat(p.slice(0,O+1)),Q=()=>{let q;return H?q=V:Y?q=F:k.route.Component?q=T.createElement(k.route.Component,null):k.route.element?q=k.route.element:q=y,T.createElement(Jp,{match:k,routeContext:{outlet:y,matches:G,isDataRoute:d!=null},children:q})};return d&&(k.route.ErrorBoundary||k.route.errorElement||O===0)?T.createElement(Wp,{location:d.location,revalidation:d.revalidation,component:V,error:H,children:Q(),routeContext:{outlet:null,matches:G,isDataRoute:!0},unstable_onError:c}):Q()},null)}function Us(s){return`${s} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Fp(s){let f=T.useContext(Cn);return je(f,Us(s)),f}function $p(s){let f=T.useContext(ir);return je(f,Us(s)),f}function Pp(s){let f=T.useContext(It);return je(f,Us(s)),f}function Bs(s){let f=Pp(s),d=f.matches[f.matches.length-1];return je(d.route.id,`${s} can only be used on routes that contain a unique "id"`),d.route.id}function e1(){return Bs("useRouteId")}function t1(){let s=T.useContext(Hs),f=$p("useRouteError"),d=Bs("useRouteError");return s!==void 0?s:f.errors?.[d]}function a1(){let{router:s}=Fp("useNavigate"),f=Bs("useNavigate"),d=T.useRef(!1);return m0(()=>{d.current=!0}),T.useCallback(async(m,p={})=>{Ct(d.current,f0),d.current&&(typeof m=="number"?s.navigate(m):await s.navigate(m,{fromRouteId:f,...p}))},[s,f])}var Zf={};function p0(s,f,d){!f&&!Zf[s]&&(Zf[s]=!0,Ct(!1,d))}T.memo(n1);function n1({routes:s,future:f,state:d,unstable_onError:c}){return h0(s,void 0,d,c,f)}function St(s){je(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function i1({basename:s="/",children:f=null,location:d,navigationType:c="POP",navigator:m,static:p=!1}){je(!Oi(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let b=s.replace(/^\/*/,"/"),E=T.useMemo(()=>({basename:b,navigator:m,static:p,future:{}}),[b,m,p]);typeof d=="string"&&(d=An(d));let{pathname:S="/",search:y="",hash:k="",state:O=null,key:H="default"}=d,Y=T.useMemo(()=>{let V=Jt(S,b);return V==null?null:{location:{pathname:V,search:y,hash:k,state:O,key:H},navigationType:c}},[b,S,y,k,O,H,c]);return Ct(Y!=null,`<Router basename="${b}"> is not able to match the URL "${S}${y}${k}" because it does not start with the basename, so the <Router> won't render anything.`),Y==null?null:T.createElement(Mt.Provider,{value:E},T.createElement(Di.Provider,{children:f,value:Y}))}function l1({children:s,location:f}){return Qp(Ds(s),f)}function Ds(s,f=[]){let d=[];return T.Children.forEach(s,(c,m)=>{if(!T.isValidElement(c))return;let p=[...f,m];if(c.type===T.Fragment){d.push.apply(d,Ds(c.props.children,p));return}je(c.type===St,`[${typeof c.type=="string"?c.type:c.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),je(!c.props.index||!c.props.children,"An index route cannot have child routes.");let b={id:c.props.id||p.join("-"),caseSensitive:c.props.caseSensitive,element:c.props.element,Component:c.props.Component,index:c.props.index,path:c.props.path,loader:c.props.loader,action:c.props.action,hydrateFallbackElement:c.props.hydrateFallbackElement,HydrateFallback:c.props.HydrateFallback,errorElement:c.props.errorElement,ErrorBoundary:c.props.ErrorBoundary,hasErrorBoundary:c.props.hasErrorBoundary===!0||c.props.ErrorBoundary!=null||c.props.errorElement!=null,shouldRevalidate:c.props.shouldRevalidate,handle:c.props.handle,lazy:c.props.lazy};c.props.children&&(b.children=Ds(c.props.children,p)),d.push(b)}),d}var tr="get",ar="application/x-www-form-urlencoded";function lr(s){return s!=null&&typeof s.tagName=="string"}function r1(s){return lr(s)&&s.tagName.toLowerCase()==="button"}function o1(s){return lr(s)&&s.tagName.toLowerCase()==="form"}function s1(s){return lr(s)&&s.tagName.toLowerCase()==="input"}function c1(s){return!!(s.metaKey||s.altKey||s.ctrlKey||s.shiftKey)}function d1(s,f){return s.button===0&&(!f||f==="_self")&&!c1(s)}var Fl=null;function u1(){if(Fl===null)try{new FormData(document.createElement("form"),0),Fl=!1}catch{Fl=!0}return Fl}var f1=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function As(s){return s!=null&&!f1.has(s)?(Ct(!1,`"${s}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${ar}"`),null):s}function m1(s,f){let d,c,m,p,b;if(o1(s)){let E=s.getAttribute("action");c=E?Jt(E,f):null,d=s.getAttribute("method")||tr,m=As(s.getAttribute("enctype"))||ar,p=new FormData(s)}else if(r1(s)||s1(s)&&(s.type==="submit"||s.type==="image")){let E=s.form;if(E==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let S=s.getAttribute("formaction")||E.getAttribute("action");if(c=S?Jt(S,f):null,d=s.getAttribute("formmethod")||E.getAttribute("method")||tr,m=As(s.getAttribute("formenctype"))||As(E.getAttribute("enctype"))||ar,p=new FormData(E,s),!u1()){let{name:y,type:k,value:O}=s;if(k==="image"){let H=y?`${y}.`:"";p.append(`${H}x`,"0"),p.append(`${H}y`,"0")}else y&&p.append(y,O)}}else{if(lr(s))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');d=tr,c=null,m=ar,b=s}return p&&m==="text/plain"&&(b=p,p=void 0),{action:c,method:d.toLowerCase(),encType:m,formData:p,body:b}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function _s(s,f){if(s===!1||s===null||typeof s>"u")throw new Error(f)}function h1(s,f,d){let c=typeof s=="string"?new URL(s,typeof window>"u"?"server://singlefetch/":window.location.origin):s;return c.pathname==="/"?c.pathname=`_root.${d}`:f&&Jt(c.pathname,f)==="/"?c.pathname=`${f.replace(/\/$/,"")}/_root.${d}`:c.pathname=`${c.pathname.replace(/\/$/,"")}.${d}`,c}async function p1(s,f){if(s.id in f)return f[s.id];try{let d=await import(s.module);return f[s.id]=d,d}catch(d){return console.error(`Error loading route module \`${s.module}\`, reloading page...`),console.error(d),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function g1(s){return s==null?!1:s.href==null?s.rel==="preload"&&typeof s.imageSrcSet=="string"&&typeof s.imageSizes=="string":typeof s.rel=="string"&&typeof s.href=="string"}async function x1(s,f,d){let c=await Promise.all(s.map(async m=>{let p=f.routes[m.route.id];if(p){let b=await p1(p,d);return b.links?b.links():[]}return[]}));return w1(c.flat(1).filter(g1).filter(m=>m.rel==="stylesheet"||m.rel==="preload").map(m=>m.rel==="stylesheet"?{...m,rel:"prefetch",as:"style"}:{...m,rel:"prefetch"}))}function Kf(s,f,d,c,m,p){let b=(S,y)=>d[y]?S.route.id!==d[y].route.id:!0,E=(S,y)=>d[y].pathname!==S.pathname||d[y].route.path?.endsWith("*")&&d[y].params["*"]!==S.params["*"];return p==="assets"?f.filter((S,y)=>b(S,y)||E(S,y)):p==="data"?f.filter((S,y)=>{let k=c.routes[S.route.id];if(!k||!k.hasLoader)return!1;if(b(S,y)||E(S,y))return!0;if(S.route.shouldRevalidate){let O=S.route.shouldRevalidate({currentUrl:new URL(m.pathname+m.search+m.hash,window.origin),currentParams:d[0]?.params||{},nextUrl:new URL(s,window.origin),nextParams:S.params,defaultShouldRevalidate:!0});if(typeof O=="boolean")return O}return!0}):[]}function y1(s,f,{includeHydrateFallback:d}={}){return v1(s.map(c=>{let m=f.routes[c.route.id];if(!m)return[];let p=[m.module];return m.clientActionModule&&(p=p.concat(m.clientActionModule)),m.clientLoaderModule&&(p=p.concat(m.clientLoaderModule)),d&&m.hydrateFallbackModule&&(p=p.concat(m.hydrateFallbackModule)),m.imports&&(p=p.concat(m.imports)),p}).flat(1))}function v1(s){return[...new Set(s)]}function b1(s){let f={},d=Object.keys(s).sort();for(let c of d)f[c]=s[c];return f}function w1(s,f){let d=new Set;return new Set(f),s.reduce((c,m)=>{let p=JSON.stringify(b1(m));return d.has(p)||(d.add(p),c.push({key:p,link:m})),c},[])}function g0(){let s=T.useContext(Cn);return _s(s,"You must render this element inside a <DataRouterContext.Provider> element"),s}function j1(){let s=T.useContext(ir);return _s(s,"You must render this element inside a <DataRouterStateContext.Provider> element"),s}var Ys=T.createContext(void 0);Ys.displayName="FrameworkContext";function x0(){let s=T.useContext(Ys);return _s(s,"You must render this element inside a <HydratedRouter> element"),s}function S1(s,f){let d=T.useContext(Ys),[c,m]=T.useState(!1),[p,b]=T.useState(!1),{onFocus:E,onBlur:S,onMouseEnter:y,onMouseLeave:k,onTouchStart:O}=f,H=T.useRef(null);T.useEffect(()=>{if(s==="render"&&b(!0),s==="viewport"){let F=Q=>{Q.forEach(q=>{b(q.isIntersecting)})},G=new IntersectionObserver(F,{threshold:.5});return H.current&&G.observe(H.current),()=>{G.disconnect()}}},[s]),T.useEffect(()=>{if(c){let F=setTimeout(()=>{b(!0)},100);return()=>{clearTimeout(F)}}},[c]);let Y=()=>{m(!0)},V=()=>{m(!1),b(!1)};return d?s!=="intent"?[p,H,{}]:[p,H,{onFocus:Ci(E,Y),onBlur:Ci(S,V),onMouseEnter:Ci(y,Y),onMouseLeave:Ci(k,V),onTouchStart:Ci(O,Y)}]:[!1,H,{}]}function Ci(s,f){return d=>{s&&s(d),d.defaultPrevented||f(d)}}function z1({page:s,...f}){let{router:d}=g0(),c=T.useMemo(()=>l0(d.routes,s,d.basename),[d.routes,s,d.basename]);return c?T.createElement(N1,{page:s,matches:c,...f}):null}function k1(s){let{manifest:f,routeModules:d}=x0(),[c,m]=T.useState([]);return T.useEffect(()=>{let p=!1;return x1(s,f,d).then(b=>{p||m(b)}),()=>{p=!0}},[s,f,d]),c}function N1({page:s,matches:f,...d}){let c=qa(),{manifest:m,routeModules:p}=x0(),{basename:b}=g0(),{loaderData:E,matches:S}=j1(),y=T.useMemo(()=>Kf(s,f,S,m,c,"data"),[s,f,S,m,c]),k=T.useMemo(()=>Kf(s,f,S,m,c,"assets"),[s,f,S,m,c]),O=T.useMemo(()=>{if(s===c.pathname+c.search+c.hash)return[];let V=new Set,F=!1;if(f.forEach(Q=>{let q=m.routes[Q.route.id];!q||!q.hasLoader||(!y.some(ee=>ee.route.id===Q.route.id)&&Q.route.id in E&&p[Q.route.id]?.shouldRevalidate||q.hasClientLoader?F=!0:V.add(Q.route.id))}),V.size===0)return[];let G=h1(s,b,"data");return F&&V.size>0&&G.searchParams.set("_routes",f.filter(Q=>V.has(Q.route.id)).map(Q=>Q.route.id).join(",")),[G.pathname+G.search]},[b,E,c,m,y,f,s,p]),H=T.useMemo(()=>y1(k,m),[k,m]),Y=k1(k);return T.createElement(T.Fragment,null,O.map(V=>T.createElement("link",{key:V,rel:"prefetch",as:"fetch",href:V,...d})),H.map(V=>T.createElement("link",{key:V,rel:"modulepreload",href:V,...d})),Y.map(({key:V,link:F})=>T.createElement("link",{key:V,nonce:d.nonce,...F})))}function T1(...s){return f=>{s.forEach(d=>{typeof d=="function"?d(f):d!=null&&(d.current=f)})}}var y0=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{y0&&(window.__reactRouterVersion="7.9.1")}catch{}function E1({basename:s,children:f,window:d}){let c=T.useRef();c.current==null&&(c.current=pp({window:d,v5Compat:!0}));let m=c.current,[p,b]=T.useState({action:m.action,location:m.location}),E=T.useCallback(S=>{T.startTransition(()=>b(S))},[b]);return T.useLayoutEffect(()=>m.listen(E),[m,E]),T.createElement(i1,{basename:s,children:f,location:p.location,navigationType:p.action,navigator:m})}var v0=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,b0=T.forwardRef(function({onClick:f,discover:d="render",prefetch:c="none",relative:m,reloadDocument:p,replace:b,state:E,target:S,to:y,preventScrollReset:k,viewTransition:O,...H},Y){let{basename:V}=T.useContext(Mt),F=typeof y=="string"&&v0.test(y),G,Q=!1;if(typeof y=="string"&&F&&(G=y,y0))try{let Se=new URL(window.location.href),Pe=y.startsWith("//")?new URL(Se.protocol+y):new URL(y),dt=Jt(Pe.pathname,V);Pe.origin===Se.origin&&dt!=null?y=dt+Pe.search+Pe.hash:Q=!0}catch{Ct(!1,`<Link to="${y}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let q=qp(y,{relative:m}),[ee,be,$]=S1(c,H),De=R1(y,{replace:b,state:E,target:S,preventScrollReset:k,relative:m,viewTransition:O});function Ce(Se){f&&f(Se),Se.defaultPrevented||De(Se)}let Oe=T.createElement("a",{...H,...$,href:G||q,onClick:Q||p?f:Ce,ref:T1(Y,be),target:S,"data-discover":!F&&d==="render"?"true":void 0});return ee&&!F?T.createElement(T.Fragment,null,Oe,T.createElement(z1,{page:q})):Oe});b0.displayName="Link";var A1=T.forwardRef(function({"aria-current":f="page",caseSensitive:d=!1,className:c="",end:m=!1,style:p,to:b,viewTransition:E,children:S,...y},k){let O=Hi(b,{relative:y.relative}),H=qa(),Y=T.useContext(ir),{navigator:V,basename:F}=T.useContext(Mt),G=Y!=null&&B1(O)&&E===!0,Q=V.encodeLocation?V.encodeLocation(O).pathname:O.pathname,q=H.pathname,ee=Y&&Y.navigation&&Y.navigation.location?Y.navigation.location.pathname:null;d||(q=q.toLowerCase(),ee=ee?ee.toLowerCase():null,Q=Q.toLowerCase()),ee&&F&&(ee=Jt(ee,F)||ee);const be=Q!=="/"&&Q.endsWith("/")?Q.length-1:Q.length;let $=q===Q||!m&&q.startsWith(Q)&&q.charAt(be)==="/",De=ee!=null&&(ee===Q||!m&&ee.startsWith(Q)&&ee.charAt(Q.length)==="/"),Ce={isActive:$,isPending:De,isTransitioning:G},Oe=$?f:void 0,Se;typeof c=="function"?Se=c(Ce):Se=[c,$?"active":null,De?"pending":null,G?"transitioning":null].filter(Boolean).join(" ");let Pe=typeof p=="function"?p(Ce):p;return T.createElement(b0,{...y,"aria-current":Oe,className:Se,ref:k,style:Pe,to:b,viewTransition:E},typeof S=="function"?S(Ce):S)});A1.displayName="NavLink";var C1=T.forwardRef(({discover:s="render",fetcherKey:f,navigate:d,reloadDocument:c,replace:m,state:p,method:b=tr,action:E,onSubmit:S,relative:y,preventScrollReset:k,viewTransition:O,...H},Y)=>{let V=H1(),F=U1(E,{relative:y}),G=b.toLowerCase()==="get"?"get":"post",Q=typeof E=="string"&&v0.test(E),q=ee=>{if(S&&S(ee),ee.defaultPrevented)return;ee.preventDefault();let be=ee.nativeEvent.submitter,$=be?.getAttribute("formmethod")||b;V(be||ee.currentTarget,{fetcherKey:f,method:$,navigate:d,replace:m,state:p,relative:y,preventScrollReset:k,viewTransition:O})};return T.createElement("form",{ref:Y,method:G,action:F,onSubmit:c?S:q,...H,"data-discover":!Q&&s==="render"?"true":void 0})});C1.displayName="Form";function M1(s){return`${s} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function w0(s){let f=T.useContext(Cn);return je(f,M1(s)),f}function R1(s,{target:f,replace:d,state:c,preventScrollReset:m,relative:p,viewTransition:b}={}){let E=Xp(),S=qa(),y=Hi(s,{relative:p});return T.useCallback(k=>{if(d1(k,f)){k.preventDefault();let O=d!==void 0?d:Ri(S)===Ri(y);E(s,{replace:O,state:c,preventScrollReset:m,relative:p,viewTransition:b})}},[S,E,y,d,c,f,s,m,p,b])}var D1=0,O1=()=>`__${String(++D1)}__`;function H1(){let{router:s}=w0("useSubmit"),{basename:f}=T.useContext(Mt),d=e1();return T.useCallback(async(c,m={})=>{let{action:p,method:b,encType:E,formData:S,body:y}=m1(c,f);if(m.navigate===!1){let k=m.fetcherKey||O1();await s.fetch(k,d,m.action||p,{preventScrollReset:m.preventScrollReset,formData:S,body:y,formMethod:m.method||b,formEncType:m.encType||E,flushSync:m.flushSync})}else await s.navigate(m.action||p,{preventScrollReset:m.preventScrollReset,formData:S,body:y,formMethod:m.method||b,formEncType:m.encType||E,replace:m.replace,state:m.state,fromRouteId:d,flushSync:m.flushSync,viewTransition:m.viewTransition})},[s,f,d])}function U1(s,{relative:f}={}){let{basename:d}=T.useContext(Mt),c=T.useContext(It);je(c,"useFormAction must be used inside a RouteContext");let[m]=c.matches.slice(-1),p={...Hi(s||".",{relative:f})},b=qa();if(s==null){p.search=b.search;let E=new URLSearchParams(p.search),S=E.getAll("index");if(S.some(k=>k==="")){E.delete("index"),S.filter(O=>O).forEach(O=>E.append("index",O));let k=E.toString();p.search=k?`?${k}`:""}}return(!s||s===".")&&m.route.index&&(p.search=p.search?p.search.replace(/^\?/,"?index&"):"?index"),d!=="/"&&(p.pathname=p.pathname==="/"?d:Wt([d,p.pathname])),Ri(p)}function B1(s,{relative:f}={}){let d=T.useContext(u0);je(d!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:c}=w0("useViewTransitionState"),m=Hi(s,{relative:f});if(!d.isTransitioning)return!1;let p=Jt(d.currentLocation.pathname,c)||d.currentLocation.pathname,b=Jt(d.nextLocation.pathname,c)||d.nextLocation.pathname;return nr(m.pathname,b)!=null||nr(m.pathname,p)!=null}const Rt="/assets/profile-Dvg5Mrpq.png",_1="/assets/shreayaa-DIab47yl.png",Y1=[{description:[i.jsx("span",{style:{display:"block",marginBottom:"1em"},children:"August 2020 rolls around, and there I am stepping foot in the beautiful UMass Amherst campus! Interested in tech and psychology I decided to double major in Computer Science and Psychology."}),i.jsx("span",{style:{display:"block",marginBottom:"1em"}}),i.jsx("span",{style:{display:"block",marginBottom:"1em"},children:"Why choose one when you can have both, right?"})],position:"right",watermark:"🎓",isFirst:!0,year:"Aug 2020",location:"University of Massachusetts Amherst"},{description:[i.jsx("span",{style:{display:"block",marginBottom:"1em"},children:"Two years into my bachelor's journey, I got my first job yayyy!!!"}),i.jsx("span",{style:{display:"block",marginBottom:"1em"}}),i.jsx("span",{style:{display:"block",marginBottom:"1em"},children:"Being an RA taught me how to create community. From late-night crisis management to organizing fun floor events, this experience taught me how to understand people's needs and create environments where everyone could thrive."})],position:"left",watermark:"💼",year:"Aug 2022",jobTitle:"Resident Assistant"},{description:[i.jsx("span",{style:{display:"block",marginBottom:"1em"},children:"I had taken up a volunteer position a few months back and realized that I love to help others learn. So  I applied to be a Teaching Assistant. A semester later I got promoted to be Head TA."}),i.jsx("span",{style:{display:"block",marginBottom:"1em"}}),i.jsx("span",{style:{display:"block",marginBottom:"1em"},children:"As Head TA, I found myself leading a team of TAs and supporting 80+ students in Human-Computer Interaction."})],position:"right",watermark:"💼",year:"Feb 2024",jobTitle:"Head Teaching Assistant"},{description:[i.jsx("span",{style:{display:"block",marginBottom:"1em"},children:"Bachelor's degree in hand, I wasn't ready to stop learning. Enter Cornell University and my MPS in Information Science with a UX focus!"}),i.jsx("span",{style:{display:"block",marginBottom:"1em"},children:"I was already in love with multi-disciplinary problem solving and I was trying to find an intersection between CS and psychology."}),i.jsx("span",{style:{display:"block",marginBottom:"1em"},children:"So Cornell's program was a dream come true! I loved learning about user research methods, design, prototyping and strategy. Plus, the campus is absolutely stunning!"})],position:"left",watermark:"🎓",year:"Aug 2024",location:"Cornell University, Ithaca"},{description:[i.jsx("span",{style:{display:"block",marginBottom:"1em"},children:"During my time at Cornell, I worked as a Graduate Teaching Specialist, supporting 200+ students across design and programming coursework."}),i.jsx("span",{style:{display:"block",marginBottom:"1em"},children:"I graded assignments and mentored students as they explored design practices while programming."})],position:"right",watermark:"💼",year:"Aug 2024",jobTitle:"Graduate Teaching Specialist"},{description:[i.jsx("span",{style:{display:"block",marginBottom:"1em"},children:"I lived my capstone dream, working directly with Google Cloud."}),i.jsx("span",{style:{display:"block",marginBottom:"1em"},children:"Our team was mentored by some of the nicest folks at Google Cloud while we got to learn so much about enterprise design and research."})],position:"left",watermark:"💼",year:"Jan 2025",jobTitle:"UX Designer + Researcher"},{description:"I worked as a Graduate RA, diving into co-design research with remote mental health support systems.",position:"right",watermark:"💼",year:"May 2025",jobTitle:"Graduate Research Assistant"}],L1=["Interaction Design","Interdisciplinary Thinking","Prototyping","Mixed Methods Research","Co-design","Qualitative Analysis","Programming","Community Building","Conflict Resolution","Leadership","Mentorship","Teamwork"];function G1(){const s=T.useRef([]),f=T.useRef([]);return T.useEffect(()=>{const d=[];return s.current.forEach((c,m)=>{if(c){const p=new IntersectionObserver(b=>{b.forEach(E=>{E.isIntersecting&&(E.target.style.animationDelay=`${m*.2}s`,E.target.classList.add("animate-in"))})},{threshold:.1,rootMargin:"-50px"});p.observe(c),d.push(p)}}),f.current.forEach((c,m)=>{if(c){const p=new IntersectionObserver(b=>{b.forEach(E=>{E.isIntersecting&&(E.target.style.animationDelay=`${m*.1}s`,E.target.classList.add("skill-animate-in"))})},{threshold:.1,rootMargin:"-30px"});p.observe(c),d.push(p)}}),()=>{d.forEach(c=>c.disconnect())}},[]),i.jsxs("div",{className:"about-page",children:[i.jsx("style",{children:`
        ...
        * {
        ...
        `}),i.jsx("header",{className:"header",children:i.jsx("div",{className:"content-container",children:i.jsxs("div",{className:"header-content",children:[i.jsx("a",{href:"/",children:i.jsx("div",{className:"logo",children:i.jsx("img",{src:Rt,alt:"Shreayaa Srinivasan Logo",className:"custom-logo"})})}),i.jsxs("nav",{className:"nav-links",children:[i.jsx("a",{href:"/work",children:"WORK"}),i.jsx("a",{href:"/playground",children:"PLAYGROUND"}),i.jsx("a",{href:"/about",children:"ABOUT"}),i.jsx("a",{href:"https://drive.google.com/file/d/1nE7H77ctf1esubvyXuKoVVAPnDlRB8R0/view?usp=sharing",target:"_blank",rel:"noopener noreferrer",children:"RESUME"})]})]})})}),i.jsx("section",{className:"hero",children:i.jsx("div",{className:"content-container",children:i.jsxs("div",{className:"hero-content",children:[i.jsxs("div",{className:"hero-text",children:[i.jsxs("h1",{children:["Hi, I'm Shreayaa."," ",i.jsxs("span",{className:"typewriter",children:["I'm a ",m,i.jsx("span",{style:{borderRight:"2px solid",animation:"blink 1s infinite"},children:"|"})]})]}),i.jsx("p",{children:"I'm a user experience designer who is curious about how design influences human behavior in the real world. I design thoughtful user experiences that balance user needs with business strategy."})]}),i.jsx("div",{className:"hero-image",children:i.jsx("div",{className:"hero-photo",children:i.jsx("img",{src:_1,alt:"Shreayaa Srinivasan"})})})]})})}),i.jsx("section",{className:"skills",children:i.jsx("div",{className:"skills-container",children:i.jsx("div",{className:"skills-strip",children:["Prototyping","Wireframing","Interaction Design","Accessibility","Python","Javascript","CSS","HTML","Figma","Framer","Webflow","Sketch","R Studio","Problem Solving","Leadership","User Research","Design Systems","A/B Testing","Prototyping","Wireframing","Interaction Design","Accessibility","Python","Javascript","CSS","HTML","Figma","Framer","Webflow","Sketch","R Studio","Problem Solving","Leadership","User Research","Design Systems","A/B Testing"].map((O,H)=>i.jsx("span",{children:O},H))})})}),i.jsx("section",{className:"design-section",children:i.jsx("div",{className:"content-container",children:i.jsxs("div",{className:"design-content",children:[i.jsxs("div",{className:"design-left",children:[i.jsx("h2",{children:"Who am I as a designer?"}),i.jsx("p",{children:"Coming from a background in both computer science and user experience design, I bring a unique blend of technical expertise and design thinking. I design with empathy and purpose."}),i.jsx("p",{children:"I am comfortable working closely with researchers, engineers, and stakeholders to shape ideas into products people trust and enjoy."})]}),i.jsx("div",{className:"design-gallery",children:i.jsx("div",{className:"gallery-container",onMouseEnter:()=>y(!0),onMouseLeave:()=>y(!1),children:Mi.map((O,H)=>{let Y="gallery-card";return H===s?Y+=" active":H===(s-1+Mi.length)%Mi.length?Y+=" prev":H===(s+1)%Mi.length&&(Y+=" next"),i.jsx("div",{className:Y,children:i.jsxs("div",{className:"card-content",children:[i.jsx("h3",{children:O.title}),i.jsx("p",{style:{marginBottom:"1.2rem"},children:O.description})]})},H)})})})]})})}),i.jsx("footer",{className:"footer",children:i.jsxs("div",{className:"footer-content",children:[i.jsx("div",{className:"footer-message",children:i.jsx("h3",{children:"Like my work? Hit me up with a hi 😊"})}),i.jsxs("div",{className:"footer-links",children:[i.jsx("a",{href:"https://www.linkedin.com/in/shreayaa-nadagudy-srinivasan-b41a271a8/",target:"_blank",rel:"noopener noreferrer",title:"LinkedIn",children:i.jsx("svg",{className:"footer-icon",viewBox:"0 0 24 24",fill:"currentColor",children:i.jsx("path",{d:"M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"})})}),i.jsx("a",{href:"https://medium.com/@shreayaasrini",target:"_blank",rel:"noopener noreferrer",title:"Medium",children:i.jsx("svg",{className:"footer-icon",viewBox:"0 0 24 24",fill:"currentColor",children:i.jsx("path",{d:"M13.54 12a6.8 6.8 0 01-6.77 6.82A6.8 6.8 0 010 12a6.8 6.8 0 016.77-6.82A6.8 6.8 0 0113.54 12zM20.96 12c0 3.54-1.51 6.42-3.38 6.42-1.87 0-3.39-2.88-3.39-6.42s1.52-6.42 3.39-6.42 3.38 2.88 3.38 6.42M24 12c0 3.17-.53 5.75-1.19 5.75-.66 0-1.19-2.58-1.19-5.75s.53-5.75 1.19-5.75C23.47 6.25 24 8.83 24 12z"})})}),i.jsx("a",{href:"https://dribbble.com/shreayaa-srinivasan",target:"_blank",rel:"noopener noreferrer",title:"Dribbble",children:i.jsx("svg",{className:"footer-icon",viewBox:"0 0 24 24",fill:"currentColor",children:i.jsx("path",{d:"M12 24C5.385 24 0 18.615 0 12S5.385 0 12 0s12 5.385 12 12-5.385 12-12 12zm10.12-10.358c-.35-.11-3.17-.953-6.384-.438 1.34 3.684 1.887 6.684 1.992 7.308 2.3-1.555 3.936-4.02 4.395-6.87zm-6.115 7.808c-.153-.9-.75-4.032-2.19-7.77l-.066.02c-5.79 2.015-7.86 6.025-8.04 6.4 1.74 1.36 3.92 2.166 6.29 2.166 1.42 0 2.77-.29 4-.816zm-11.62-2.58c.232-.4 3.045-5.055 8.332-6.765.135-.045.27-.084.405-.12-.26-.585-.54-1.167-.832-1.74C7.17 11.775 2.206 11.71 1.756 11.7l-.004.312c0 2.633.998 5.037 2.634 6.855zm-2.42-8.955c.46.008 4.683.026 9.477-1.248-1.698-3.018-3.53-5.558-3.8-5.928-2.868 1.35-5.01 3.99-5.676 7.17zM9.6 2.052c.282.38 2.145 2.914 3.822 6 3.645-1.365 5.19-3.44 5.373-3.702-1.81-1.61-4.19-2.586-6.795-2.586-.825 0-1.63.1-2.4.285zm10.335 3.483c-.218.29-1.935 2.493-5.724 4.04.24.49.47.985.68 1.486.08.18.15.36.22.53 3.41-.43 6.8.26 7.14.33-.02-2.42-.88-4.64-2.31-6.38z"})})}),i.jsx("a",{href:"mailto:shreayaasrini@gmail.com",title:"Email",children:i.jsx("svg",{className:"footer-icon",viewBox:"0 0 24 24",fill:"currentColor",children:i.jsx("path",{d:"M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 0 1 0 19.366V5.457c0-.904.732-1.636 1.636-1.636h1.818L12 11.73l8.545-7.909h1.818c.904 0 1.636.732 1.636 1.636 Z"})})})]}),i.jsx("p",{className:"footer-copyright",children:"Designed + Coded with 🩷 by Shreayaa Srinivasan © 2025 "})]})})]})}function U0(){return i.jsx(E1,{children:i.jsxs(l1,{children:[i.jsx(St,{path:"/",element:i.jsx(Pg,{})}),i.jsx(St,{path:"/about",element:i.jsx(G1,{})}),i.jsx(St,{path:"/playground",element:i.jsx(q1,{})}),i.jsx(St,{path:"/work",element:i.jsx($1,{})}),i.jsx(St,{path:"/google-cloud-case-study",element:i.jsx(fg,{})}),i.jsx(St,{path:"/ithaca-soap-case-study",element:i.jsx(Ng,{})}),i.jsx(St,{path:"/routes-to-roots-case-study",element:i.jsx(Ug,{})}),i.jsx(St,{path:"/ecocart-case-study",element:i.jsx(Jg,{})}),i.jsx(St,{path:"/iname-case-study",element:i.jsx(Qg,{})}),i.jsx(St,{path:"/rshiny-case-study",element:i.jsx($g,{})})]})})}i0.createRoot(document.getElementById("root")).render(i.jsx(T.StrictMode,{children:i.jsx(U0,{})}));hp.createRoot(document.getElementById("root")).render(i.jsx(n0.StrictMode,{children:i.jsx(U0,{})}));
