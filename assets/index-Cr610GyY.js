 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Bf;function sp(){return Bf||(Bf=1,function(s){function f(C,B){var W=C.length;C.push(B);e:for(;0<W;){var pe=W-1>>>1,g=C[pe];if(0<m(g,B))C[pe]=B,C[W]=g,W=pe;else break e}}function d(C){return C.length===0?null:C[0]}function c(C){if(C.length===0)return null;var B=C[0],W=C.pop();if(W!==B){C[0]=W;e:for(var pe=0,g=C.length,D=g>>>1;pe<D;){var _=2*(pe+1)-1,U=C[_],Z=_+1,oe=C[Z];if(0>m(U,W))Z<g&&0>m(oe,U)?(C[pe]=oe,C[Z]=W,pe=Z):(C[pe]=U,C[_]=W,pe=_);else if(Z<g&&0>m(oe,W))C[pe]=oe,C[Z]=W,pe=Z;else break e}}return B}function m(C,B){var W=C.sortIndex-B.sortIndex;return W!==0?W:C.id-B.id}if(s.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var p=performance;s.unstable_now=function(){return p.now()}}else{var b=Date,E=b.now();s.unstable_now=function(){return b.now()-E}}var S=[],v=[],k=1,O=null,H=3,Y=!1,V=!1,F=!1,G=!1,Q=typeof setTimeout=="function"?setTimeout:null,q=typeof clearTimeout=="function"?clearTimeout:null,ee=typeof setImmediate<"u"?setImmediate:null;function be(C){for(var B=d(v);B!==null;){if(B.callback===null)c(v);else if(B.startTime<=C)c(v),B.sortIndex=B.expirationTime,f(S,B);else break;B=d(v)}}function $(C){if(F=!1,be(C),!V)if(d(S)!==null)V=!0,De||(De=!0,qe());else{var B=d(v);B!==null&&Xe($,B.startTime-C)}}var De=!1,Ce=-1,Oe=5,Se=-1;function Pe(){return G?!0:!(s.unstable_now()-Se<Oe)}function dt(){if(G=!1,De){var C=s.unstable_now();Se=C;var B=!0;try{e:{V=!1,F&&(F=!1,q(Ce),Ce=-1),Y=!0;var W=H;try{t:{for(be(C),O=d(S);O!==null&&!(O.expirationTime>C&&Pe());){var pe=O.callback;if(typeof pe=="function"){O.callback=null,H=O.priorityLevel;var g=pe(O.expirationTime<=C);if(C=s.unstable_now(),typeof g=="function"){O.callback=g,be(C),B=!0;break t}O===d(S)&&c(S),be(C)}else c(S);O=d(S)}if(O!==null)B=!0;else{var D=d(v);D!==null&&Xe($,D.startTime-C),B=!1}}break e}finally{O=null,H=W,Y=!1}B=void 0}}finally{B?qe():De=!1}}}var qe;if(typeof ee=="function")qe=function(){ee(dt)};else if(typeof MessageChannel<"u"){var ja=new MessageChannel,Sa=ja.port2;ja.port1.onmessage=dt,qe=function(){Sa.postMessage(null)}}else qe=function(){Q(dt,0)};function Xe(C,B){Ce=Q(function(){C(s.unstable_now())},B)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(C){C.callback=null},s.unstable_forceFrameRate=function(C){0>C||125<C?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Oe=0<C?Math.floor(1e3/C):5},s.unstable_getCurrentPriorityLevel=function(){return H},s.unstable_next=function(C){switch(H){case 1:case 2:case 3:var B=3;break;default:B=H}var W=H;H=B;try{return C()}finally{H=W}},s.unstable_requestPaint=function(){G=!0},s.unstable_runWithPriority=function(C,B){switch(C){case 1:case 2:case 3:case 4:case 5:break;default:C=3}var W=H;H=C;try{return B()}finally{H=W}},s.unstable_scheduleCallback=function(C,B,W){var pe=s.unstable_now();switch(typeof W=="object"&&W!==null?(W=W.delay,W=typeof W=="number"&&0<W?pe+W:pe):W=pe,C){case 1:var g=-1;break;case 2:g=250;break;case 5:g=1073741823;break;case 4:g=1e4;break;default:g=5e3}return g=W+g,C={id:k++,callback:B,priorityLevel:C,startTime:W,expirationTime:g,sortIndex:-1},W>pe?(C.sortIndex=W,f(v,C),d(S)===null&&C===d(v)&&(F?(q(Ce),Ce=-1):F=!0,Xe($,W-pe))):(C.sortIndex=g,f(S,C),V||Y||(V=!0,De||(De=!0,qe()))),C},s.unstable_shouldYield=Pe,s.unstable_wrapCallback=function(C){var B=H;return function(){var W=H;H=B;try{return C.apply(this,arguments)}finally{H=W}}}}(Ns)),Ns}var _f;function cp(){return _f||(_f=1,ks.exports=sp()),ks.exports}var Ts={exports:{}},Ze={};/**
 * @license React
