...
const caseStudySections = [
  {
    ...
    content: (
      <div>
        <p>
          Between 2012 and 2022, the Connecticut Department of Public Health collected annual 
          school-level vaccination and exemption data. The challenge? Making sense of more than 500 
          rows of data covering different vaccines, grades, and school types, and finding a way to turn it 
          into actionable insights for educators, policymakers, and health officials.
        </p>
      </div>
    )
  },
  {
    ...
    content: (
      <div>
        <ul>
          <li>As an analyst cleaned and restructured messy, incomplete records, explored relationships between exemptions, enrollment size, school type, and grade level.</li>
          <li>As a developer built an interactive Shiny web application to bring the data to life.</li>
          <li>Translated raw numbers into trends that could be understood outside of a technical context.</li>
        </ul>
      </div>
    )
  },
  {
    ...
    content: (
      <div>
        <p>
          This wasn’t just “load a dataset and plot a chart.” The coding process involved several critical steps:
        </p>
        <h4>01 Data Cleaning</h4>
        <ul>
          <li>We handled missing values by replacing NA with 0 where appropriate.</li>
          <li>Renamed columns for readability.</li>
          <li>Converted grade levels into factors for easier grouping and analysis.</li>
          <li>Removed redundant percentage columns to avoid duplication.</li>
        </ul>
        <h4>02 Exploratory Data Analysis (EDA)</h4>
        <ul>
          <li>We compared vaccination rates between public and private schools.</li>
          <li>Looked at grade-level patterns, e.g., compliance differences in kindergarten vs. middle school.</li>
          <li>Studied trends over time, checking whether exemption rates were increasing.</li>
        </ul>
      </div>
    )
  },
  {
    ...
    content: (
      <div>
        <p>
          After evaluating the options, we selected the main visualizations to include in our product. We 
          decided that a Shiny application would be the best way to showcase the data, allowing users to 
          apply filters to control the dataset and explore various visualizations.
        </p>
        <p>
          We aimed to ensure that policymakers could easily view and interpret the results to make 
          informed decisions regarding vaccinations for school children. We developed a responsive Shiny 
          application to achieve our product goals, putting significant effort into designing an interface that 
          is user-friendly, even for non-tech-savvy individuals.
        </p>
        <p>
          We used a gradient scale of orange for our color palettes to evoke a sense of warmth and energy. 
          Additionally, we utilized Midjourney to generate a descriptive image for the sidebar. This image 
          aims to clearly illustrate our intention of drawing attention to the children’s immunization 
          guidelines.
        </p>
        <h4>01 Building in Shiny</h4>
        <ul>
          <li>We added filters for school year, grade, vaccine type, and school type.</li>
          <li>Used ggplot2 for clean, interpretable visualizations.</li>
          <li>Structured the app so users could quickly switch between vaccination coverage, exemptions, and compliance metrics.</li>
        </ul>
      </div>
    )
  },
  {
    ...
    content: (
      <div>
        <p>
          The end result a interactive Shiny application that allows users to:
        </p>
        <ul>
          <li>Filter vaccination data by school type, grade, vaccine, and time period.</li>
          <li>Visualize exemption rates alongside enrollment counts.</li>
          <li>Track compliance trends over the 10-year period.</li>
        </ul>
        <div className="final-images">
          <img src={finalProduct1} alt="Final product 1" className="final-image" />
          <img src={finalProduct2} alt="Final product 2" className="final-image" />
        </div>
      </div>
    )
  },
  {
    ...
    content: (
      <div>
        <ul>
          <li>A static report would have buried these insights, but an interactive app made them accessible.</li>
          <li>I learned how to clean messy datasets in R turning raw, inconsistent records into usable structures.</li>
          <li>I got comfortable with data visualization in ggplot2, learning how small tweaks in aesthetics can make a chart either confusing or crystal clear.</li>
          <li>I learnt the power of Shiny apps, and how interactivity transforms static numbers into tools people can actually use.</li>
        </ul>
        <p>
          ✅ Acknowledgments<br />
          Thanks to the Connecticut Department of Public Health for the dataset, the R/Shiny community 
...
function RShinyCaseStudy() {
  ...
  // Scroll animation effect (copied from google.jsx)
  useEffect(() => {
        ...
        <div className="content-container">
          ...
          <div className="project-metadata">
            <div className="metadata-item">
              ...
              <div className="metadata-value">Data Scientist</div>
            </div>
            <div className="metadata-item">
              <div className="metadata-label">Team</div>
              <div className="metadata-value">Shreayaa, Xihan, and Yuzu</div>
            </div>
            <div className="metadata-item">
...
export default RShinyCaseStudy;
